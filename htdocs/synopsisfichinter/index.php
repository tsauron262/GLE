...
/**
        \file       htdocs/synopsisfichinter/index.php
...
$js = '
    ...
    <script type="text/javascript">var dashtype="24";</script>

';

    llxHeader($js,$langs->trans("Espace interventions"),0);


    print '<div class="titre">Mon tableau de bord - Interventions</div>';
    print "<br/>";
    print "<br/>";
...
//        $var=!$var;
//        print "<tr $bc[$var]>";
//        print "<td><a href=\"card.php?id=".$objp->fichid."\">".img_object($langs->trans("Show"),"task").' '.$objp->ref."</a></td>\n";
