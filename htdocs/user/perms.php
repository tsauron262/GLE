...
if ($result)
{
	...
	while ($i < $num)
	{
		...
		print '<td class="maxwidthonsmartphone tdoverflowonsmartphone">'.img_object('',$picto,'class="pictoobjectwidth"').' '.$objMod->getName().' <a href="'.DOL_URL_ROOT.'/bimpcore/?fc=admin&tab=droit&id_right='.$obj->id.'&id_user='.$object->id.'"> +</a></td>';
