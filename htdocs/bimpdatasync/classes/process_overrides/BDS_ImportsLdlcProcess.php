...
//                            die('fin');
                    ...
                    if(count($tabHtml)){
						...
						$msg = '<h3>Bonjour, voici la liste des produits avec une marge négative ('.$i.')</h3><br/><br/>'.implode('<br /><br /><hr /><br /> ', $tabHtml);
						BimpUserMsg::envoiMsg($code, 'Produit LDLC marge négative', $msg);
                    }
                }
                break;
        }
