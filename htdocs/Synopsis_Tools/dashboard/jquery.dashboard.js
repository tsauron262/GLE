...
(function($) { // Create closure.
     ...
     */
       ...
       */
            ...
            widget.saveSettings = function() {
                ...
                for (var i in fields) {
                    ...
                    if (field.value != undefined && field.name != undefined &&  field.value+"x" != "x" && params['settings[' + field.name + ']'] +"x" != "x")
                    {
                        params['settings[' + field.name + ']'] = params['settings[' + field.name + ']']+", "+field.value;
                    } else {
                ...
                $.extend(params, opts.ajaxCallbacks.widgetSettings.data, {
                    id: widget.id
                });
                ...
                $.getJSON(opts.ajaxCallbacks.getWidget.url, params, reload);
                }, 'json');
            ...
            widget.addControl = function(id, control) {
                var markup = '<a class="widget-icon ' + id + '-icon"><img src="'+DOL_URL_ROOT+'/Synopsis_Tools/dashboard/images/' + id + '.gif" alt="' + control.description + '" /></a>';
       ...
       */
            ...
            widget.controls = {
                reload: {
                    description: 'Reload this widget',
                    callback: widget.reloadContent
                },
                settings: {
       ...
       */
            ...
            function reload(data, status){
                $.extend(widget, data);
                $('.widget-content', widget.element).html(widget.content);
            }
            ...
            function initSettings() {
                ...
                var params = $.extend({}, opts.ajaxCallbacks.widgetSettings.data, {
                    id: widget.id
                });
    ...
    $.fn.dashboard.defaults = {
        ...
        fullscreenHeaderInner: '<img alt="Close this widget" src="'+DOL_URL_ROOT+'/Synopsis_Tools/dashboard/images/close.gif" /> Return to Dashboard',
        throbberMarkup: '<div class="throbber"><img alt="Loading, please wait" src="'+DOL_URL_ROOT+'/Synopsis_Tools/dashboard/images/throbber.gif" /><p>Loading...</p></div>',
        animationSpeed: 200,
        callbacks: {},
        widgetCallbacks: {}
    };
