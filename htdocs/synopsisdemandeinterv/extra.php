...
//Ref contrat ou commande
    ...
    if ($_REQUEST['action'] != 'editdate_delivery' && $synopsisdemandeinterv->status == 0) print '<a href="'.$_SERVER["PHP_SELF"].'?action=editdate_delivery&amp;id='.$synopsisdemandeinterv->id.'">'.img_edit($langs->trans('SetDateCreate'),1).'</a>';
