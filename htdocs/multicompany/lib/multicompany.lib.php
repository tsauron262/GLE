...
function checkMultiCompanyVersion()
{
	...
	if (empty($conf->global->MULTICOMPANY_MAIN_VERSION) || (version_compare($dolversion[0], '15', '=') && version_compare($conf->global->MULTICOMPANY_MAIN_VERSION, '15.0.3', '<'))) {
		$out = -2;
	} else {
		$out = version_compare($dolversion[0], '15');
	}
