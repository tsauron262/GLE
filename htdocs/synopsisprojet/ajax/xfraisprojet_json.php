    ...
    default :
    {
        $SQL = "SELECT count(*) as cnt
                  FROM ".MAIN_DB_PREFIX."user,
                       ".MAIN_DB_PREFIX."Synopsis_global_ressources_resa2
        ...
        $SQL = "SELECT ".MAIN_DB_PREFIX."Synopsis_global_ressources_resa2.id as id,
			".MAIN_DB_PREFIX."Synopsis_global_ressources_resa2.designation as nom,
			...
			".MAIN_DB_PREFIX."projet_task.label as tache
                  FROM ".MAIN_DB_PREFIX."user,
