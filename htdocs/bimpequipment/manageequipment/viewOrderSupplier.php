...
print '<strong>Enregistrer dans l\'entrepôt </strong>';
...
print '<th>Mettre en stock <input type="checkbox" name="checkAll" checked></th>';
print '</thead>';
...
foreach ($lignes as $id => $ligne) {
    ...
    print '<td name="qty">'.$ligne['qty'].'</td>';
    ...
    print '<td><input type="checkbox" name="stocker" checked></td>';
    print '</tr>';
    $cnt++;
}
