...
YAHOO.widget.Calendar._DEFAULT_CONFIG = {
	...
	MONTHS_SHORT : {key:"months_short", value:["Jan", "Fev", "Mar", "Avr", "Mai", "Jun", "Jui", "Aou", "Sep", "Oct", "Nov", "Dec"]},
	MONTHS_LONG: {key:"months_long", value:["Janvier", "Fevrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Aout", "Septembre", "Octobre", "Novembre", "Decembre"]},
	WEEKDAYS_1CHAR: {key:"weekdays_1char", value:["D", "L", "M", "M", "J", "V", "S"]},
	WEEKDAYS_SHORT: {key:"weekdays_short", value:["Di", "Lu", "Ma", "Me", "Je", "Ve", "Sa"]},
	WEEKDAYS_MEDIUM: {key:"weekdays_medium", value:["Dim", "Lun", "Mar", "Mer", "Jeu", "Ven", "Sam"]},
	WEEKDAYS_LONG: {key:"weekdays_long", value:["Dimanche", "Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi", "Samedi"]},
...
YAHOO.widget.Calendar.prototype.setupConfig = function() {
	...
	* @config MONTHS_LONG
	* @type String[]
	* @default ["Janvier", "February", "March", "Avril", "May", "June", "July", "August", "September", "October", "November", "December"
	*/
...
* @method setMonth
* @param {Number}	month		The numeric month, from 0 (Janvier) to 11 (December)
*/
