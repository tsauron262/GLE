...
if (!defined(_DOLNAME_))
    define("_DOLNAME_", "DOLSESSID_156594ef5e803056b99844d244b649c0");

if ($_REQUEST['doliauth'] == 1 || !isset($_SESSION['fname'])) {
...
if ((isset($_POST['actionID'])) && $_POST['actionID'] == 'chkAuthentication') {
    ...
    $rset = $login->filterUser(trim($_REQUEST['txtUserName']));
    if (md5("") == $rset[0][1] && $_SESSION['ldapStatus'] == "enabled") {
        $ldapAuth = $ldap->ldapAuth($rset[0][0], $_REQUEST['txtPassword']);
...
//var_dump($_SESSION);exit(0);
    ...
    } else if (md5($_REQUEST['txtPassword']) == $rset[0][1]) {
                                ...
                                <td rowspan="5" valign="top"><img src="themes/<?php echo $styleSheet; ?>/pictures/orange_new_13.jpg" width="167" height="180">
                                    <table width="100%"  border="0" cellspacing="0" cellpadding="3">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (isset($_REQUEST['txtUserName'])) { ?>
                                                    <input name="txtUserName" type="text" class="loginTXT" size="10" value="<?php echo $_REQUEST['txtUserName'] ?>">
                                                <?php } else { ?>
