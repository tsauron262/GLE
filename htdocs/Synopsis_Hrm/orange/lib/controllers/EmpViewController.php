    ...
    function reDirect($getArr, $postArr, $object = null) {
        ...
        switch ($getArr['reqcode']) {
            ...
            case 'EMP' : $form_creator->formPath = '/templates/hrfunct/hrEmpMain.php';     //hremp.php';
                ...
                $form_creator->popArr['arrMStat'] = array('Célibataire', 'Marié(e)', 'Divorcé(e)', 'Autres');
                ...
                if ($getArr['capturemode'] == 'addmode') {
                    ...
                    if ((!isset($getArr['id']) || $getArr['id'] == '') && isset($_REQUEST['id']) && $_REQUEST['id'] != '')
                        $getArr['id'] = $_REQUEST['id'];
                    if (!isset($getArr['id']) || $getArr['id'] == '')
                        die("PAs D'Id. " . print_r($_REQUEST, true));
                    $empJobInfo = $empinfo->filterEmpJobInfo($getArr['id']);
