...
$tabPrefixe = array("" => "Général", "_deprecated" => "Deprecated", "_recur" => "Récurent", "_mail" => "Mail", "_sms" => "SMS", "_apple" => "Apple", "_apple2" => "Apple2", "_apple3" => "Apple3", "_time" => "Pages lentes", "_caldav" => "CalDav", "_caldav2" => "CalDav2", "_ldap" => "Ldap", "_sauv" => "Sauv");
