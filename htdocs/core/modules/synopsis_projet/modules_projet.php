 ...
 */
abstract class ModelePDFProjets extends CommonDocGenerator
{
    public $error='';
...
function projet_pdf_create($db, $id, $modele='', $outputlangs='')
{
    ...
    $file = "pdf_projet_".$modele.".modules.php";
    ...
    if ($modelisok)
    {
        ...
        {
            print $langs->trans("Error")." ".$langs->trans("Error_projet_ADDON_PDF_NotDefined");
        } else {
...
*/
function projet_delete_preview($db, $contratid, $contratref='')
{
        global $langs,$conf;
        ...
        if ($conf->PROJET->dir_output)
        {
            ...
            $dir = $conf->PROJET->dir_output . "/" . $contratref ;
