 ...
 *
 *  \file       htdocs/bimpticketrestaurant/core/modules/modBimpTicketRestaurant.class.php
 *  \ingroup    bimpticketrestaurant
 *  \brief      Descriptor for the module product bimpticketrestaurant
 */
 ...
 */
class modBimpTicketRestaurant extends DolibarrModules {
    ...
    public function __construct($db) {
        ...
        $this->numero = 678124;  // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'bimpticketrestaurant';
        ...
        $this->description = "Calcul des tickets restaurants";
        // Used only if file README.md and README-LL.md not found.
        $this->descriptionlong = "Calcul des tickets restaurants";
...
//        $this->warnings_activation_ext = array();                 // Warning to show when we activate an external module. array('always'='text') or array('FR'='textfr','ES'='textes'...)
        ...
        if (!isset($conf->modBimpTicketRestaurant) || !isset($conf->modBimpTicketRestaurant->enabled)) {
            $conf->modBimpTicketRestaurant = new stdClass();
            $conf->modBimpTicketRestaurant->enabled = 1;
        }
...
//        $r = 1;
        ...
        /* BEGIN MODULEBUILDER TOPMENU
          ...
          'titre'=>'MyModule',
          'mainmenu'=>'modBimpContratAuto',
          'leftmenu'=>'',
          'url'=>'/modBimpContratAuto/modBimpContratAuto.php',
          'langs'=>'mymodule@mymodule',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
          'position'=>1000+$r,
          'enabled'=>'$conf->modBimpContratAuto->enabled',	// TODO changer path peut-être	 Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
        ...
        $this->menu[$r] = array(
            'fk_menu' => 'fk_mainmenu=hrm,fk_leftmenu=expensereport', // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode of parent menu
            'type' => 'left', // This is a Left menu entry
            'titre' => 'Ticket Restaurant',
            'mainmenu' => 'hrm',
            'leftmenu' => 'expensereport',
            'url' => '/bimpticketrestaurant/view.php',
