...
class modBabelCron extends DolibarrModules
{
    ...
    */
    function modBabelCron($DB)
    {
        ...
        $this->name = "Babel - Cron";
        $this->description = "Ordonnancement";
        $this->version = '0.1';    // 'experimental' or 'dolibarr' or version
        $this->const_name = 'MAIN_MODULE_BABELCRON';
        $this->special = 0;
        $this->picto='Cron';
...
//    $r++;
        ...
        $this->rights[$r][1] = 'Acc&egrave;s au module d\'ordonnancement';
        ...
        $this->rights[$r][0] = $this->numero.$r;// this->numero ."". 1
        $this->rights[$r][1] = 'Modifier l\'ordonnancement';
        $this->rights[$r][2] = 'r'; //useless
...
//        // Left menu linked to top menu
        ...
        foreach($menu as $key=>$val)
        {
            $requete = "INSERT INTO ".MAIN_DB_PREFIX."menu
                             ...
                             VALUES ('BabelCron', '".$val['fk_menu']."', '".$val['type']."', '".$val['rowid']."', '".$val['titre']."', '".$val['mainmenu']."', '".$val['url']."', '".$val['langs']."', '".$val['position']."', '".$val['perms']."', '".$val['target']."', '".$val['user']."',".$val['level'].")";
  ...
  {
    $sql = array();
            $requete = "DELETE FROM ".MAIN_DB_PREFIX."menu WHERE module = 'BabelCron' ";
            $sql = $this->db->query($requete);
