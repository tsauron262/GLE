...
class BC_List extends BC_Panel
{
    ...
    {
        if (!preg_match('^.+\..+$', $name) && stripos($name, "a.") === false) {
            $name = 'a.' . $name;
        }
