		...
		if (!empty($this->array_options)) {
			...
			foreach ($new_array_options as $key => $value) {
				...
				switch ($attributeType) {
					...
					case 'password':
						$algo = '';
						if ($this->array_options[$key] != '' && /*moddrsi (20.2)*/is_array($extrafields->attributes[$this->table_element]['param'][$attributeKey])/*fmoddrsi*/ && is_array($extrafields->attributes[$this->table_element]['param'][$attributeKey]['options'])) {
