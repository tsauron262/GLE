    ...
    function traiteLn($ln) {
        ...
        if($prodId > 0){
            ...
            if($fournId > 0){
                ...
                if(!$ok){
                    if($existeDeja != "non"){
                        mailSyn2("Ref fourn en double", "debugerp@bimp.fr,f.poirier@bimp.fr", "gle@bimp.fr", "Bonjour la ref : ".$ln['ProCode']." existe deja dans prodId ".$existeDeja." ne peut donc pas être ajouter a ".$prodId);
                    }
                    else{
