...
/*
 ...
 /**
  *
  * Name : pdf_contratGMAO_courrierBIMPavenant.modules.php
  * GLE-1.2
  */
...
class pdf_contratGMAO_courrierBIMPavenant extends ModeleSynopsiscontrat
{
    ...
    */
    function pdf_contratGMAO_courrierBIMPavenant($db)
    {
