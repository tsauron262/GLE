...
EOF;
    ...
    dol_fiche_head($head, 'Cout', $langs->trans("Project"));
...
<div id="tabs">
     <ul>
         <li><a href="ajax/fraisprojet_html-response.php?projId=$project_id"><span>Frais de projet</span></a></li>
         <li><a href="ajax/coutressource_html-response.php?projet_id=$project_id"><span>Co&ucirc;ts mat&eacute;riels</span></a></li>
         <li><a href="ajax/Hcoutressource_html-response.php?projet_id=$project_id"><span>Co&ucirc;ts humains</span></a></li>
         <li><a href="ajax/calendar_html-response.php?projId=$project_id"><span>Historique</span></a></li>
EOF;
/*<li><a href="ajax/analyse_html-response.php?projId=$project_id"><span>Analyse</span></a></li>*/
print <<<EOF
     </ul>
</div>
