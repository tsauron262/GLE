...
class ModelePDFSynopsischrono extends CommonDocGenerator
{
    var $error='';
...
*/
function synopsischrono_pdf_create($db, $object, $modele='', $outputlangs='')
{
    global $langs, $conf;
    $langs->load("babel");
    $langs->load("contracts");

    $dir = DOL_DOCUMENT_ROOT."/synopsischrono/core/modules/synopsischrono/doc/";
    $modelisok=0;
