...
//jqgrid
 //Affiche les ressources du projet
    ...
    $requete = "SELECT distinct *
                  FROM ".MAIN_DB_PREFIX."Synopsis_global_resatype
			ORDER BY name";
    $sql = $db->query($requete);
    $jsEditopts["cmdFourn"]="";
...
$jqgridJs .= <<<EOF
    ...
    function launch_panel0(){
        ...
        grid = jQuery("#gridListRessources1").jqGrid({
                datatype: "json",
                url: "ajax/xfraisprojet_json.php?userId="+userId+get,
                colNames:['id',"D&eacute;signation", "T&acirc;che",'Referent','Date achat','Co&ucirc;t','Type resa','Ressource'],
                ...
                sortname: 'id',
                mtype: "POST",
                editurl: "ajax/xfraisprojet_ajax.php?usrId="+userId+get,
                viewrecords: true,
            autowidth: true,
                height: 500,
                sortorder: "desc",
                //multiselect: true,
                caption: "<span style='padding:4px; font-size: 13px;'>Ressources du projet</span>",
                viewsortcols: true,
