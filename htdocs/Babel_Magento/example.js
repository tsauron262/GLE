...
//function init() {
//    $.getJSON('hypertree_json.php',function(data){
...
//                                if ("x"+node.data != "x")
//                                {
//                                    $("#resInfoProd").replaceWith("<div id='resInfoProd'><table><tr><td>"+node.data+"</td><td>"+node.id+"</td><td>"+node.name+"</td></tr></table></div>")
////                                    domElement.style.backgroudColor = "#FF0000";
//                                   // alert(node.data + " id " + node.id);
//                                }
//                            };
//                            },
//
        ...
        //Create a new ST instance
         st = new ST(canvas, {
            ...
            onCreateLabel: function(label, node){
                ...
                var tmpCnt = node.name.length - 10;
                label.innerHTML = node.name.substr(0,15)+suffix;
                if (node.name.charAt(16) + "x" != "x") {
                    label.innerHTML += node.name.substr(tmpCnt, 10);
                }
                ...
                label.onmouseover = function(){
                    ...
                    {
                        $("<div id ='someid'; class='node' style='position: absolute; width: 220px; background: #C0C0F0; z-index: 2000000; height: 200%;  margin-top: 10px; color: #FFFFFF;'>Catégorie: "+node.name+"</div>").appendTo($(label));
                    } else {
                        $("<div id ='someid'; class='node' style='position: absolute; width: 220px; background: #C0C0F0; z-index: 2000000; height: 200%;  margin-top: 10px; color: #FFFFFF;'>"+node.name+"</div>").appendTo($(label));
                    }
                };
