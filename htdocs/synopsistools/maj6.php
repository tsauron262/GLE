...
elseif (isset($_REQUEST['ok2'])) {
 ...
 having COUNT(`contratdet_refid`) > 1");
    ...
    $db->query("UPDATE `" . MAIN_DB_PREFIX . "product_extrafields` pe SET `type2` = (SELECT fk_product_type FROM " . MAIN_DB_PREFIX . "product p WHERE pe.`fk_object` = p.rowid) WHHERE type2 < 1");
