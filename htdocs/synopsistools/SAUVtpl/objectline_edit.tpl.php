...
<tr <?php echo $bc[$var]; ?>>
	<td<?php echo (! empty($conf->global->MAIN_VIEW_LINE_NUMBER) ? ' colspan="2"' : ''); ?>>
            <?php global $tabTypeLigne; print $tabTypeLigne[$type]; ?> : 
	...
	<td align="right" <?php if ($type > 99) { echo 'style="display:none;"'; } ?>><?php echo $form->load_tva('tva_tx',$line->tva_tx,$seller,$buyer,0,$line->info_bits,$line->product_type); ?></td>

	<td align="right" <?php if ($type > 99) { echo 'style="display:none;"'; } ?>><input type="text" class="flat" size="8" id="price_ht" name="price_ht" value="<?php echo price($line->subprice,0,'',0); ?>"></td>
	<?php if ($conf->global->MAIN_FEATURES_LEVEL > 1) { ?>
	<td align="right" <?php if ($type > 99) { echo 'style="display:none;"'; } ?>><input type="text" class="flat" size="8" id="price_ttc" name="price_ttc" value="<?php echo price($pu_ttc,0,'',0); ?>"></td>
	<?php } ?>

	<td align="right" <?php if ($type > 99) { echo 'style="display:none;"'; } ?>>
	...
	<td align="right" nowrap <?php if ($type > 99) { echo 'style="display:none;"'; } ?>>
	<?php if (($line->info_bits & 2) != 2) { ?>
...
<tr id="service_duration_area" <?php echo $bc[$var]; ?>>
	...
	echo $form->select_date($line->date_start,'date_start',$hourmin,$hourmin,$line->date_start?0:1,"updateline");
	echo ' '.$langs->trans('to').' ';
	echo $form->select_date($line->date_end,'date_end',$hourmin,$hourmin,$line->date_end?0:1,"updateline");
	?>
	</td>
</tr>
<?php } ?>
