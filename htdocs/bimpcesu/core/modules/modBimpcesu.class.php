 ...
 */
class modBimpcesu extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 598392;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		...
		$this->description = "Attestation fiscale annuelle";
		...
		$this->langfiles = array("bimpcesu@bimpcesu");
