 ...
 */
class mod_project_universal2 extends ModeleNumRefProjects
{
	var $version='dolibarr';		// 'development', 'experimental', 'dolibarr'
	var $error = '';
	var $nom = 'Universal Type';
	var $name = 'Universal Type';
		...
		if (! $mask)
		{
			...
			return 0;
                ...
                if(is_object($project)){
                    if(isset($project->array_options['options_type']))
                ...
                if($type == 0 && isset($_REQUEST['options_type']))
                    $type = $_REQUEST['options_type'];
                if($type > 0){
                    if($type == 2 )
                        $type = 6;
                    elseif($type == 4)
                    ...
                    elseif($type == 3)
                        $type = 5;
                $mask = str_replace("{type}", $type, $mask);
                }
