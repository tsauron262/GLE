...
$requete = "SELECT " . MAIN_DB_PREFIX . "societe.rowid, " . MAIN_DB_PREFIX . "societe.nom FROM " . MAIN_DB_PREFIX . "societe, " . MAIN_DB_PREFIX . "synopsischrono WHERE " . MAIN_DB_PREFIX . "societe.rowid = " . MAIN_DB_PREFIX . "synopsischrono.fk_societe";
$sql = $db->query($requete);
$js .= 'var socRess = "';
