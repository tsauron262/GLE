...
//    jQuery.getJSON('ajax/test.json.php', function(pData) {
    jQuery.getJSON('ajax/propal.json.php', function(pData) {
      data = pData;
...
//                            <tr><td colspan=2><br/>\
//                            <tr class="ui-widget-header ui-state-default"><td>Propositions commerciales\
//                                <td><span>'+data.results[i].cnt+'</span>\
//                        </table></div></p>\
//                    </div>',
//                });
      ...
      google.maps.event.addListener(marker[i], 'click', function() {
        for (var j=0;j<data.count;j++)
        {
         ...
         jQuery('#propalTable'+data.results[index].socid).visualize({
            width:380,
            height:200,
            appendTitle: true,
            title: "Proposition",
         });
         jQuery('#propalTable'+data.results[index].socid).parent().parent().parent().parent().parent().parent().parent().css('overflow','hidden');
      });
