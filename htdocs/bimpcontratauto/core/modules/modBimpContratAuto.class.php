 ...
 */
class modBimpContratAuto extends DolibarrModules {
    ...
    public function __construct($db) {
        ...
        $this->rights_class = 'BimpContratAuto';
        ...
        $this->description = "Permet à l'utilisateur de choisir des clauses d'un contrat auto";
        // Used only if file README.md and README-LL.md not found.
        $this->descriptionlong = "Permet à l'utilisateur de choisir des clauses d'un contrat auto (maintenance, garanti, etc ...)";
