 ...
 */
class modBimpmsg extends DolibarrModules {
    ...
    public function __construct($db) {
        ...
        $this->numero = 14533452;  // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'bimpmsg';
        ...
        $this->description = "Bimp Msg";
        // Used only if file README.md and README-LL.md not found.
        $this->descriptionlong = "Gestion des Messages";
