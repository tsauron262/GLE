...
require_once DOL_DOCUMENT_ROOT.'/synopsisprojetplus/class/task.class.php';
...
if ($id > 0 || ! empty($ref))
{
	...
	if ($object->fetch($id, $ref) >= 0)
	{
		...
		dol_fiche_head($head, 'attribution', $langs->trans("Task"),0,'projecttask');
...
//				$userid=$contactsoftask[0];
				print $form->select_dolusers((GETPOST('userid')?GETPOST('userid'):$userid), 'userid', 0, '', 0, '', '', 0, 0, 0, '', 0, $langs->trans("ResourceNotAssignedToTheTask"));
//			}
//			else
//			{
...
//			}
		...
		print '<td align="right">'.$langs->trans("TimeWorkload").'</td>';
