...
class soap_transport_http extends nusoap_base {
	...
	*/
	...
	function __construct($url, $curl_options = NULL, $use_curl = false){
		...
		//lvsi if (isset($rev[1])) $this->setHeader('User-Agent', $this->title.'/'.$this->version.' ('.$rev[1].')');
...
//		}
		...
		if ($this->scheme == 'https') {
			...
			//$this->setCurlOption(CURLOPT_SSL_CIPHER_LIST,'SSLv2');//lvsi
			//$this->setCurlOption(CURLOPT_SSLVERSION , 'CURL_SSLVERSION_TLSv1_0');
			...
			if ($this->authtype == 'certificate') {
				...
				if (isset($this->certRequest['verifyhost'])) {
					...
					//$this->setCurlOption(CURLOPT_SSL_CIPHER_LIST,'AES256-SHA');//lvsi
					//$this->setCurlOption(CURLOPT_SSLVERSION , 1);
	...
	*/
	...
	function setEncoding($enc='gzip, deflate') {
		...
		if (function_exists('gzdeflate')) {
			...
			$this->protocol_version = '1.1';//lvsi
