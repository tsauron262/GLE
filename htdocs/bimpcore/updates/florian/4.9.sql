...
ALTER TABLE `llx_br_reservation` ADD `id_sav_product` INT UNSIGNED NOT NULL DEFAULT '0';
ALTER TABLE `llx_br_reservation` ADD `id_sav` INT UNSIGNED NOT NULL DEFAULT '0';
