...
/**
 *       \file       htdocs/synopsisfichinter/document.php
 *       \ingroup    fichinter
...
$object = new Synopsisfichinter($db);
$object->fetch($id, $ref);
...
if ($object->id)
{
	...
	$formfile->form_attach_new_file(DOL_URL_ROOT.'/synopsisfichinter/document.php?id='.$object->id,'',0,0,$user->rights->synopsisficheinter->creer,50,$object);
