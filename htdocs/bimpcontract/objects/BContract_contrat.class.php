...
//            $values[] = $idSepa;
    ...
    {
        if ($this->isLoaded()) {
            return DOL_URL_ROOT . '/bimpinterfaceclient/client.php?tab=contrats&content=card&id_contrat=' . $this->id;
        }
    ...
    {
        return DOL_URL_ROOT . '/bimpinterfaceclient/client.php?tab=contrats';
    }
