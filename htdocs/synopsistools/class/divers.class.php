...
class synopsisHook {
    ...
    function synopsisHook() {
        ...
        $tabCentre = array("V" => array("04 75 81 81 54", "sav07@bimp.fr", "Saint Peray (valence)"), "VB" => array("04 75 81 81 54", "sav07@bimp.fr", "Valence Boutique"),
            "M" => array("04 50 22 15 55", "sav74@bimp.fr", "Meythet"), "AB" => array("04 50 22 15 55", "sav74@bimp.fr", "Annecy Boutique"), "C" => array("04 50 22 15 55", "sav74@bimp.fr", "Chambery"), "CB" => array("04 50 22 15 55", "sav74@bimp.fr", "Chambery boutique"),
            'L' => array("04 78 17 30 28", "sav69@bimp.fr", "Lyon"),
            "S" => array("04 77 81 58 12", "sav42@bimp.fr", "Saint-Etienne"),
            "GB" => array("04 76 23 05 18", "sav38@bimp.fr", "Grenoble boutique"), "GA" => array("04 76 23 05 18", "sav38@bimp.fr", "Grenoble (Arts et Métiers)"),
            "B" => array("09 70 72 12 33", "sav250@bimp.fr", "Besançon"),
            "MO" => array("03 81 95 19 20", "sav252@bimp.fr", "Montbeliard"));
