		...
		if (!empty($this->array_options)) {
			...
			foreach ($new_array_options as $key => $value) {
				...
				switch ($attributeType) {
					...
					case 'password':
						$algo = '';
						if ($this->array_options[$key] != '' && isset($extrafields->attributes[$this->table_element]['param'][$attributeKey]['options']) && is_array($extrafields->attributes[$this->table_element]['param'][$attributeKey]['options'])) {
