...
class Resource extends CommonObject
{
    ...
    function load_previous_next_ref($filter, $fieldid, $nodbprefix =0)
    {
    	...
    	if (/*mod drsi*/$this->table_element != "usergroup" && /*fmod drsi*/isset($this->ismultientitymanaged) && $this->ismultientitymanaged == 2 || ($this->element != 'societe' && empty($this->isnolinkedbythird) && !$user->rights->societe->client->voir)) $sql.= ' AND te.fk_soc = s.rowid';			// If we need to link to societe to limit select to entity
