...
//        }
    ...
    public function sendMsg($msg_type = '')
    {
        ...
        $signature = file_get_contents("https://www.bimp.fr/signatures/v3/supports/sign.php?prenomnom=BIMP%20SAV&job=Centre%20de%20Services%20Agr%C3%A9%C3%A9%20Apple&phone=".$centre['tel'], false, stream_context_create(array(
            'http' => array(
