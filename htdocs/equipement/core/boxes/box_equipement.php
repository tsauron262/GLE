	...
	function loadBox($max=5)
	{
		...
		if ($user->rights->equipement->lire)
		{
			...
			if ($result)
			{
				...
				while ($i < $num)
				{
					$this->info_box_contents[$i][0] = array('td' => 'align="left" width="16"','logo' => 'object_equipement@equipement');
					...
					$this->info_box_contents[$i][3] = array('td' => 'align="right"', 'text' => ($objp->etatequipement?$langs->trans($objp->etatequipement):""));
					$this->info_box_contents[$i][4] = array('td' => 'align="right" width="18"', 'text' => $equipement_static->LibStatut($objp->fk_statut,3));
