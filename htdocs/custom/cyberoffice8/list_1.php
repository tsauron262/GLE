...
$arrayfields = array(
	...
	'customerorsupplier'=>array('label'=>'NatureOfThirdParty', 'position'=>61, 'checked'=>0),
	...
	's.import_key'=>array('label'=>"ImportId", 'checked'=>1, 'position'=>1100),
);
// Extra fields
...
$sql .= " s2.nom as name2,s.import_key,";
...
print '<div style="overflow:scroll; border:#000000 1px solid; width: 500px; height: 500px;">';
