...
//				}
	...
	public function getListExtraButtons()
	{
		...
		if ($this->isActionAllowed('transferStock') && $this->canSetAction('transferStock')) {
			$buttons[] = array(
				'label'   => 'Transférer stock',
				'icon'    => 'fas_exchange-alt',
				'onclick' => $this->getJsActionOnclick('transferStock', array(), array(
					'form_name' => 'transfer_stock'
				))
			);
		}
	...
	public function actionTransferStock($data, &$success)
	{
		$errors = array();
		$warnings = array();
		$success = '';
