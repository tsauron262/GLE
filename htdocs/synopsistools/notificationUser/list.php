...
while($result = $db->fetch_object($sql)){
    ...
    echo "<td><a href='".DOL_URL_ROOT."/synopsistools/notificationUser/card.php?id=".$result->idNU."'>".img_edit("Modifier")."</a></td>";
    echo "</tr>";
}
echo "</table>";

echo "<div class='divButAction'><a href='" . DOL_URL_ROOT . "/synopsistools/notificationUser/card.php'><input type='button' class='butAction' value='Nouveau'/></a></div>";
?>
