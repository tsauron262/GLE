...
$.datepicker._showDatepicker = function (input) {
    ...
    if (showTime) $.timepicker.show(input,inst);
}
    ...
    _generateHtml: function ()
    {
        ...
        $('#hourSlider').slider({
            ...
            stop: function(event, ui) {
                $('#' + self._inputId).focus();
                $('#' + self._inputId).datepicker.selectedHour = ui.value;
            }
        });
        ...
        $('#minuteSlider').slider({
            ...
            stop: function(event, ui) {
                $('#' + self._inputId).focus();
                $('#' + self._inputId).datepicker.selectedMin = ui.value;
            }
        });
