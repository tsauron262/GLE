 ...
 */
class pdf_tempete extends ModelePDFDeliveryOrder
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "tempete";
		$this->description = $langs->trans("DocumentModeltempete");
				...
				*/
				...
				for ($i = 0 ; $i < $nblines ; $i++)
				{
				  ...
				  //pdf_writelinedesc($pdf,$object,$i,$outputlangs,$this->posxqtyordered-10,3,$this->posxdesc,$curY,0,1);
					...
					$pdf->writeHTMLCell(140, 3, $this->posxdesc+10, $curY+4, $outputlangs->convToOutputCharset($strTemp), 0, 1);
