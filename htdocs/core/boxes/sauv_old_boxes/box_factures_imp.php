 ...
 * Foundation, Inc., 59 Temple Place - Suite 330, Boston, MA 02111-1307, USA.*//*
  ...
  *//*
 *
 * $Id: box_factures_imp.php,v 1.38 2008/05/30 07:22:10 ywarnier Exp $
 * $Source: /cvsroot/dolibarr/dolibarr/htdocs/core/boxes/box_factures_imp.php,v $
 */
        ...
        if ($user->rights->facture->lire)
        {
            ...
            if ($result)
            {
                ...
                while ($i < $num)
                {
                    ...
                    $late='';
                    if ($objp->datelimite < (time() - $conf->facture->warning_delay)) $late = img_warning(sprintf($l_due_date,dol_print_date($objp->datelimite,'day')));
