...
switch ($action)
{
    default :
    {
        ...
        $sql .= " FROM " . MAIN_DB_PREFIX . "Synopsis_Process_form";
        $sql.= " WHERE 1 = 1";
...
//        print $SQL;
        ...
        $sql = "SELECT f.id,
                       ...
                       f.description,
                       f.fk_statut";
        $sql .= " FROM " . MAIN_DB_PREFIX . "Synopsis_Process_form as f";
        $sql.= " WHERE 1 = 1";
        ...
        while($obj = $db->fetch_object($result))
        {
            ...
            $responce->rows[$i]['cell']=array($obj->id,
                                              utf8_encode($obj->label),
                                              utf8_encode($obj->description),
                                              utf8_encode($obj->fk_statut),
                                              );
            $i++;
        }
