...
//            return $instance->id;
    ...
    public function displayEcheancier($data, $display, $header = true) {
        ...
        if($this->getData('next_facture_date') < "2000-01-01" || $this->getData('next_facture_date') < $dateFin->add(new DateInterval('P1D'))->format('Y-m-d 00:00:00'))
...
//                }
            ...
            if(($user->rights->facture->creer && $reste_periodeEntier == 0 && round($parent->getCurrentTotal(), 2) - round($parent->getTotalDejaPayer(), 2) != 0) && $parent->getData('statut') == 11)
