...
//global $oldPref, $nbIframeMax, $nbIframe, $nbErreur;
    ...
    function majSAv($mailTech = false) {
        ...
        $this->verifOBj("Propal", "Propal sans Sav", "SELECT rowid from llx_propal where rowid not in (select propalid from llx_synopsischrono_view_105) AND extraparams is null AND ref LIKE 'PR%'", 'ligneSav');
