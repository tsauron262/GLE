 ...
 *
 *  \file       htdocs/mymodule/core/modules/ modbimpcontratauto.class.php
 *  \ingroup    mymodule
 ...
 */
class modBimpRemoveDuplicate extends DolibarrModules {
    ...
    public function __construct($db) {
        ...
        $this->numero = 826385;  // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'BimpRemoveDuplicate';
        ...
        $this->description = "Enlever les doublons dans la BDD";
        // Used only if file README.md and README-LL.md not found.
        $this->descriptionlong = "Enlever les doublons dans la BDD";
...
//            'categories_0:+restreindre:Restreindre:@bimpproductbrowser:$user->rights->bimpproductbrowser->read:/bimpproductbrowser/browse.php?id=__ID__',
        ...
        if (!isset($conf->modBimpRemoveDuplicate) || !isset($conf->modBimpRemoveDuplicate->enabled)) {
            $conf->modBimpRemoveDuplicate = new stdClass();
            $conf->modBimpRemoveDuplicate->enabled = 0;
        }
...
//        $this->rights[$r][5] = '';        // In php code, permission will be checked by test if ($user->rights->mymodule->level1->level2)
        ...
        /* BEGIN MODULEBUILDER LEFTMENU MYOBJECT */
                ...
                $this->menu[$r] = array(
            'fk_menu' => 'fk_mainmenu=companies,fk_leftmenu=thirdparties', // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode of parent menu
            'type' => 'left', // This is a Left menu entry
            'titre' => 'Bimp doublons',
            'mainmenu' => 'companies',
            'leftmenu' => 'thirdparties',
            'url' => '/bimpremoveduplicate/removeduplicatecustomer.php',
