 ...
 */
class pdf_propaleGA_jaune extends ModelePDFPropalesGA
{
    ...
    */
    function pdf_propaleGA_jaune($db=0)
    {
        ...
        $this->db = $db;
        $this->name = "jaune";
        $this->description = "Mod&egrave;le de proposition Jaune";
    ...
    */
    ...
    function write_file($propale,$outputlangs='')
    {
        ...
        {
            // Definition de l'objet $propal (pour compatibilite ascendante)
