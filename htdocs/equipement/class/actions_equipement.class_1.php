...
{ 
	...
	function addSearchEntry ($parameters, $object, $action) 
	{
		global $confg, $langs;
		$resArray=array();
		$resArray['searchintoequipement']=array('text'=>img_picto('','object_equipement@equipement').' '.$langs->trans("Equipement", GETPOST('q')), 'url'=>dol_buildpath('/equipement/list.php?sall='.urlencode(GETPOST('q')),1));
