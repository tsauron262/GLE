...
/*              $xml .= "<qteTktPerDuree><![CDATA[".$res->GMAO_qteTktPerDuree."]]></qteTktPerDuree>";
                ...
                $xml .= "<qteTempsPerDureeM><![CDATA[".$arrDur['minutes']['rel']."]]></qteTempsPerDureeM>";*/
                        ...
                        if (jQuery(msg).find('fk_contrat_prod').text() + "x" != "x") {
                            ...
                            var url = DOL_URL_ROOT + '/product/ajaxproducts.php';
                            var curId = 'keysearchp_idContratprod_mod';
                            var retId = 'ajdynfieldp_idContratprod_mod';
                            var param = 'htmlname=p_idContratprod_mod&price_level=&type=2&mode=1&status=1&prodId=' + jQuery(msg).find('fk_contrat_prod').text();
                            jQuery.ajax({
                                datatype: "html",
                                url: url,
                                data: param,
                                ...
                                success: function(data){
                                    ...
                                    if (fkProd > 0) {
                                        ...
                                        var param = 'htmlname=p_idprod_mod&price_level=&type=0&mode=1&status=1&prodId=' + fkProd;
                                        jQuery.ajax({
                                            datatype: "html",
                                            url: url,
                                            data: param,
