 ...
 */
class modBimplocation extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 3507000;  // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'bimplocation';
        ...
        $this->description = "Location de matériel";
...
//            1 => array('MYMODULE_MYCONSTANT', 'chaine', 'avalue', 'This is a constant to add', 1, 'allentities', 1)
        ...
        if (!isset($conf->modBimpvalidation) || !isset($conf->modBimpvalidation->enabled)) {
            $conf->modBimpvalidation = new stdClass();
            $conf->modBimpvalidation->enabled = 0;
        }
...
//        );
        ...
        $this->cronjobs = array(
//            0 => array(
//                'label'         => 'Rappels validations',
//                'jobtype'       => 'method',
//                'class'         => '/bimpvalidation/class/BimpValidationCronExec.class.php',
//                'objectname'    => 'BimpValidationCronExec',
//                'method'        => 'sendRappels',
//                'parameters'    => '',
//                'comment'       => 'Envoie un email aux valideurs qui ont des demandes à traiter',
//                'frequency'     => 2,
//                'unitfrequency' => 3600,
//                'status'        => 1,
//                'test'          => true
...
//        $this->rights[$r][1] = 'Gérer les règles de validation'; // Permission label
//        $this->rights[$r][3] = 0;      // Permission by default for new user (0/1)
//        $this->rights[$r][4] = 'rule';    // In php code, permission will be checked by test if ($user->rights->mymodule->level1->level2)
