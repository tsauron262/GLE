 ...
 */
class modBimpvalidation extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 3504000;  // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'bimpvalidion';
        ...
        $this->description = "Gestion des validations";
