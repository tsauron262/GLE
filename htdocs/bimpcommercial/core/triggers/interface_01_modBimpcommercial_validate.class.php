...
//                setEventMessages($msg, null, 'errors');
            ...
            if ($action == 'ORDER_VALIDATE' && $object->array_options['options_type'] != "M" && !BimpDebug::isActive('bimpcommercial/no_validate') && !defined('NOT_VERIF') && BimpTools::getConf('NOT_FORCE_CONTACT')) {
                //contact facturation
