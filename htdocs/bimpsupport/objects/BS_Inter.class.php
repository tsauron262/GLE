    ...
    public function create(&$warnings = array(), $force_create = false)
    {
        ...
        if (!count($errors)) {
            ...
            if($parent->getData('id_user_client') > 0) {
                ...
                mailSyn2("BIMP CLIENT : Intervention sur votre ticket : " . $parent->getData('ticket_number'), implode(', ', $liste_destinataires), 'admin@bimp.fr', "Une intervention a été créée sur votre ticket N°" . $this->getData('ticket_number'));
            }
