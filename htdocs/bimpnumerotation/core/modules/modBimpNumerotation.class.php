 ...
 */
class modBimpNumerotation extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 515486;		// TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'bimpnumerotation';
		...
		$this->description = "BimpNumerotation";
...
//		$this->config_page_url = array("setup.php@mymodule");
		...
		$this->langfiles = array("bimpnumerotation@bimpnumerotation");
       ...
       // );
		...
		$r++;
						    // In php code, permission will be checked by test if ($user->rights->mymodule->level1->level2)
