...
#	Copyright notice
#
#	(c) 2015 Jérôme Schneider <mail@jeromeschneider.fr>
#	All rights reserved
#
...
define("PROJECT_DB_MYSQL_HOST", $conf->db->host);

# MySQL > Database name
define("PROJECT_DB_MYSQL_DBNAME", $conf->db->name);

# MySQL > Username
define("PROJECT_DB_MYSQL_USERNAME", $conf->db->user);
//
//# MySQL > Password
define("PROJECT_DB_MYSQL_PASSWORD", $dolibarr_main_db_pass);

# A random 32 bytes key that will be used to encrypt data
//define("BAIKAL_ENCRYPTION_KEY", '12f49805d1b0e1d3ace24933bae7a5b6');
define("BAIKAL_ENCRYPTION_KEY", '24faebaabcdabac8b167f85dcfa3b2f7');
