<?php
      ...
      try
      {
         ...
         $labelDeliveryDO = $das->createDataObject('','LabelDeliveryType');
         $labelLinkIndDO = $das->createDataObject('','LabelLinkIndicator');
         $resendEmailIndDO = $das->createDataObject('','ResendEMailIndicator');
         $labelDeliveryDO->LabelLinkIndicator = $labelLinkIndDO;
         $labelDeliveryDO->ResendEMailIndicator = $resendEmailIndDO;
         $root->LabelDelivery = $labelDeliveryDO;
         $root->TrackingNumber = '';
