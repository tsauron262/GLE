...
function newGrid(TableName) {
  ...
  ex4_buffer=null;
  ex4_grid=null;
  ex4_buffer=new Rico.Buffer.AjaxSQL('ricoXMLquery.aspx', { requestParameters: ['id=ex4'+TableName] }); // override the id sent in the ajax request
