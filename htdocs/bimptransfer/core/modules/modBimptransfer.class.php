 ...
 *
 *  \file       htdocs/mymodule/core/modules/modProductBrowser.class.php
 *  \ingroup    mymodule
 ...
 */
class modBimptransfer extends DolibarrModules {
    ...
    public function __construct($db) {
        ...
        $this->numero = 14561932;  // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'bimptransfer';
        ...
        $this->description = "Transfert de produit/équipement";
        // Used only if file README.md and README-LL.md not found.
        $this->descriptionlong = "Transfert de produit/équipement";
...
//        );
        ...
        $this->rights[$r][1] = 'Envoyer'; // Permission label
        $this->rights[$r][3] = 0;      // Permission by default for new user (0/1)
        $this->rights[$r][4] = 'send';    // In php code, permission will be checked by test if ($user->rights->mymodule->level1->level2)
        $this->rights[$r][5] = '';        // In php code, permission will be checked by test if ($user->rights->mymodule->level1->level2)

        $r++;
        $this->rights[$r][0] = $this->numero + $r; // Permission id (must not be already used)
        $this->rights[$r][1] = 'Recevoir'; // Permission label
        $this->rights[$r][3] = 0;      // Permission by default for new user (0/1)
        $this->rights[$r][4] = 'receive';    // In php code, permission will be checked by test if ($user->rights->mymodule->level1->level2)
        $this->rights[$r][5] = '';        // In php code, permission will be checked by test if ($user->rights->mymodule->level1->level2)
        ...
        $this->rights[$r][3] = 0;      // Permission by default for new user (0/1)
        $this->rights[$r][4] = 'admin';    // In php code, permission will be checked by test if ($user->rights->mymodule->level1->level2)
        $this->rights[$r][5] = '';        // In php code, permission will be checked by test if ($user->rights->mymodule->level1->level2)
// Main menu entries
...
//        $r = 1;
        ...
        /* BEGIN MODULEBUILDER TOPMENU
          ...
          'titre'=>'MyModule',
          'mainmenu'=>'modProductBrowser',
          'leftmenu'=>'',
          'url'=>'/bimpproductbrowser/modProductBrowser.php',
          'langs'=>'mymodule@mymodule',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
          'position'=>1000+$r,
          'enabled'=>'$conf->bimpproductbrowser->enabled',	// TODO changer path peut-être	 Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
