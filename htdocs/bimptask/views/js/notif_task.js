...
class notif_task extends AbstractNotification {
    ...
    updateNavs() {
        ...
        if (this.nb_affectd_msgs) {
            html += '&nbsp;&nbsp;<span style="font-size: 11px; font-style: italic; font-weight: normal">(' + this.nb_affectd_msgs + ' message' + (this.nb_affectd_msgs > 1 ? 's' : '') + ' non lu' + (this.nb_affectd_msgs > 1 ? 's' : '') + ')</span>';
        }
        $nav.html(html);
