...
/*
  ...
  */
  ...
  if ($userId > 0)
  {
    $requete = "DELETE FROM ".MAIN_DB_PREFIX."synopsisfichinter_User_PrixTypeInterv WHERE user_refid = ".$userId;
    ...
    {
        $requete = "INSERT INTO ".MAIN_DB_PREFIX."synopsisfichinter_User_PrixTypeInterv
  ...
  if ($userId > 0)
  {
    ...
    $requete = "DELETE FROM ".MAIN_DB_PREFIX."synopsisfichinter_User_PrixDepInterv WHERE user_refid = ".$userId;
    $sql = $db->query($requete);
    $error = 0;
    if (!$sql) $error++;
    ...
    foreach($priceArr as $key=>$val)
    {
        $requete = "INSERT INTO ".MAIN_DB_PREFIX."synopsisfichinter_User_PrixDepInterv
