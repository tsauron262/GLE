...
/*
  ...
  */
    ...
    if($_REQUEST['action'] == "moveDown"){
        $id = $_REQUEST['id'];
        $requete = "UPDATE ".MAIN_DB_PREFIX."synopsisfichinter_extra_key
    ...
    {
        $requete = "INSERT INTO ".MAIN_DB_PREFIX."synopsisfichinter_extra_values_choice
    ...
    {
        $requete = "DELETE FROM ".MAIN_DB_PREFIX."synopsisfichinter_extra_values_choice
                          WHERE id=".$arr[1];
//print $requete;
        $sql = $db->query($requete);
    }
    ...
    {
        $requete="INSERT INTO ".MAIN_DB_PREFIX."synopsisfichinter_extra_key
                              (label,type)
    ...
    {
        $requete="DELETE FROM ".MAIN_DB_PREFIX."synopsisfichinter_extra_key
