        ...
        try {
            ...
            if ($res) {
                ...
                switch ($index) {
                    ...
                    case 'EMX' : $emailConfig = new EmailConfiguration();
                                //$emailConfig->setTestEmail("test");
                                if (isset($_REQUEST['chkTestEmail']) && $_REQUEST['chkTestEmail']=='on' && isset($_REQUEST['txtTestEmail']) && $_REQUEST['txtTestEmail']."x" != 'x' )
                                {
                                    $emailConfig->setTestEmail($_REQUEST['txtTestEmail']);
                                    $emailConfig->setTestEmailType($_REQUEST['txtMailType']);
