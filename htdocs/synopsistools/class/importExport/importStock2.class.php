...
//    CONST CHAMP_STOCK = 'ArdStk';
    ...
    public function go() {
//        $this->db->query("DELETE FROM `llx_product_stock` WHERE `fk_entrepot` IN (134,136,156,166,172,222, 170,256,258,224,262,366,368,370,426,429, 358,372,374,417,420,423)");
        parent::go();
