 ...
 */
class modsynopsisfav extends DolibarrModules {
    ...
    function __construct($DB) {
        ...
        $this->rights_class = 'modsynopsisfav';

        // Family can be 'crm','financial','hr','projects','products','ecm','technic','other'
        // It is used to group modules in module setup page
        $this->family = "Synopsis";
        // Module label (no space allowed), used if translation string 'ModuleXXXName' not found (where XXX is value of numeric property 'numero' of module)
        $this->name = "synopsisfav";
        $this->nameI = "synopsisfav";
        // Module description, used if translation string 'ModuleXXXDesc' not found (where XXX is value of numeric property 'numero' of module)
        $this->description = "Ajoute des Favori par Client";
        ...
        $this->config_page_url = array("Synopsis_Fav.php@synopsisfav");
