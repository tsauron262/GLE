...
if (empty($reshook))
{
	...
	*/
	...
	elseif ($action == 'updateline' && $user->rights->facture->creer && ! GETPOST('cancel'))
	{
...
else if ($id > 0 || ! empty($ref))
{
		...
		if (empty($reshook)) {
			...
			if ($user->rights->facture->supprimer)
			{
				...
				print '<div class="inline-block divButAction"><a class="butActionRefused" href="#" title="' . $langs->trans("NotAllowed") . '">' . $langs->trans('Delete') . '</a></div>';
					...
					print '<div class="inline-block divButAction"><a class="butActionDelete" href="' . DOL_URL_ROOT.'/synopsistools/mailRequest.php?action=annulObj&id='.$id.'">' . $langs->trans('Demande Annulation') . '</a></div>';
	...
	if ($action != 'prerelance' && $action != 'presend')
	{
		...
		if ($linktoelem) print '<br>'.$linktoelem;
			...
			print '<br><a href="#" id="linktopropal">' . $langs->trans('Lier à une propal') . '</a>';
                        print '
