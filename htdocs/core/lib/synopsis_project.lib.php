...
function synopsis_project_prepare_head($projet)
{
    ...
    {
        $head[$h][0] = DOL_URL_ROOT.'/projet/gantt/gantt.php?id='.$projet->id;
    ...
    if ($projet->hasCout == 1)
    {
        $head[$h][0] = DOL_URL_ROOT.'/projet/cout.php?id='.$projet->id;
    ...
    if ($projet->hasRH == 1 && 0)
    {
        $head[$h][0] = DOL_URL_ROOT.'/projet/Hressources.php?id='.$projet->id;
    ...
    if ($projet->hasRessources == 1 && 0)
    {
        ...
        $head[$h][0] = DOL_URL_ROOT.'/projet/ressources.php?id='.$projet->id;
    ...
    {
        $head[$h][0] = DOL_URL_ROOT.'/projet/risque.php?id='.$projet->id;
    ...
    {
        $head[$h][0] = DOL_URL_ROOT.'/projet/pointage.php?id='.$projet->id;
    ...
    {
        $head[$h][0] = DOL_URL_ROOT.'/projet/agenda.php?id='.$projet->id;
    ...
    if ($projet->hasDocuments == 1)
    {
        ...
        $head[$h][0] = DOL_URL_ROOT.'/projet/document.php?id='.$projet->id;
    ...
    if ($projet->hasStats == 1 && 0)
    {
        ...
        $head[$h][0] = DOL_URL_ROOT.'/projet/stats.php?id='.$projet->id;
    ...
    {
        $head[$h][0] = DOL_URL_ROOT.'/projet/element.php?id='.$projet->id;
    ...
    $head[$h][0] = DOL_URL_ROOT.'/projet/info.php?id='.$projet->id;
