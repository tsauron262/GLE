 ...
 */
class modBimptask extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 182802;  // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'bimptask';
		...
		$this->description = "Bimp Task";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "Gestion des Taches";
...
//        $this->warnings_activation_ext = array();                 // Warning to show when we activate an external module. array('always'='text') or array('FR'='textfr','ES'='textes'...)
		...
		// );
		$this->const = array(//            1 => array('MYMODULE_MYCONSTANT', 'chaine', 'avalue', 'This is a constant to add', 1, 'allentities', 1)
		);
