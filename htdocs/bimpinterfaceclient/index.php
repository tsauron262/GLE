...
if ($userClient->isLoged()) {
    ...
    $langs->setDefaultLang($userClient->getData('lang'));
                            ...
                            <div class="collapse navbar-collapse">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    <div class="css-tooltip bottom">
                                        <li><a href="?lang=fr_fr" class=""><img width="20px" src="<?= DOL_URL_ROOT ?>/bimpinterfaceclient/views/img/lang/fr_fr.png" /></a></li>
                                        <span class="tt-content"><?= $langs->trans('menuLangFr') ?></span>
                                    </div>
                                    <div class="css-tooltip bottom">
                                        <li><a href="?lang=en_us" class=""><img width="20px" src="<?= DOL_URL_ROOT ?>/bimpinterfaceclient/views/img/lang/en_us.png" /></a></li>
                                        <span class="tt-content"><?= $langs->trans('menuLangEn') ?></span>
                                    </div>
                                    <div class="css-tooltip bottom">
                                        <li><a href="?lang=de_de" class=""><img width="20px" src="<?= DOL_URL_ROOT ?>/bimpinterfaceclient/views/img/lang/de_de.png" /></a></li>
                                        <span class="tt-content"><?= $langs->trans('menuLangDe') ?></span>
                                    </div>
                                    <div class="css-tooltip bottom">
                                        <li><a href="?lang=es_es" class=""><img width="20px" src="<?= DOL_URL_ROOT ?>/bimpinterfaceclient/views/img/lang/es_es.png" /></a></li>
                                        <span class="tt-content"><?= $langs->trans('menuLangEs') ?></span>
                                    </div>
