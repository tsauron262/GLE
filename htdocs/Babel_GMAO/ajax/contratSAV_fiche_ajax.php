    ...
    case 'getLineDet':
    {
        ...
        while ($res = $db->fetch_object($sql))
        {
            ...
            $requete = "SELECT durValid, qte,llx_product_serial_cont.serial_number,
                     ...
                     LEFT JOIN llx_product_serial_cont ON llx_product_serial_cont.element_id = Babel_GMAO_contratdet_prop.contratdet_refid AND llx_product_serial_cont.element_type='contratSAV'
