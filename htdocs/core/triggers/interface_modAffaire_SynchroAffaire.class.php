...
{
    global $db;
    $requete = "DELETE FROM Synopsis_Affaire_Element WHERE type='".$type."' AND element_id = ".$id;
    $db->query($requete);
}
    ...
    switch ($type)
    {
        case "commande":
        {
            ...
            $requete ="SELECT affaire_refid
                         FROM ".MAIN_DB_PREFIX."co_pr, Synopsis_Affaire_Element
        ...
        {
            $requete ="SELECT affaire_refid
                         FROM ".MAIN_DB_PREFIX."co_fa, Synopsis_Affaire_Element
        ...
        {
            $requete ="SELECT affaire_refid
                         FROM ".MAIN_DB_PREFIX."co_liv, Synopsis_Affaire_Element
            ...
            $requete ="SELECT affaire_refid
                         FROM ".MAIN_DB_PREFIX."co_exp, Synopsis_Affaire_Element
                        WHERE fk_livraison = ".$obj->id ."
        ...
        {
            $requete ="SELECT affaire_refid
                         FROM Babel_li_fourn_co_fa, Synopsis_Affaire_Element
                        WHERE fk_facture = ".$obj->id ."
                          AND fk_commande = element_id
                          AND type='commande'";
            $sql = $obj->db->query($requete);
