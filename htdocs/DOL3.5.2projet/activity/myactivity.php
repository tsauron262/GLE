...
$head .= '{"data-file":"'.DOL_URL_ROOT.'/projet/activity/myactivity-pie-chart.php?dur=effective&userId=59"} );';
...
$head .= '{"data-file":"'.DOL_URL_ROOT.'/projet/activity/myactivity-pie-chart.php?dur=planed&userId=59"} );';
