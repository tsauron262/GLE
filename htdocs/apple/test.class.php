...
class GSX {
	...
	protected function assign_wsdl ( ) {
		...
		if ( $this->gsxDetails['gsxWsdl'] != '' ) {
			...
			return $this->wsdlUrl = 'https://gsxwsit.apple.com:443/wsdl/' . strtolower ( $this->gsxDetails['regionCode'] ) . 'Asp/gsx-' . strtolower ( $this->gsxDetails['regionCode'] ) . 'Asp.wsdl';
		} else {
			$this->wsdlUrl = 'https://gsxws2' . $api_mode . '.apple.com:443/wsdl/' . strtolower ( $this->gsxDetails['regionCode'] ) . 'Asp/gsx-' . strtolower ( $this->gsxDetails['regionCode'] ) . 'Asp.wsdl';
