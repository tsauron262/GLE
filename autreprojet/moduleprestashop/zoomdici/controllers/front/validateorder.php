...
class zoomdiciValidateOrderModuleFrontController extends ModuleFrontController {
   /* public $auth = true;
    public $php_self = 'validateorder';
    public $authRedirection = 'myaccount';*/
...
//http://192.168.0.78/~tilito/prestashop/index.php?fc=module&module=zoomdici&controller=validateorder&id_order=18 TODO remove
    public function initContent() {
        ...
        } elseif (!$is_good_user || !$this->context->customer->isLogged(true))
			$html.= "pas de login".$id_order;//Tools::redirect('index.php');
        elseif (!$is_valid) {
        ...
        parent::initContent();
        $this->setTemplate('validateorder.tpl');
        echo $script;
    }
