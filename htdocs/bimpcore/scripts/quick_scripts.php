...
switch ($action) {
    ...
    case 'aj_menu_compta':
        global $db;
        $sql = $db->query("SELECT rowid FROM `".MAIN_DB_PREFIX."menu` WHERE `titre` = 'Comptabilité';");
