...
<td valign="middle" class="nowrap">
<input id="password" name="password" class="flat" type="password" size="15" maxlength="30" value="<?php echo dol_escape_htmltag($password); ?>" tabindex="2" autocomplete="<?php echo (defined('IP_EXTERIEUR') && $_SERVER["REMOTE_ADDR"] == IP_EXTERIEUR)? "off" : "on"; ?>" />
</td></tr>
<?php
