...
class MailNotifications {
    ...
    */
    private function _approveMail() {
        ...
        $this->templateFile = utf8_decode(file_get_contents(ROOT_PATH."/templates/leave/mails/".self::MAILNOTIFICATIONS_TEMPLATE_APPROVE));
        ...
        if (isset($leaveObjs[0])) {
            ...
            $this->subject = utf8_decode($this->_getMailSubject(self::MAILNOTIFICATIONS_TEMPLATE_APPROVE_SUBJECT,
    ...
    */
    private function _rejectMail() {
        ...
        $this->templateFile = utf8_decode(file_get_contents(ROOT_PATH."/templates/leave/mails/".self::MAILNOTIFICATIONS_TEMPLATE_REJECT));
        $txt = $this->templateFile;
        ...
        if (isset($leaveObjs[0])) {
            ...
            $this->subject = utf8_decode($this->_getMailSubject(self::MAILNOTIFICATIONS_TEMPLATE_REJECT_SUBJECT,
                                                    $employeeName, $fulldays));
    ...
    */
    private function _applyMail() {
        ...
        $this->templateFile = utf8_decode(file_get_contents(ROOT_PATH."/templates/leave/mails/".self::MAILNOTIFICATIONS_TEMPLATE_APPLY));
        $txt = $this->templateFile;
        ...
        if (isset($leaveObjs[0])) {
            ...
            $this->subject = utf8_decode($this->_getMailSubject(self::MAILNOTIFICATIONS_TEMPLATE_APPLY_SUBJECT,
                                                    $employeeName, $fulldays));
    ...
    private function _assignMail() {
        ...
        $this->templateFile = utf8_decode(file_get_contents(ROOT_PATH."/templates/leave/mails/".self::MAILNOTIFICATIONS_TEMPLATE_ASSIGN));
        $txt = $this->templateFile;
        ...
        if (isset($leaveObjs[0])) {
            ...
            $this->subject = utf8_decode($this->_getMailSubject(self::MAILNOTIFICATIONS_TEMPLATE_ASSIGN_SUBJECT,
                                                    $employeeName, $fulldays));
    ...
    */
    private function _cancelMail() {
        ...
        if ($this->action == self::MAILNOTIFICATIONS_ACTION_SUPERVISOR_CANCEL) {
            $this->templateFile = utf8_decode(file_get_contents(ROOT_PATH."/templates/leave/mails/".self::MAILNOTIFICATIONS_TEMPLATE_SUPERVISOR_CANCEL));
        } else {
            $this->templateFile = utf8_decode(file_get_contents(ROOT_PATH."/templates/leave/mails/".self::MAILNOTIFICATIONS_TEMPLATE_CANCEL));
        }
        ...
        if (isset($leaveObjs[0])) {
            ...
            if ($this->action == self::MAILNOTIFICATIONS_ACTION_SUPERVISOR_CANCEL) {
                $subjectTemplate = utf8_decode(self::MAILNOTIFICATIONS_TEMPLATE_SUPERVISOR_CANCEL_SUBJECT);
                $this->to = $this->subordinateMail;
            } else {
                $subjectTemplate = utf8_decode(self::MAILNOTIFICATIONS_TEMPLATE_CANCEL_SUBJECT);
                $this->to = $this->supervisorMail;
            }
