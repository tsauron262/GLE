...
class mod_contrat_tourmaline extends ModeleNumRefContrat
{
    ...
    function info()
    {
        ...
        $texte.= '<td align="right">'.$form->textwithtooltip('<input type="text" class="flat" size="24" name="maskcontrat" value="'.$conf->global->CONTRAT_TOURMALINE_MASK.'">',$langs->trans("GenericMaskCodes",$langs->transnoentities("Contrat"),$langs->transnoentities("Contrat"),$langs->transnoentities("Contrat")),1,1).'</td>';
