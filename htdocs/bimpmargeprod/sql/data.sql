...
--
-- Contenu de la table `llx_bmp_event`
--

INSERT INTO `llx_bmp_event` (`id`, `name`, `date`, `type`, `place`, `status`, `analytics`, `ca_moyen_bar`, `tva_billets`, `frais_billet`, `default_dl_dist`, `default_dl_prod`, `user_create`, `date_create`, `user_update`, `date_update`, `bar_20_save`, `bar_55_save`, `billets_loc`) VALUES
...
--
-- Contenu de la table `llx_bmp_event_billets`
--

INSERT INTO `llx_bmp_event_billets` (`id`, `id_event`, `id_soc_seller`, `seller_name`, `id_tarif`, `quantity`, `dl_dist`, `dl_prod`, `id_coprod`) VALUES
...
--
-- Contenu de la table `llx_bmp_event_calc_montant`
--

INSERT INTO `llx_bmp_event_calc_montant` (`id`, `id_event`, `id_calc_montant`, `percent`, `source_amount`, `active`) VALUES
(1, 4, 16, 7.744, 0, 0),
(2, 4, 9, 1.1, 0, 1),
(3, 4, 7, 3.37, 0, 1),
(4, 4, 3, 50, 0, 1),
...
--
-- Contenu de la table `llx_bmp_event_coprod`
--

INSERT INTO `llx_bmp_event_coprod` (`id`, `id_event`, `id_soc`, `default_part`) VALUES
(1, 4, 79980, 25),
(2, 4, 79628, 25),
(3, 6, 79674, 30);
...
--
-- Contenu de la table `llx_bmp_event_coprod_part`
--

INSERT INTO `llx_bmp_event_coprod_part` (`id_event_montant`, `id_coprod`, `part`) VALUES
(31, 2, 50),
(47, 2, 0),
(47, 1, 100),
(35, 1, 99),
...
--
-- Contenu de la table `llx_bmp_event_montant`
--

INSERT INTO `llx_bmp_event_montant` (`id`, `id_event`, `id_category_montant`, `id_montant`, `amount`, `tva_tx`, `status`, `type`, `comment`, `id_coprod`, `paiements`) VALUES
...
--
-- Contenu de la table `llx_bmp_event_montant_detail`
--

INSERT INTO `llx_bmp_event_montant_detail` (`id`, `id_event_montant`, `label`, `quantity`, `unit_price`) VALUES
(11, 39, 'Plateau', 0, 330),
...
--
-- Contenu de la table `llx_bmp_event_tarif`
--

INSERT INTO `llx_bmp_event_tarif` (`id`, `id_event`, `name`, `amount`, `previsionnel`, `droits_loc`, `droits_loc_coprods`) VALUES
