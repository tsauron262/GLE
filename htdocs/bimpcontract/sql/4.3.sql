...
SELECT CONCAT(cd.rowid, f.rowid) as id, cd.fk_contrat, cd.fk_product, f.rowid as fk_facture, cd.rowid as fk_contratdet, f.total_ht as totalFact, cd.total_ht as totalLn, datef as datef, renouvellement
