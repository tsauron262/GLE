...
<table border="0" cellpadding="0" cellspacing="0">
  <thead>
    ...
    <tr>
        ...
        <th width="60px" class="tableMiddleMiddle"><?php echo $lang_Leave_Common_LeaveType;?></th>
        ...
        <th width="50px" class="tableMiddleMiddle"><?php echo $lang_Leave_Common_Comments;?></th>
        <th width="50px" class="tableMiddleMiddle"><?php echo "$lang_Leave_Common_LeaveRemaining ($lang_Common_Days)";?></th>
...
?>
  <tr>
    ...
    <td class="<?php echo $cssClass; ?>"><?php
    $arr = array();
    $yearQuota =  date('Y',strtotime($record->getLeaveFromDate()));
    $arr =  $record->fetchAllEmployeeLeaveSummary( $yearQuota);
    print $arr[0]['leave_available'];
    ?></td>
    <td class="tableMiddleRight"></td>
  </tr>
