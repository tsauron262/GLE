...
/*style bimp*/
div#id-top,
div.side-nav, .vmenu, div.blockvmenuend, div.blockvmenubookmarks, div.blockvmenusearch, .vmenu a,
...
.liste_titre a:not(.select2-choice),
tr.liste_titre, #id-left span.help, #id-left span.select2-chosen{
    color: white!important;
    opacity: 1!important;
}
.ulselectedfields{
...
#id-left .select2-container .select2-choice .select2-arrow b {
   background: rgba(0, 0, 0, 0) url("<?php  echo DOL_URL_ROOT  ?>/synopsistools/img/select2_white.png") no-repeat scroll 0 1px!important;
}
/*fstyle bimp*/
