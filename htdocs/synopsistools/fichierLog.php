...
$tabPrefixe = array("" => "Général", "_deprecated" => "Deprecated", "_recur" => "Récurent", "_mail" => "Mail", "_sms" => "SMS", "_apple" => "Apple", "_apple2" => "Apple2", "_time" => "Pages lentes", "_caldav" => "CalDav", "_sauv" => "Sauv");
