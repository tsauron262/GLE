...
if (isset($conf->global->MAIN_MODULE_SYNOPSISCALDAV)) {
    $lienG = ((isset($_SERVER['SERVER_PORT']) && $_SERVER['SERVER_PORT']  == 443) || (isset($_SERVER['HTTP_X_FORWARDED_PROTO']) && $_SERVER['HTTP_X_FORWARDED_PROTO'] == 'https') ? 'https' : 'http') ."://". $_SERVER['HTTP_HOST'].DOL_URL_ROOT."/synopsiscaldav/html/cal.php/";
