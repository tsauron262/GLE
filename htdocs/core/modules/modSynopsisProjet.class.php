...
class modSynopsisProjet extends DolibarrModules {
    ...
    function modSynopsisProjet($DB) {
        ...
        $this->special = 0;
        $this->picto = 'project';
        $this->langfiles = array("project@projet");
        ...
        $this->rights[7][1] = 'Modifier les projet/tache des autres'; // libelle de la permission
        $this->rights[7][2] = 'c'; // type de la permission (deprecie a ce jour)
       ...
       /* $this->menu[$r] = array('fk_menu' => 'r=' . $s,
        ...
        $this->tabs = array('user:+coutUser:Coût horaire:@monmodule:/projet/userPrix.php?id=__ID__');
    }
