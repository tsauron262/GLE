...
//                    $fullQty = abs($fullQty);
	...
	public function initBdsActionCheckPeriodicityData($process, &$action_data = array(), &$errors = array(), $extra_data = array())
	{
		...
		$id_client = (int) BimpTools::getArrayValueFromPath($extra_data, 'id_client', 0);
		$id_fourn = (int) BimpTools::getArrayValueFromPath($extra_data, 'id_fourn', 0);
		$id_product = (int) BimpTools::getArrayValueFromPath($extra_data, 'id_product', 0);
