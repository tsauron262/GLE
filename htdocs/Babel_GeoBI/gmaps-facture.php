...
//    jQuery.getJSON('ajax/test.json.php', function(pData) {
    jQuery.getJSON('ajax/facture.json.php', function(pData) {
      data = pData;
 ...
 function refreshMap() {
            ...
            marker[i] = new google.maps.Marker({
             ...
             infowindow[i] = new google.maps.InfoWindow({  content: '<div id="content">\
                        ...
                        <p><div style="height: 340px; width: 450px;"><table border=0 width=400>\
                            ...
                            <tr><td colspan=3><br/>\
                            <tr class="ui-widget-header ui-state-default"><td>Total factures clients\
      ...
      google.maps.event.addListener(marker[i], 'click', function() {
        for (var j=0;j<data.count;j++)
        {
         ...
         jQuery('#factureTable'+data.results[index].socid).visualize({
            width:380,
            height:200,
            appendTitle: true,
            title: "factures",
         });
         jQuery('#factureTable'+data.results[index].socid).parent().parent().parent().parent().parent().parent().parent().css('overflow','hidden');
      });
