			...
			if ($result)
			{
				...
				while ($i < $num)
				{
					...
					if ($objp->statueventlibelle)
						$this->info_box_contents[$i][3] = array('td' => 'align="right"', 'text' => $langs->trans($objp->statueventlibelle));
					else
						$this->info_box_contents[$i][3] = array('td' => 'align="right"', 'text' => $langs->trans("None"));
