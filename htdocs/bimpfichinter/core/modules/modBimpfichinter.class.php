 ...
 *
 *  \file       htdocs/bimpfichinter/core/modules/modBimpfichinter.class.class.php
 *  \ingroup    bimpfichinter
 *  \brief      Manage intervention
 */
...
class modBimpfichinter extends DolibarrModules {
    ...
    public function __construct($db) {
        ...
        $this->numero = 752519;  // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'Bimp_Fichinter';
        ...
        $this->description = "Manage intervention";
        // Used only if file README.md and README-LL.md not found.
        $this->descriptionlong = "Manage intervention";
...
//            'product:+categoriser:Catégoriser:@bimpproductbrowser:$user->rights->bimpproductbrowser->read:/bimpproductbrowser/categoriser.php?id=__ID__'
        ...
        if (!isset($conf->modProductBrowser) || !isset($conf->modProductBrowser->enabled)) {
            $conf->modProductBrowser = new stdClass();
            $conf->modProductBrowser->enabled = 0;
        }
