 ...
 */
class modBimpsupport extends DolibarrModules {
    ...
    public function __construct($db) {
        ...
        $this->description = "Gestion des support";
        // Used only if file README.md and README-LL.md not found.
        $this->descriptionlong = "Gestion support BIMP (Hotline + SAV)";
...
//        $r = 1;
        ...
        $this->menu[$r] = array(
            'fk_menu' => 'fk_mainmenu=bimpsupport', // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode of parent menu
