...
class BimpCommercialCronExec extends BimpCron
{
    ...
    public function hourlyChecks()
    {
		...
		$this->output .= '<br/><br/>***** Vérifs Marges commandes mises à jour *****<br/>';
		$commande_class = '';
		BimpObject::loadClass('bimpcommercial', 'Bimp_Commande', $commande_class);
		$this->output .= $commande_class::checkMargesAll();

		$this->output .= '<br/><br/>***** Vérifs Marges propal mises à jour *****<br/>';
		$propal_class = '';
		BimpObject::loadClass('bimpcommercial', 'Bimp_Propal', $propal_class);
		$this->output .= $propal_class::checkMargesAll();
