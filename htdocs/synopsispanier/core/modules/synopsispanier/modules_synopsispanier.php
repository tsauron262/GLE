...
class ModeleSynopsispanier extends CommonDocGenerator
{
    var $error='';
...
function panier_pdf_create($db, $object, $modele='', $outputlangs='')
{
    ...
    $dir = DOL_DOCUMENT_ROOT."/synopsispanier/core/modules/synopsispanier/doc/";
    $modelisok=0;
    ...
    {
        $liste=array();
        $model=new ModeleSynopsispanier();
