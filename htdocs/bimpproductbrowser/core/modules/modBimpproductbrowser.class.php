...
class modBimpproductbrowser extends DolibarrModules {
    ...
    public function __construct($db) {
        ...
        $this->rights_class = 'bimpproductbrowser';
        ...
        $this->description = "Allow the user to browse in product using categories on a single page";
        ...
        $this->version = '1.0';
        // Key used in l_const table to save module status enabled/disabled (where MYMODULE is value of property name of module in uppercase)
