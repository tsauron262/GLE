...
//    }
    ...
    function addSearchEntry($parameters, &$object, &$action, $hookmanager) {
        global $langs;
	$this->results['searchintochrono']=array('position' =>34, 'text'=>img_object("Chrono", "chrono@synopsischrono") . $langs->trans("Chrono"), 'url'=>DOL_URL_ROOT.'/synopsischrono/liste.php?mainmenu=Process&filtre='.GETPOST('q'));
        return 0;
    }
