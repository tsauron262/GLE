...
//        if (! $object->use_phenix) return 0;        // Option syncro phenix non active
        ...
        switch ($action)
        {
            ...
            break;
            case 'ECM_GENsynopsisdemandeinterv':
                $ecm->create_autogenerated('synopsisdemandeinterv',$object,$user,$conf);
            break;
            case 'ECM_GENLIVRAISON':
                $ecm->create_autogenerated('livraison',$object,$user,$conf);
            break;
            ...
            break;
            case 'ECM_UL_synopsisdemandeinterv':
                $ecm->create_assoc("synopsisdemandeinterv",$object, $this->texte,$user,$conf);
            break;
            case 'ECM_UL_DEL_synopsisdemandeinterv':
                //$ecm->create_assoc("synopsisdemandeinterv",$object, $this->texte,$user,$conf);
            break;
