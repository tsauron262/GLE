...
Rico.TableColumn.EURO    = {type:'number', suffix:'&euro;', decPlaces:2, ClassName:'alignright'}; //modif Babel => euro en suffix
 ...
 */
  baseInit: function(liveGrid,colIdx,hdrInfo,tabIdx) {
    ...
    this.hdrColDiv=(divs.length<1) ? RicoUtil.wrapChildren(this.hdrCell,'ui-state-default ui-widget-header') : divs[0];
