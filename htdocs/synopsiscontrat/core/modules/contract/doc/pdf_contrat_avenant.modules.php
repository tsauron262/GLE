...
//                    $pdf1->Cell($W, 4, "Article ".$current_article."", "L", null, 'L', true);
                ...
                $pdf->ln();
                $pdf->Cell($W*5, 4, "Ce contrat et ses avenants portent à ce jour sur un montant de " . $bContract->getTotalContrat() . ' € HT', 0, null, 'L', false);
                $pdf1->setY($pdf1->getY() + 5);
                $pdf1->SetFont('', '', 8);
                $pdf1->Cell($W, 4, "Article " . $current_article, "L", null, 'C', true);
                $pdf1->ln();
                ...
                $pdf1->ln();
                $pdf1->Cell($W*5, 4, "Ce contrat et ses avenants portent à ce jour sur un montant de " . $bContract->getTotalContrat() . ' € HT', 0, null, 'L', false);
                $current_article++;
