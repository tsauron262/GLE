...
class devController extends BimpController
{
	...
	public function renderDashboardTab()
	{
		...
		$date = new DateTime();
		$html .= 'New test serv Date serveur : ' . $date->format('d / m / Y H:i:s');
...
//        }
		...
		if (BimpCore::getExtendsVersion()) {
			$html .= '<b>' . BimpCore::getExtendsVersion() . '</b>';
		} else {
		...
		if (isset($conf->global->MAIN_MODULE_BIMPSECURLOGIN) && $conf->global->MAIN_MODULE_BIMPSECURLOGIN) {
