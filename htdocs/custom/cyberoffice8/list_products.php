...
if ($resql) {
	...
	$moreforfilter .= img_picto('prestashop', 'object_cyberoffice@cyberoffice8', 'class="pictofixedwidth"');
		...
		if (!empty($arrayfields['p.stock']['checked'])) {
			...
			if ($obj->fk_product_type != 1) {
				...
				print price(price2num($product_static->stock_reel, 'MS'));
                                ...
                                print $product_static->stock_warehouse[$entrepot_id]->real ;
			}
			print '</td>';
			if (!$i) {
				$totalarray['nbfield']++;
