 ...
 */
class modBimpuserConfig extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 3500000;  // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'bimpuserconfig';
        ...
        $this->description = "BimpUserConfig";
        ...
        $this->dirs = array("/bimpuserconfig/data");
        ...
        $this->langfiles = array("bimpuserconfig@bimpuserconfig");
