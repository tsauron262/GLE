...
class modSynopsishisto extends DolibarrModules {
    ...
    function __construct($DB) {
        ...
        $this->rights_class = 'modSynopsisHisto';

        // Family can be 'crm','financial','hr','projects','products','ecm','technic','other'
        // It is used to group modules in module setup page
        $this->family = "Synopsis";
        // Module label (no space allowed), used if translation string 'ModuleXXXName' not found (where XXX is value of numeric property 'numero' of module)
        $this->name = "SynopsisHisto";
        ...
        $this->config_page_url = array("Synopsis_Histo.php@synopsishisto");
    ...
    function init($options = '') {
        $sql = array("CREATE TABLE IF NOT EXISTS `" . MAIN_DB_PREFIX . "Synopsis_Histo_User` (
