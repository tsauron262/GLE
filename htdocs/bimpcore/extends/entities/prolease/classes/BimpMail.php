...
class BimpMail extends BimpMailCore
{
    ...
    public $title = 'LDLC';
    public $subtitle = 'PRO LEASE';
    public $from_name = 'LDLC PRO LEASE';
    ...
    function getHeader()
    {
        ...
        if ($this->title) {
            $html .= '<span style="font-size: 24px; font-weight: bold; color: #FFFFFF">';
            $html .= $this->title;
            $html .= '</span>';
        }

        if ($this->subtitle) {
            $html .= '   <span style="font-size: 18px; color: #FFFFFF">';
            $html .= $this->subtitle;
            $html .= '</span>';
        }
