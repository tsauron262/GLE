...
if ((int) BimpCore::getConf('use_centres_sav', null, 'bimpsupport')) {
	BimpCore::addlog('Fichier centre.inc require', 3);
}
...
$tabCentre = array(
    ...
    "CB"    => array("09 70 72 12 32", "sav73@ldlc.com", "Chambéry", 213, "1461034", "73000", "Chambéry", "150 rue croix d'or", 36, 1, null, '7fc5cb7c-1a59-480d-89e5-252b501a0017', '<span style="color:red"><p>Attention la boutique et le SAV <b>Apple</b> sont situés dans le centre de Chambery</p></span>'),
    ...
    "CF"    => array("04 63 46 76 37", "sav63@ldlc.com", "Chamalières OLD", 147, "1461020", "63000", "Clermont-Ferrand", "Centre Jaude 2 (1er Etage) 7 Rue Giscard de la Tour Fondue", 35, 0, 'idGroup'=>694),
