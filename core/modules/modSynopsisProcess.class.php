...
(2, \'select_users\', \'SELECTED||ID||SHOWEMPTY||EXCLUDE||DISABLED||DISPLAY\', \'Utilisateurs\', \'Liste des utilisateurs\', \'form\', \'/core/class/html.form.class.php\', 1, \'tmpReturn\', \'ID\', \'SELECTED\', \'$requete = "SELECT * FROM llx_user WHERE rowid=[[valeur]]";\n$sql = $db->query($requete);\n$res = $db->fetch_object($sql);\nreturn($res->name." ".$res->firstname);\'),
...
(4, \'fct_select_users\', \'SELECTED||ID||SHOWEMPTY||EXCLUDE||DISABLED||DISPLAY\', \'Utilisateurs\', \'Liste des utilisateurs\', \'user_fct\', \'/' . MAIN_DB_PREFIX . 'Synopsis_Process/user_fct.class.php\', 1, \'tmpReturn\', \'ID\', \'SELECTED\', \'$requete = "SELECT * FROM llx_user WHERE rowid=[[valeur]]";\n$sql = $this->db->query($requete);\n$res = $this->db->fetch_object($sql);\nreturn($res->name." ".$res->firstname);\');',
...
(1, \'SELECT name, firstname FROM llx_socpeople where name like \'\'%%%s\'\' order by name\', \'SELECT name, firstname FROM llx_socpeople where name like \'\'%%%s\'\' AND [[indexField]] order by name \', \'a\', 100, \'test query\', \'tezst query\', \'name, firstname\', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(10, \'SELECT rowid, name, firstname FROM llx_user WHERE rowid <> %s AND name like \'\'%%%s%%\'\' order by name\', \'SELECT rowid, name, firstname FROM llx_user WHERE rowid <> %s AND [[indexField]] AND name like \'\'%%%s%%\'\' order by name                                                            \', \'a:2:{i:0;s:13:"".$user->id."";i:1;s:1:"a";}\', 50, \'req14\', \'test\', \'N;\', \'rowid\', \'\', NULL, NULL, NULL, \'rowid\', \'rowid\', \'N;\'),
...
(12, \'SELECT p.rowid, p.ref, p.fk_soc, s.nom  FROM babel_projet as p, llx_societe as s where s.rowid = p.fk_soc order by s.nom, p.dateo \', \'SELECT p.rowid, p.ref, p.fk_soc, s.nom  FROM  babel_projet as p, llx_societe as s WHERE s.rowid = fk_soc AND [[indexField]] order by s.nom, p.dateo  , p.ref                   \', \'a:1:{i:0;s:0:"";}\', 100, \'requete projet/soc\', \'Toutes les projets par société\', \'a:1:{i:0;s:5:"rowid";}\', \'ref\', \'p\', NULL, NULL, NULL, \'rowid\', \'rowid\', \'a:1:{s:3:"ref";s:0:"";}\'),
(15, \'SELECT concat(ref,\'\' - \'\',title) as texte FROM babel_projet ORDER BY ref desc\', \'                                             \', \'a:1:{i:0;s:0:"";}\', 1000, \'req_projet\', \'liste des projets\', \'N;\', \'texte\', \'\', NULL, NULL, NULL, \'texte\', \'texte\', \'N;\');',
