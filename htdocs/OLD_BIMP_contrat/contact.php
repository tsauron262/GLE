...
/**
        ...
        \version    $Id: contact.php,v 1.27 2008/02/25 20:03:25 eldy Exp $
*/
...
if ($id > 0)
{
    ...
    if ($contrat->fetch($id) > 0)
    {
        ...
        */
        ...
        print '<tr><th width="25%" class="ui-widget-header ui-state-default">'.$langs->trans("Ref").'</td><td colspan="3" class="ui-widget-content">';
        print $contrat->ref;
        print "</td></tr>";
    ...
    {
        // Contrat non trouve
        print "Contrat inexistant ou acc&egrave;s refus&eacute;";
    }
}

$db->close();

llxFooter('$Date: 2008/02/25 20:03:25 $');
?>
