...
/*
  ...
  */
    ...
    $filterProcess= false;
    if ($_REQUEST['filterMyValid']."x" != "x") $filterMyValid = true;
    if ($_REQUEST['filterMyPossible']."x" != "x") $filterMyPossible = true;
    if ($_REQUEST['filterProcess'] > 0) $filterProcess = $_REQUEST['filterProcess'];
    ...
    while($res = $db->fetch_object($sql))
    {
        ...
        $process->fetch($res->process_refid);
