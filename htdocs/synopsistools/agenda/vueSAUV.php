...
llxHeader('<script type="text/javascript" src="' . DOL_URL_ROOT . '/synopsistools/agenda/agenda.js"></script>
    <link rel="stylesheet" type="text/css" href="' . DOL_URL_ROOT . '/synopsistools/agenda/agenda.css" />');
...
function printOneDayOneUser($userId, $date, $printUser = false, $printDate = false, $bg = "bgAgenda") {
    ...
    print "<img src='" . DOL_URL_ROOT . "/synopsistools/agenda/img/".$bg.".jpg' class='bgAgenda'/>";
    if ($printUser) {
