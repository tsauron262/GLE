...
if ($_REQUEST['chrono_refid'] > 0)
    $wh .= " AND revision is not null AND orig_ref IN (SELECT ref FROM ".MAIN_DB_PREFIX."Synopsis_Chrono WHERE id = ".$_REQUEST['chrono_refid'].")";
...
switch ($action)
{
    default :
    {
        ...
        $sql .= " FROM ".MAIN_DB_PREFIX."Synopsis_Chrono as st";
...
//        print $SQL;
        ...
        $sql .= " FROM ".MAIN_DB_PREFIX."Synopsis_Chrono as c ";
