 ...
 *
 */
dojo.provide("BabelCalWidget.widget.CalendarDialog");
...
dojo.declare(
    "BabelCalWidget.widget.CalendarDialogNewEntry",
    [dijit.Dialog],
{
    // summary:
    // This is the actual content.
    templatePath: dojo.moduleUrl("BabelCalWidget.widget","templates/newcalendarentry.html"),
    widgetsInTemplate: true,
    openerId: "newentrydialog",
    ne_subject: "",
    ne_location: "",
    ne_categories: "",
    ne_body:"",
    ...
    postCreate:function(){
        ...
        var dDate = new Date();
        this.ne_date.attr('value',dDate);
        this.ne_starttime.attr('value',dDate);
        dDate.setHours(dDate.getHours()+1);
        this.ne_endtime.attr('value',dDate);
    ...
    ok: function(){
        ...
        if(!isOk){
            dojo.require("BabelCalWidget.widget.ModalAlert");
            var params = {
                height: "230px",
                iconSrc: dojo.moduleUrl("BabelCalWidget.widget","templates/images/error.gif"),
                alertText: '<strong>Please edit/complete the following field(s):</strong><br />' + alertText
            };
            var modal = new BabelCalWidget.widget.ModalAlert(params);
        }else{
            var tmpBabel = "";
            if (this.ne_subject)
            {
                tmpBabel = this.ne_subject.value;
            } else {
                tmpBabel = "";
            }
            var oEntry = {
...
dojo.declare(
    "BabelCalWidget.widget.CalendarDialogTimezone",
    [dijit.Dialog],
    {
    // summary:
    // This is the actual content.
    templatePath: dojo.moduleUrl("BabelCalWidget.widget","templates/timezones.html"),
    widgetsInTemplate: true,
    openerId: "",
...
dojo.declare(
    "BabelCalWidget.widget.CalendarDialogChangeTime",
    [dijit._Widget, dijit._Templated],
{
    // summary:
    // This is the actual content.
    templatePath: dojo.moduleUrl("BabelCalWidget.widget","templates/changetime.html"),
    widgetsInTemplate: true,
    openerId: "",
    itemId: "",
    eventChanged: false,
...
dojo.declare(
    "BabelCalWidget.widget.CalendarDialog",
    [dijit._Widget],
    {
        // summary:
        //        Provides a Dialog which can be modal or normal.
        //templatePath: dojo.moduleUrl("BabelCalWidget.widget","templates/Editor2/EditorDialog.html"),
...
//            BabelCalWidget.widget.CalendarDialog.superclass.fillInTemplate.call(this, args, frag);
        },
        postCreate: function(){
            if(this.modal){
...
//          dojo.widget.FloatingPaneBase.prototype.postCreate.apply(this, arguments);
            BabelCalWidget.widget.CalendarDialog.superclass.postCreate.call(this);
        ...
        show: function(){
            if(!this.contentWidget){
                this.inherited(arguments);
//              BabelCalWidget.widget.CalendarDialog.superclass.show.apply(this, arguments);
                this.createContent();
                this.hide();
//              BabelCalWidget.widget.CalendarDialog.superclass.hide.call(this);
            }
...
//              place the background div under this modal pane
        ...
        onShow: function(){
            BabelCalWidget.widget.CalendarDialog.superclass.onShow.call(this);
            this.onFloatingPaneShow();
        },
        closeWindow: function(){
            this.hide();
            this.inherited(arguments);
//          BabelCalWidget.widget.CalendarDialog.superclass.closeWindow.apply(this, arguments);
        },
        hide: function(){
            if(this.modal){
