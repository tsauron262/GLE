 ...
 */
class modBimpnotesfrais extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->description = "Bimp Notes de frais";
...
//								'user'=>0);				                // 0=Menu for internal users, 1=external users, 2=both
  ...
  `cv` int(11) NOT NULL,
  `zero_cinq_mille` double NOT NULL,
  `cinq_mille_un_vingt_mille` double NOT NULL,
  `plus_vingt_mille` double NOT NULL,
  `ajout_euro` double NOT NULL,
...
"
  ...
  `client` varchar(12) COLLATE utf8_unicode_ci NOT NULL,
  `type_vehicule` int(11) NOT NULL,
  `type_carburant` int(11) NOT NULL,
  ...
  `lieu` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `date_create` datetime DEFAULT NULL,
  `user_create` int(11) DEFAULT NULL,
  `user_update` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
