...
require_once DOL_DOCUMENT_ROOT.'/bimpcesu/class/bimpcesu.class.php';
...
if (! empty($conf->global->FICHEINTER_ADDON) && is_readable(DOL_DOCUMENT_ROOT ."/core/modules/bimpcesu/mod_".$conf->global->FICHEINTER_ADDON.".php"))
{
	require_once DOL_DOCUMENT_ROOT ."/core/modules/bimpcesu/mod_".$conf->global->FICHEINTER_ADDON.'.php';
}
