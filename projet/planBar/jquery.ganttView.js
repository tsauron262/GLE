...
(function (jQuery) {
    ...
    jQuery.fn.ganttView = function () {
        ...
        if (args.length == 2 && typeof(args[0]) == "string") {
            handleMethod.call(this, args[0], args[1],remOpts);
        }
        if (args.length == 2 && typeof(args[0]) == "string" && typeof(args[1]) == "object") {
            handleRootMethod.call(this, args[0], args[1],remOpts);
        }
    };
    ...
    function handleRootMethod(method, value, defaults){
        if (method == "redraw") {
            var els = this;
            var options = value;
            var opts = jQuery.extend(true, defaults, options);
            jQuery(els).find('.ganttview').each(function(){
                jQuery(this).remove();
            });
            build.call(this, opts);
        }
    }
    function handleMethod(method, value,defaults) {
