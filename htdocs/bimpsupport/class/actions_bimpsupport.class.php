...
//    }
    ...
    {
        global $langs;
        $this->results['searchintosav'] = array('position' => 33, 'img' => "object_chrono@synopsischrono", 'text' => img_object("Chrono", "chrono@synopsischrono") . $langs->trans("SAV"), 'url' => DOL_URL_ROOT . '/bimpsupport/?search=1&object=sav&sall=' . GETPOST('q'), 'label' => 'SAV');
        $this->results['searchintosn'] = array('position' => 32, 'img' => "object_chrono@synopsischrono", 'text' => img_object("Chrono", "chrono@synopsischrono") . $langs->trans("S/N"), 'url' => DOL_URL_ROOT . '/bimpequipment/?search=1&object=equipment&sall=' . GETPOST('q'), 'label' => "S/N");
        $this->results['searchintosac'] = array('position' => 34, 'img' => "object_chrono@synopsischrono", 'text' => img_object("Chrono", "chrono@synopsischrono") . $langs->trans("SAC"), 'url' => DOL_URL_ROOT . '/bimpsupport/?search=1&object=sac&sall=' . GETPOST('q'), 'label' => "SAC");
        return 0;
    }
