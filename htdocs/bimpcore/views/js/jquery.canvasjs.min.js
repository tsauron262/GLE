...
/* 
 CanvasJS Chart - v3.8.12 GA - https://canvasjs.com/ 
 Copyright 2024 fenopix
...
ea=20;A=14;Fa={colorSet:"colorSet1",backgroundColor:"#2A2A2A",title:{fontFamily:Fa,fontSize:32,fontColor:ca,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Fa,fontSize:A,fontColor:ca,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:t,indexLabelFontSize:A,indexLabelFontColor:V,
...
Y="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),t=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,C=/[^-+\dA-Z]/g;return function(A,G,Q){var P=Q?Q.days:m,X=Q?Q.months:w,H=Q?Q.shortDays:n,L=Q?Q.shortMonths:Y;Q="";var O=!1;A=A&&A.getTime?A:A?new Date(A):new Date;if(isNaN(A))throw SyntaxError("invalid date");"UTC:"===G.slice(0,4)&&(G=G.slice(4),O=!0);Q=O?"getUTC":"get";var T=A[Q+"Date"](),K=A[Q+"Day"](),
W=A[Q+"Month"](),a=A[Q+"FullYear"](),g=A[Q+"Hours"](),c=A[Q+"Minutes"](),b=A[Q+"Seconds"](),e=A[Q+"Milliseconds"](),h=O?0:A.getTimezoneOffset();return Q=G.replace(d,function(r){switch(r){case "D":return T;case "DD":return da(T,2);case "DDD":return H[K];case "DDDD":return P[K];case "M":return W+1;case "MM":return da(W+1,2);case "MMM":return L[W];case "MMMM":return X[W];case "Y":return parseInt(String(a).slice(-2));case "YY":return da(String(a).slice(-2),2);case "YYY":return da(String(a).slice(-3),
3);case "YYYY":return da(a,4);case "h":return g%12||12;case "hh":return da(g%12||12,2);case "H":return g;case "HH":return da(g,2);case "m":return c;case "mm":return da(c,2);case "s":return b;case "ss":return da(b,2);case "f":return da(String(e),3).slice(0,1);case "ff":return da(String(e),3).slice(0,2);case "fff":return da(String(e),3).slice(0,3);case "t":return 12>g?"a":"p";case "tt":return 12>g?"am":"pm";case "T":return 12>g?"A":"P";case "TT":return 12>g?"AM":"PM";case "K":return O?"UTC":(String(A).match(t)||
...
A=this._themeOptionsKey,G=this._index;this.theme&&n(this.parent)&&n(A)&&n(G)?w=n(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&this.parent.themeOptions&&(this.options.theme&&Oa[this.options.theme]?w=Oa[this.options.theme]:this.parent.themeOptions[A]&&(null===G?w=this.parent.themeOptions[A]:0<this.parent.themeOptions[A].length&&(w=Math.min(this.parent.themeOptions[A].length-1,G),w=this.parent.themeOptions[A][w])));this.themeOptions=w;
...
n||{};for(var t=this._eventListeners[d],A=0;A<t.length;A++)t[A].eventHandler.call(t[A].context,n)}"function"===typeof this[d]&&this[d].call(w||this.chart,n)};Ea.prototype.registerSpace=function(d,n){"top"===d?this._topOccupied+=n.height:"bottom"===d?this._bottomOccupied+=n.height:"left"===d?this._leftOccupied+=n.width:"right"===d&&(this._rightOccupied+=n.width)};Ea.prototype.unRegisterSpace=function(d,n){"top"===d?this._topOccupied-=n.height:"bottom"===d?this._bottomOccupied-=n.height:"left"===d?
...
this.ctx.save();var n=this.ctx.font;this.ctx.textBaseline=this.textBaseline;var w=0;this._isDirty&&this.measureText(this.ctx);this.ctx.translate(this.x,this.y+w);"middle"===this.textBaseline&&(w=-this._lineHeight/2);this.ctx.font=this._getFontString();this.ctx.rotate(Math.PI/180*this.angle);var t=0,A=this.topPadding,G=null;this.ctx.roundRect||za(this.ctx);(0<this.borderThickness&&this.borderColor||this.backgroundColor)&&this.ctx.roundRect(0,w,this.width,this.height,this.cornerRadius,this.borderThickness,
...
t,A);A+=G.height}this.ctx.font=n;d&&this.ctx.restore()}};ja.prototype.setText=function(d){this.text=d;this._isDirty=!0;this._wrappedText=null};ja.prototype.measureText=function(){this._lineHeight=Za(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ja.prototype._getLineWithWidth=function(d,n,w){d=String(d);if(!d)return{text:"",width:0};var t=
w=0,A=d.length-1,G=Infinity;for(this.ctx.font=this._getFontString();t<=A;){var G=Math.floor((t+A)/2),C=d.substr(0,G+1);w=this.ctx.measureText(C).width;if(w<n)t=G+1;else if(w>n)A=G-1;else break}w>n&&1<C.length&&(C=C.substr(0,C.length-1),w=this.ctx.measureText(C).width);n=!0;if(C.length===d.length||" "===d[C.length])n=!1;n&&(d=C.split(" "),1<d.length&&d.pop(),C=d.join(" "),w=this.ctx.measureText(C).width);return{text:C,width:w}};ja.prototype._wrapText=function(){var d=new String(Ga(String(this.text))),
n=[],w=this.ctx.font,t=0,A=0;this.ctx.font=this._getFontString();if(0===this.frontSize)A=t=0;else for(;0<d.length;){var G=this.maxHeight-(this.topPadding+this.bottomPadding),C=this._getLineWithWidth(d,this.maxWidth-(this.leftPadding+this.rightPadding),!1);C.height=this._lineHeight;n.push(C);var H=A,A=Math.max(A,C.width),t=t+C.height,d=Ga(d.slice(C.text.length,d.length));G&&t>G&&(C=n.pop(),t-=C.height,A=H)}this._wrappedText={lines:n,width:A,height:t};this.width=A+(this.leftPadding+this.rightPadding);
...
t=w.x1,A=w.y1,G=0,H=0,C=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?40:0,O,L;"top"===this.verticalAlign||"bottom"===this.verticalAlign?(null===this.maxWidth&&(this.maxWidth=w.width-4-C*("center"===this.horizontalAlign?2:1)),H=0.5*w.height-this.margin-2,G=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||"right"===this.horizontalAlign?(null===this.maxWidth&&(this.maxWidth=w.height-4),H=0.5*w.width-this.margin-2):"center"===this.horizontalAlign&&(null===
...
fontWeight:this.fontWeight,horizontalAlign:this.horizontalAlign,textAlign:this.horizontalAlign,verticalAlign:this.verticalAlign,borderColor:this.borderColor,borderThickness:this.borderThickness,backgroundColor:this.backgroundColor,maxWidth:this.maxWidth,maxHeight:H,cornerRadius:this.cornerRadius,text:this.text,padding:this.padding,textBaseline:"middle"});Q=H.measureText();"top"===this.verticalAlign||"bottom"===this.verticalAlign?("top"===this.verticalAlign?(A=w.y1+2+this.fontSize/2+4,L="top"):"bottom"===
this.verticalAlign&&(A=w.y2-2-Q.height+this.fontSize/2+4,L="bottom"),"left"===this.horizontalAlign?t=w.x1+2:"center"===this.horizontalAlign?t=w.x1+w.width/2-Q.width/2:"right"===this.horizontalAlign&&(t=w.x2-2-Q.width-C),O=this.horizontalAlign,this.width=Q.width,this.height=Q.height):"center"===this.verticalAlign&&("left"===this.horizontalAlign?(t=w.x1+2+(this.fontSize/2+4),A=w.y2-2-(this.maxWidth/2-Q.width/2),G=-90,L="left",this.width=Q.height,this.height=Q.width):"right"===this.horizontalAlign?(t=
w.x2-2-(this.fontSize/2+4),A=w.y1+2+(this.maxWidth/2-Q.width/2),G=90,L="right",this.width=Q.height,this.height=Q.width):"center"===this.horizontalAlign&&(A=d.y1+(d.height/2-Q.height/2)+this.fontSize/2+4,t=d.x1+(d.width/2-Q.width/2),L="center",this.width=Q.width,this.height=Q.height),O="center");H.x=t;H.y=A;H.angle=G;H.horizontalAlign=O;this._textBlock=H;d.layoutManager.registerSpace(L,{width:this.width+("left"===L||"right"===L?this.margin+2:0),height:this.height+("top"===L||"bottom"===L?this.margin+
2:0)});this.bounds={x1:t,y1:A,x2:t+this.width,y2:A+this.height};this.ctx.textBaseline="top"}};Aa.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};pa(Ia,T);Ia.prototype.setLayout=Aa.prototype.setLayout;Ia.prototype.render=Aa.prototype.render;Wa.prototype.get=function(d,n){var w=null;0<this.pool.length?(w=this.pool.pop(),Ma(w,d,n)):w=ua(d,n);return w};Wa.prototype.release=function(d){this.pool.push(d)};pa(Ja,T);var Qa={addTheme:function(d,n){Oa[d]=n},addColorSet:function(d,n){Ba[d]=
...
null,l.indexKeyword):null;if(null!==B&&""!==B){var u=ma("indexLabelPlacement",l.dataPoint,l.dataSeries),m=ma("indexLabelOrientation",l.dataPoint,l.dataSeries),D=ma("indexLabelTextAlign",l.dataPoint,l.dataSeries),t=l.direction,e=l.dataSeries.axisX,r=l.dataSeries.axisY,A=!1,v=new ja(g,{x:0,y:0,maxWidth:f?f:0.5*this.width,maxHeight:h?5*Ra:1.5*Ra,angle:"horizontal"===m?0:-90,text:B,padding:0,backgroundColor:v,textAlign:D,fontSize:Ra,fontFamily:d,fontWeight:q,fontColor:y,fontStyle:k,textBaseline:"middle"});
...
p||"scatter"===p)u="inside";q=l.point.x-d/2+("horizontal"===m?0:v._lineHeight/2);if("inside"!==u)e=c.y1,h=c.y2,0<t?(f=l.point.y+v._lineHeight/2-k-y-b,f<e&&(f="auto"===u?Math.max(l.point.y,e)+v._lineHeight/2+y+b:e+v._lineHeight/2+y+b,A=f+("horizontal"===m?k-v._lineHeight/2:0)>l.point.y,!A||(0<=p.indexOf("line")||0<=p.indexOf("area"))||(f-=b))):(f=l.point.y+v._lineHeight/2+y+b,f>h-k+v._lineHeight/2-y&&(f="auto"===u?Math.min(l.point.y,h)+v._lineHeight/2-k-y-b:h+v._lineHeight/2-k-y-b,A=f-("horizontal"===
m?v._lineHeight/2:k)<l.point.y,!A||(0<=p.indexOf("line")||0<=p.indexOf("area"))||(f+=b)));else{Math.max(l.bounds.y1,c.y1);h=Math.min(l.bounds.y2,c.y2)-k+v._lineHeight/2;b=0<=p.indexOf("range")||"error"===p?0<t?Math.max(l.bounds.y1,c.y1)+v._lineHeight/2+y:Math.min(l.bounds.y2,c.y2)+v._lineHeight/2-k-y:(Math.max(l.bounds.y1,c.y1)+Math.min(l.bounds.y2,c.y2))/2-k/2+v._lineHeight/2;if(0<t){if(f=b,"bubble"===p||"scatter"===p)f=l.point.y-k/2+v._lineHeight/2,k>l.bounds.y2-l.bounds.y1&&(f-=k/2+y),0>f-v._lineHeight/
...
m?0:v._lineHeight/2)-r-b,("horizontal"===m?q:q-v._lineHeight/2)<h&&(q="auto"===u?Math.max(l.point.x,h)+("horizontal"===m?0:v._lineHeight/2)+y+b:h+("horizontal"===m?0:v._lineHeight/2)+r,(A=q+d-("horizontal"===m?0:v._lineHeight/2)>l.point.x)&&(q-=b))):(q=l.point.x+("horizontal"===m?0:v._lineHeight/2)+r+b,("horizontal"===m?q:q-v._lineHeight/2)>e-d-r-b&&(q="auto"===u?Math.min(l.point.x,e)-("horizontal"===m?d:d-v._lineHeight/2)-r-b:e-d-r+("horizontal"===m?0:v._lineHeight/2),(A=q-("horizontal"===m?0:v._lineHeight/
...
(A=0<t?f+("horizontal"===m?k-v._lineHeight/2:0)>l.point.y:f-("horizontal"===m?v._lineHeight/2:k)<l.point.y),"bubble"===p||"scatter"===p)&&(q+=v._lineHeight/2-Ra/2);v.x=q;v.y=f;v.render(!0);z&&("inside"!==u&&(0>p.indexOf("bar")&&("error"!==p||!l.axisSwapped)&&l.point.x>c.x1&&l.point.x<c.x2||!A)&&(-1==="ohlc candlestick boxandwhisker column rangecolumn stackedcolumn stackedcolumn100 error".split(" ").indexOf(p)&&("error"!==p||l.axisSwapped)&&l.point.y>c.y1&&l.point.y<c.y2||!A))&&(g.lineWidth=z,g.strokeStyle=
...
if(0<l.length){for(var m=!1,s=0;s<l.length;s++)if(z=l[s].x.getTime?l[s].x.getTime():l[s].x,!(z<a.axisX.dataInfo.viewPortMin||z>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!m)))if("number"!==typeof l[s].y)0<s&&!(k.connectNullData||m||x)&&(c.stroke(),w&&b.stroke()),m=!0;else{z=a.axisX.convertValueToPixel(z);u=a.axisY.convertValueToPixel(l[s].y);var B=k.dataPointIds[s];this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:d,dataPointIndex:s,x1:z,y1:u};x||m?(!x&&k.connectNullData?
...
k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(z,u),v=l[s].lineColor||n,c.strokeStyle=v,c.setLineDash&&(l[s].lineDashType?(p=l[s].lineDashType,c.setLineDash(G(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(f))));if(0!==l[s].markerSize&&(0<l[s].markerSize||0<k.markerSize)){var D=k.getMarkerProperties(s,z,u,c);h.push(D);B=X(B);w&&h.push({x:z,y:u,ctx:b,type:D.type,size:D.size,color:B,borderColor:B,borderThickness:D.borderThickness})}(l[s].indexLabel||k.indexLabel||l[s].indexLabelFormatter||
...
n[0];c.strokeStyle=n;var x=!0,s=0,z,u;c.beginPath();if(0<l.length){for(var m=!1,s=0;s<l.length;s++)if(z=l[s].getTime?l[s].x.getTime():l[s].x,!(z<a.axisX.dataInfo.viewPortMin||z>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!m)))if("number"!==typeof l[s].y)0<s&&!(k.connectNullData||m||x)&&(c.stroke(),w&&b.stroke()),m=!0;else{var B=u;z=a.axisX.convertValueToPixel(z);u=a.axisY.convertValueToPixel(l[s].y);var D=k.dataPointIds[s];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:d,
dataPointIndex:s,x1:z,y1:u};x||m?(!x&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(r.x,r.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(z,B),c.lineTo(z,u),w&&(b.lineTo(z,B),b.lineTo(z,u))):(c.beginPath(),c.moveTo(z,u),w&&(b.beginPath(),b.moveTo(z,u))),m=x=!1):(c.lineTo(z,B),w&&b.lineTo(z,B),c.lineTo(z,u),w&&b.lineTo(z,u),0==s%500&&(c.stroke(),c.beginPath(),c.moveTo(z,u),w&&
(b.stroke(),b.beginPath(),b.moveTo(z,u))));r={x:z,y:u};s<l.length-1&&(v!==(l[s].lineColor||n)||p!==(l[s].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(z,u),v=l[s].lineColor||n,c.strokeStyle=v,c.setLineDash&&(l[s].lineDashType?(p=l[s].lineDashType,c.setLineDash(G(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(f))));0!==l[s].markerSize&&(0<l[s].markerSize||0<k.markerSize)&&(B=k.getMarkerProperties(s,z,u,c),h.push(B),D=X(D),w&&h.push({x:z,y:u,ctx:b,type:B.type,size:B.size,
color:D,borderColor:D,borderThickness:B.borderThickness}));(l[s].indexLabel||k.indexLabel||l[s].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:l[s],dataSeries:k,point:{x:z,y:u},direction:0>l[s].y===a.axisY.reversed?1:-1,color:n})}c.stroke();w&&b.stroke()}}W.drawMarkers(h);w&&(g.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
...
dataPointIndex:x,x1:s,y1:z};u[u.length]={x:s,y:z};x<l.length-1&&(v!==(l[x].lineColor||n)||p!==(l[x].lineDashType||k.lineDashType))&&(v=l[x].lineColor||n,u[u.length-1].newStrokeStyle=v,b.setLineDash&&(l[x].lineDashType?(p=l[x].lineDashType,u[u.length-1].newLineDashArray=G(p,k.lineThickness)):(p=k.lineDashType,u[u.length-1].newLineDashArray=f)));if(0!==l[x].markerSize&&(0<l[x].markerSize||0<k.markerSize)){var B=k.getMarkerProperties(x,s,z,b);r.push(B);m=X(m);w&&r.push({x:s,y:z,ctx:e,type:B.type,size:B.size,
color:m,borderColor:m,borderThickness:B.borderThickness})}(l[x].indexLabel||k.indexLabel||l[x].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:l[x],dataSeries:k,point:{x:s,y:z},direction:0>l[x].y===a.axisY.reversed?1:-1,color:n});z=!1}g(u)}W.drawMarkers(r);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
...
else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=s[k].y)d[b]=s[k].y+(d[b]?d[b]:0),m=a.axisY.convertValueToPixel(d[b]),p="undefined"!==typeof r[b]?r[b]:q,r[b]=m;else if(p=a.axisY.convertValueToPixel(s[k].y),0<=s[k].y){var B="undefined"!==typeof h[b]?h[b]:0;p-=B;m=q-B;h[b]=B+(m-p)}else B=r[b]?r[b]:0,m=p+B,p=q+B,r[b]=B+(m-p);b=s[k].color?s[k].color:x._colorSet[k%x._colorSet.length];aa(c,l,a.axisY.reversed?m:p,u,a.axisY.reversed?p:m,b,0,null,z&&(a.axisY.reversed?0>s[k].y:0<=
...
0<s[k].y)d[b]=s[k].y+(d[b]?d[b]:0),0<d[b]&&(t=h[b]?h[b]:q,h[b]=l=a.axisY.convertValueToPixel(d[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=s[k].y)n[b]=s[k].y+(n[b]?n[b]:0),l=r[b]?r[b]:q,r[b]=t=a.axisY.convertValueToPixel(n[b]);else if(l=a.axisY.convertValueToPixel(s[k].y),0<=s[k].y){var B=h[b]?h[b]:0;t=q+B;l+=B;h[b]=B+(l-t)}else B=r[b]?r[b]:0,t=l-B,l=q-B,r[b]=B+(l-t);b=s[k].color?s[k].color:x._colorSet[k%x._colorSet.length];aa(c,a.axisY.reversed?l:t,p,a.axisY.reversed?
...
0<s[k].y){d[b]=u+(d[b]?d[b]:0);if(0>=d[b])continue;u=h[b]?h[b]:q;h[b]=l=a.axisY.convertValueToPixel(d[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=s[k].y)n[b]=u+(n[b]?n[b]:0),l=r[b]?r[b]:q,r[b]=u=a.axisY.convertValueToPixel(n[b]);else if(l=a.axisY.convertValueToPixel(u),0<=s[k].y){var B=h[b]?h[b]:0;u=q+B;l+=B;a.dataSeriesIndexes.length-1===f&&1>=Math.abs(e.x2-l)&&(l=e.x2);h[b]=B+(l-u)}else B=r[b]?r[b]:0,u=l-B,l=q-B,a.dataSeriesIndexes.length-1===f&&1>=Math.abs(e.x1-
u)&&(u=e.x1),r[b]=B+(l-u);b=s[k].color?s[k].color:x._colorSet[k%x._colorSet.length];aa(c,a.axisY.reversed?l:u,p,a.axisY.reversed?u:l,t,b,0,null,z,!1,!1,!1,x.fillOpacity);b=x.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:v,dataPointIndex:k,x1:u,y1:p,x2:l,y2:t};b=X(b);w&&aa(this._eventManager.ghostCtx,u,p,l,t,b,0,null,!1,!1,!1,!1);(s[k].indexLabel||x.indexLabel||s[k].indexLabelFormatter||x.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",
...
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:g,dest:this.plotArea.ctx,animationCallback:K.xScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderArea=function(a){var g,c;function b(){B&&(0<f.lineThickness&&h.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?t=u:0>a.axisY.viewportMaximum?
t=d.y1:0<a.axisY.viewportMinimum&&(t=u),h.lineTo(x,t),h.lineTo(B.x,t),h.closePath(),h.globalAlpha=f.fillOpacity,h.fill(),h.globalAlpha=1,w&&(r.lineTo(x,t),r.lineTo(B.x,t),r.closePath(),r.fill()),h.beginPath(),h.moveTo(x,s),r.beginPath(),r.moveTo(x,s),B={x:x,y:s})}var e=a.targetCanvasCtx||this.plotArea.ctx,h=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var r=this._eventManager.ghostCtx,d=a.axisY.lineCoordinates,n=[],k=this.plotArea,l;h.save();w&&r.save();h.beginPath();h.rect(k.x1,k.y1,
k.width,k.height);h.clip();w&&(r.beginPath(),r.rect(k.x1,k.y1,k.width,k.height),r.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],f=this.data[q],m=f.dataPoints,n=f.id;this._eventManager.objectMap[n]={objectType:"dataSeries",dataSeriesIndex:q};n=X(n);r.fillStyle=n;n=[];g=!0;var v=0,x,s,z,u=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),t,B=null;if(0<m.length){var D=f._colorSet[v%f._colorSet.length],A=f.lineColor=f.options.lineColor||D,
C=A;h.fillStyle=D;h.strokeStyle=A;h.lineWidth=f.lineThickness;c="solid";if(h.setLineDash){var J=G(f.nullDataLineDashType,f.lineThickness);c=f.lineDashType;var U=G(c,f.lineThickness);h.setLineDash(U)}for(var ba=!0;v<m.length;v++)if(z=m[v].x.getTime?m[v].x.getTime():m[v].x,!(z<a.axisX.dataInfo.viewPortMin||z>a.axisX.dataInfo.viewPortMax&&(!f.connectNullData||!ba)))if("number"!==typeof m[v].y)f.connectNullData||(ba||g)||b(),ba=!0;else{x=a.axisX.convertValueToPixel(z);s=a.axisY.convertValueToPixel(m[v].y);
g||ba?(!g&&f.connectNullData?(h.setLineDash&&(f.options.nullDataLineDashType||c===f.lineDashType&&f.lineDashType!==f.nullDataLineDashType)&&(g=x,c=s,x=l.x,s=l.y,b(),h.moveTo(l.x,l.y),x=g,s=c,B=l,c=f.nullDataLineDashType,h.setLineDash(J)),h.lineTo(x,s),w&&r.lineTo(x,s)):(h.beginPath(),h.moveTo(x,s),w&&(r.beginPath(),r.moveTo(x,s)),B={x:x,y:s}),ba=g=!1):(h.lineTo(x,s),w&&r.lineTo(x,s),0==v%250&&b());l={x:x,y:s};v<m.length-1&&(C!==(m[v].lineColor||A)||c!==(m[v].lineDashType||f.lineDashType))&&(b(),C=
m[v].lineColor||A,h.strokeStyle=C,h.setLineDash&&(m[v].lineDashType?(c=m[v].lineDashType,h.setLineDash(G(c,f.lineThickness))):(c=f.lineDashType,h.setLineDash(U))));var Z=f.dataPointIds[v];this._eventManager.objectMap[Z]={id:Z,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:v,x1:x,y1:s};0!==m[v].markerSize&&(0<m[v].markerSize||0<f.markerSize)&&(z=f.getMarkerProperties(v,x,s,h),n.push(z),Z=X(Z),w&&n.push({x:x,y:s,ctx:r,type:z.type,size:z.size,color:Z,borderColor:Z,borderThickness:z.borderThickness}));
...
r=l.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:k};r=X(r);e.fillStyle=r;var r=[],q=0,f,m,v=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),x,s=null,z=[];if(0<p.length){var u=l._colorSet[q%l._colorSet.length],A=l.lineColor=l.options.lineColor||u,B=A;b.fillStyle=u;b.strokeStyle=A;b.lineWidth=l.lineThickness;var D="solid";if(b.setLineDash){var C=G(l.nullDataLineDashType,l.lineThickness),D=l.lineDashType,db=G(D,l.lineThickness);b.setLineDash(db)}for(m=
!1;q<p.length;q++)if(f=p[q].x.getTime?p[q].x.getTime():p[q].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!l.connectNullData||!m)))if("number"!==typeof p[q].y)0<q&&!m&&(l.connectNullData?b.setLineDash&&(0<z.length&&(l.options.nullDataLineDashType||!p[q-1].lineDashType))&&(z[z.length-1].newLineDashArray=C,D=l.nullDataLineDashType):(g(),z=[])),m=!0;else{f=a.axisX.convertValueToPixel(f);m=a.axisY.convertValueToPixel(p[q].y);var J=l.dataPointIds[q];this._eventManager.objectMap[J]=
{id:J,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:f,y1:m};z[z.length]={x:f,y:m};q<p.length-1&&(B!==(p[q].lineColor||A)||D!==(p[q].lineDashType||l.lineDashType))&&(B=p[q].lineColor||A,z[z.length-1].newStrokeStyle=B,b.setLineDash&&(p[q].lineDashType?(D=p[q].lineDashType,z[z.length-1].newLineDashArray=G(D,l.lineThickness)):(D=l.lineDashType,z[z.length-1].newLineDashArray=db)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<l.markerSize)){var U=l.getMarkerProperties(q,f,m,b);r.push(U);
...
0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(d.x1,d.y1,d.width,d.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};m.prototype.renderStepArea=function(a){var g,c;function b(){B&&(0<f.lineThickness&&
...
t,B=null;c=!1;if(0<m.length){var D=f._colorSet[v%f._colorSet.length],A=f.lineColor=f.options.lineColor||D,C=A;h.fillStyle=D;h.strokeStyle=A;h.lineWidth=f.lineThickness;var J="solid";if(h.setLineDash){var U=G(f.nullDataLineDashType,f.lineThickness),J=f.lineDashType,ba=G(J,f.lineThickness);h.setLineDash(ba)}for(;v<m.length;v++)if(z=m[v].x.getTime?m[v].x.getTime():m[v].x,!(z<a.axisX.dataInfo.viewPortMin||z>a.axisX.dataInfo.viewPortMax&&(!f.connectNullData||!c))){var Z=s;"number"!==typeof m[v].y?(f.connectNullData||
(c||g)||b(),c=!0):(x=a.axisX.convertValueToPixel(z),s=a.axisY.convertValueToPixel(m[v].y),g||c?(!g&&f.connectNullData?(h.setLineDash&&(f.options.nullDataLineDashType||J===f.lineDashType&&f.lineDashType!==f.nullDataLineDashType)&&(g=x,c=s,x=l.x,s=l.y,b(),h.moveTo(l.x,l.y),x=g,s=c,B=l,J=f.nullDataLineDashType,h.setLineDash(U)),h.lineTo(x,Z),h.lineTo(x,s),w&&(r.lineTo(x,Z),r.lineTo(x,s))):(h.beginPath(),h.moveTo(x,s),w&&(r.beginPath(),r.moveTo(x,s)),B={x:x,y:s}),c=g=!1):(h.lineTo(x,Z),w&&r.lineTo(x,
Z),h.lineTo(x,s),w&&r.lineTo(x,s),0==v%250&&b()),l={x:x,y:s},v<m.length-1&&(C!==(m[v].lineColor||A)||J!==(m[v].lineDashType||f.lineDashType))&&(b(),C=m[v].lineColor||A,h.strokeStyle=C,h.setLineDash&&(m[v].lineDashType?(J=m[v].lineDashType,h.setLineDash(G(J,f.lineThickness))):(J=f.lineDashType,h.setLineDash(ba)))),z=f.dataPointIds[v],this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:v,x1:x,y1:s},0!==m[v].markerSize&&(0<m[v].markerSize||0<f.markerSize)&&(Z=
...
D.connectNullData?(b.setLineDash&&(D.options.nullDataLineDashType||u===D.lineDashType&&D.lineDashType!==D.nullDataLineDashType)&&(z=k.pop(),u=k[k.length-1],g(),b.moveTo(s.x,s.y),k.push(u),k.push(z),u=D.nullDataLineDashType,b.setLineDash(U)),b.lineTo(f,m),w&&x.lineTo(f,m)):(b.beginPath(),b.moveTo(f,m),w&&(x.beginPath(),x.moveTo(f,m))),Z=z=!1):(b.lineTo(f,m),w&&x.lineTo(f,m),0==q%250&&(g(),b.moveTo(f,m),w&&x.moveTo(f,m),k.push({x:f,y:v-oa})));s={x:f,y:m};q<A.length-1&&(J!==(A[q].lineColor||C)||u!==
(A[q].lineDashType||D.lineDashType))&&(g(),b.beginPath(),b.moveTo(f,m),k.push({x:f,y:v-oa}),J=A[q].lineColor||C,b.strokeStyle=J,b.setLineDash&&(A[q].lineDashType?(u=A[q].lineDashType,b.setLineDash(G(u,D.lineThickness))):(u=D.lineDashType,b.setLineDash(ba))));if(0<=D.dataPointIndexes[h]){var ka=D.dataPointIds[D.dataPointIndexes[h]];this._eventManager.objectMap[ka]={id:ka,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:D.dataPointIndexes[h],x1:f,y1:m}}0<=D.dataPointIndexes[h]&&0!==ga.markerSize&&
...
0,f,m,v,x,s,z=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),u=this._eventManager.ghostCtx;b.save();w&&u.save();b.beginPath();b.rect(r.x1,r.y1,r.width,r.height);b.clip();w&&(u.beginPath(),u.rect(r.x1,r.y1,r.width,r.height),u.clip());for(var e=[],t=0;t<a.dataSeriesIndexes.length;t++){var B=a.dataSeriesIndexes[t],D=this.data[B],A=D.dataPoints;D.dataPointIndexes=[];for(q=0;q<A.length;q++)B=A[q].x.getTime?A[q].x.getTime():A[q].x,D.dataPointIndexes[B]=q,e[B]||(l.push(B),e[B]=
!0);l.sort(Sa)}for(t=0;t<a.dataSeriesIndexes.length;t++){B=a.dataSeriesIndexes[t];D=this.data[B];A=D.dataPoints;x=!0;e=D.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:B};e=X(e);u.fillStyle=e;k=[];if(0<l.length){var e=D._colorSet[q%D._colorSet.length],C=D.lineColor=D.options.lineColor||e,J=C;b.fillStyle=e;b.strokeStyle=C;b.lineWidth=D.lineThickness;s="solid";if(b.setLineDash){var U=G(D.nullDataLineDashType,D.lineThickness);s=D.lineDashType;var ba=G(s,D.lineThickness);
...
var A=m-t/2<<0,B=A+t<<0,h=s.options.fallingColor?s.fallingColor:s._colorSet[0],e=z[d].color?z[d].color:s._colorSet[0],D=Math.round(Math.max(1,0.15*t)),C=0===D%2?0:0.5,G=s.dataPointIds[d];this._eventManager.objectMap[G]={id:G,objectType:"dataPoint",dataSeriesIndex:x,dataPointIndex:d,x1:A,y1:k,x2:B,y2:l,x3:m,y3:p,x4:m,y4:q,borderThickness:D,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=D;b.lineWidth=Math.max(D,4);"candlestick"===s.type?(c.moveTo(m-C,l),c.lineTo(m-C,Math.min(k,q)),c.stroke(),c.moveTo(m-
C,Math.max(k,q)),c.lineTo(m-C,p),c.stroke(),aa(c,A,Math.min(k,q),B,Math.max(k,q),z[d].y[0]<=z[d].y[3]?s.risingColor:h,D,e,u,u,!1,!1,s.fillOpacity),w&&(e=X(G),b.strokeStyle=e,b.moveTo(m-C,l),b.lineTo(m-C,Math.min(k,q)),b.stroke(),b.moveTo(m-C,Math.max(k,q)),b.lineTo(m-C,p),b.stroke(),aa(b,A,Math.min(k,q),B,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===s.type&&(c.moveTo(m-C,l),c.lineTo(m-C,p),c.stroke(),c.beginPath(),c.moveTo(m,k),c.lineTo(A,k),c.stroke(),c.beginPath(),c.moveTo(m,q),c.lineTo(B,q),
c.stroke(),w&&(e=X(G),b.strokeStyle=e,b.moveTo(m-C,l),b.lineTo(m-C,p),b.stroke(),b.beginPath(),b.moveTo(m,k),b.lineTo(A,k),b.stroke(),b.beginPath(),b.moveTo(m,q),b.lineTo(B,q),b.stroke()));(z[d].indexLabel||s.indexLabel||z[d].indexLabelFormatter||s.indexLabelFormatter)&&this._indexLabels.push({chartType:s.type,dataPoint:z[d],dataSeries:s,point:{x:A+(B-A)/2,y:a.axisY.reversed?p:l},direction:1,bounds:{x1:A,y1:Math.min(l,p),x2:B,y2:Math.max(l,p)},color:e})}}w&&(g.drawImage(this._preRenderCanvas,0,0,
...
h.height);c.clip();w&&(b.beginPath(),b.rect(h.x1,h.y1,h.width,h.height),b.clip());for(var v=!1,v=!!a.axisY.reversed,x=0;x<a.dataSeriesIndexes.length;x++){var s=a.dataSeriesIndexes[x],z=this.data[s],u=z.dataPoints;if(0<u.length)for(var A=5<t&&z.bevelEnabled?!0:!1,r=0;r<u.length;r++)if(u[r].getTime?f=u[r].x.getTime():f=u[r].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&!n(u[r].y)&&u[r].y.length&&"number"===typeof u[r].y[0]&&"number"===typeof u[r].y[1]&&"number"===typeof u[r].y[2]&&
"number"===typeof u[r].y[3]&&"number"===typeof u[r].y[4]&&5===u[r].y.length){d=a.axisX.convertValueToPixel(f);m=a.axisY.convertValueToPixel(u[r].y[0]);k=a.axisY.convertValueToPixel(u[r].y[1]);l=a.axisY.convertValueToPixel(u[r].y[2]);p=a.axisY.convertValueToPixel(u[r].y[3]);q=a.axisY.convertValueToPixel(u[r].y[4]);var B=d-t/2<<0,D=d+t/2<<0,e=u[r].color?u[r].color:z._colorSet[0],C=Math.round(Math.max(1,0.15*t)),H=0===C%2?0:0.5,J=u[r].whiskerColor?u[r].whiskerColor:u[r].color?z.whiskerColor?z.whiskerColor:
u[r].color:z.whiskerColor?z.whiskerColor:e,U="number"===typeof u[r].whiskerThickness?u[r].whiskerThickness:"number"===typeof z.options.whiskerThickness?z.whiskerThickness:C,ba=u[r].whiskerDashType?u[r].whiskerDashType:z.whiskerDashType,Z=n(u[r].whiskerLength)?n(z.options.whiskerLength)?t:z.whiskerLength:u[r].whiskerLength,Z="number"===typeof Z?0>=Z?0:Z>=t?t:Z:"string"===typeof Z?parseInt(Z)*t/100>t?t:parseInt(Z)*t/100:t,ga=1===Math.round(U)%2?0.5:0,oa=u[r].stemColor?u[r].stemColor:u[r].color?z.stemColor?
z.stemColor:u[r].color:z.stemColor?z.stemColor:e,ka="number"===typeof u[r].stemThickness?u[r].stemThickness:"number"===typeof z.options.stemThickness?z.stemThickness:C,E=1===Math.round(ka)%2?0.5:0,L=u[r].stemDashType?u[r].stemDashType:z.stemDashType,O=u[r].lineColor?u[r].lineColor:u[r].color?z.lineColor?z.lineColor:u[r].color:z.lineColor?z.lineColor:e,Q="number"===typeof u[r].lineThickness?u[r].lineThickness:"number"===typeof z.options.lineThickness?z.lineThickness:C,P=u[r].lineDashType?u[r].lineDashType:
z.lineDashType,M=1===Math.round(Q)%2?0.5:0,N=z.upperBoxColor,S=z.lowerBoxColor,ta=n(z.options.fillOpacity)?1:z.fillOpacity,R=z.dataPointIds[r];this._eventManager.objectMap[R]={id:R,objectType:"dataPoint",dataSeriesIndex:s,dataPointIndex:r,x1:B,y1:m,x2:D,y2:k,x3:d,y3:l,x4:d,y4:p,y5:q,borderThickness:C,color:e,stemThickness:ka,stemColor:oa,whiskerThickness:U,whiskerLength:Z,whiskerColor:J,lineThickness:Q,lineColor:O};c.save();0<ka&&(c.beginPath(),c.strokeStyle=oa,c.lineWidth=ka,c.setLineDash&&c.setLineDash(G(L,
ka)),c.moveTo(d-E,k),c.lineTo(d-E,m),c.stroke(),c.moveTo(d-E,p),c.lineTo(d-E,l),c.stroke());c.restore();b.lineWidth=Math.max(C,4);c.beginPath();aa(c,B,Math.min(q,k),D,Math.max(k,q),S,0,e,v?A:!1,v?!1:A,!1,!1,ta);c.beginPath();aa(c,B,Math.min(l,q),D,Math.max(q,l),N,0,e,v?!1:A,v?A:!1,!1,!1,ta);c.beginPath();c.lineWidth=C;c.strokeStyle=e;c.rect(B-H,Math.min(k,l)-H,D-B+2*H,Math.max(k,l)-Math.min(k,l)+2*H);c.stroke();c.save();0<Q&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(G(P,Q)),c.strokeStyle=
O,c.lineWidth=Q,c.moveTo(B,q-M),c.lineTo(D,q-M),c.stroke());c.restore();c.save();0<U&&(c.beginPath(),c.setLineDash&&c.setLineDash(G(ba,U)),c.strokeStyle=J,c.lineWidth=U,c.moveTo(d-Z/2<<0,p-ga),c.lineTo(d+Z/2<<0,p-ga),c.stroke(),c.moveTo(d-Z/2<<0,m+ga),c.lineTo(d+Z/2<<0,m+ga),c.stroke());c.restore();w&&(e=X(R),b.strokeStyle=e,b.lineWidth=ka,0<ka&&(b.moveTo(d-H-E,k),b.lineTo(d-H-E,Math.max(m,p)),b.stroke(),b.moveTo(d-H-E,Math.min(m,p)),b.lineTo(d-H-E,l),b.stroke()),aa(b,B,Math.max(k,l),D,Math.min(k,
l),e,0,null,!1,!1,!1,!1),0<U&&(b.beginPath(),b.lineWidth=U,b.moveTo(d+Z/2,p-ga),b.lineTo(d-Z/2,p-ga),b.stroke(),b.moveTo(d+Z/2,m+ga),b.lineTo(d-Z/2,m+ga),b.stroke()));(u[r].indexLabel||z.indexLabel||u[r].indexLabelFormatter||z.indexLabelFormatter)&&this._indexLabels.push({chartType:z.type,dataPoint:u[r],dataSeries:z,point:{x:B+(D-B)/2,y:a.axisY.reversed?m:p},direction:1,bounds:{x1:B,y1:Math.min(m,p),x2:D,y2:Math.max(m,p)},color:e})}}w&&(g.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
a.dataSeriesIndexes.length;z++){var u=a.dataSeriesIndexes[z],C=this.data[u],B=C.dataPoints,D=n(C._linkedSeries)?!1:C._linkedSeries.type.match(/(bar|column)/ig)&&C._linkedSeries.visible?!0:!1,G=0;if(D)for(e=C._linkedSeries.id,s=0;s<e;s++)!this.data[s].type.match(/(bar|column)/ig)||!this.data[s].visible||this.data[s].type.match(/(stacked)/ig)&&G||(this.data[s].type.match(/(range)/ig)&&(h=!0),G++);e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:
...
Math.abs(v)/Math.abs(a.axisX.range))/(D?x:1))<<0;this.dataPointMaxWidth&&e>d&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,d));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&d<e)&&(d=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));s<e&&(s=e);s>d&&(s=d);if(0<B.length)for(var H=C._colorSet,d=0;d<B.length;d++){var e=C.lineColor=C.options.color?C.options.color:H[0],J={color:B[d].whiskerColor?B[d].whiskerColor:B[d].color?C.whiskerColor?C.whiskerColor:B[d].color:
C.whiskerColor?C.whiskerColor:e,thickness:n(B[d].whiskerThickness)?C.whiskerThickness:B[d].whiskerThickness,dashType:B[d].whiskerDashType?B[d].whiskerDashType:C.whiskerDashType,length:n(B[d].whiskerLength)?n(C.options.whiskerLength)?s:C.options.whiskerLength:B[d].whiskerLength,trimLength:n(B[d].whiskerLength)?n(C.options.whiskerLength)?50:0:0};J.length="number"===typeof J.length?0>=J.length?0:J.length>=s?s:J.length:"string"===typeof J.length?parseInt(J.length)*s/100>s?s:parseInt(J.length)*s/100>s:
s;J.thickness="number"===typeof J.thickness?0>J.thickness?0:Math.round(J.thickness):2;var U={color:B[d].stemColor?B[d].stemColor:B[d].color?C.stemColor?C.stemColor:B[d].color:C.stemColor?C.stemColor:e,thickness:B[d].stemThickness?B[d].stemThickness:C.stemThickness,dashType:B[d].stemDashType?B[d].stemDashType:C.stemDashType};U.thickness="number"===typeof U.thickness?0>U.thickness?0:Math.round(U.thickness):2;B[d].getTime?t=B[d].x.getTime():t=B[d].x;if(!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax)&&
!n(B[d].y)&&B[d].y.length&&"number"===typeof B[d].y[0]&&"number"===typeof B[d].y[1]){var ba=a.axisX.convertValueToPixel(t);b?k=ba:m=ba;ba=a.axisY.convertValueToPixel(B[d].y[0]);b?l=ba:q=ba;ba=a.axisY.convertValueToPixel(B[d].y[1]);b?p=ba:f=ba;b?(q=a.axisX.reversed?k+(D?x:1)*s/2-(D?G-1:0)*s<<0:k-(D?x:1)*s/2+(D?G-1:0)*s<<0,f=a.axisX.reversed?q-s<<0:q+s<<0):(l=a.axisX.reversed?m+(D?x:1)*s/2-(D?G-1:0)*s<<0:m-(D?x:1)*s/2+(D?G-1:0)*s<<0,p=a.axisX.reversed?l-s<<0:l+s<<0);!b&&q>f&&(ba=q,q=f,f=ba);b&&l>p&&
(ba=l,l=p,p=ba);ba=C.dataPointIds[d];this._eventManager.objectMap[ba]={id:ba,objectType:"dataPoint",dataSeriesIndex:u,dataPointIndex:d,x1:Math.min(l,p),y1:Math.min(q,f),x2:Math.max(p,l),y2:Math.max(f,q),isXYSwapped:b,stemProperties:U,whiskerProperties:J};A(c,Math.min(l,p),Math.min(q,f),Math.max(p,l),Math.max(f,q),e,J,U,b);w&&A(this._eventManager.ghostCtx,l,q,p,f,e,J,U,b);if(B[d].indexLabel||C.indexLabel||B[d].indexLabelFormatter||C.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:B[d],
dataSeries:C,indexKeyword:0,point:{x:b?B[d].y[1]>=B[d].y[0]?l:p:l+(p-l)/2,y:b?q+(f-q)/2:B[d].y[1]>=B[d].y[0]?f:q},direction:B[d].y[1]>=B[d].y[0]?-1:1,bounds:{x1:b?Math.min(l,p):l,y1:b?q:Math.min(q,f),x2:b?Math.max(l,p):p,y2:b?f:Math.max(q,f)},color:e,axisSwapped:b}),this._indexLabels.push({chartType:"error",dataPoint:B[d],dataSeries:C,indexKeyword:1,point:{x:b?B[d].y[1]>=B[d].y[0]?p:l:l+(p-l)/2,y:b?q+(f-q)/2:B[d].y[1]>=B[d].y[0]?q:f},direction:B[d].y[1]>=B[d].y[0]?1:-1,bounds:{x1:b?Math.min(l,p):
...
l=this.data[k],p=l.dataPoints,h=l.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:k};h=X(h);e.fillStyle=h;var h=[],q=!0,f=0,m,v,x,s,z=null;if(0<p.length){var u=l._colorSet[f%l._colorSet.length],t=l.lineColor=l.options.lineColor||u,B=t;b.fillStyle=u;b.strokeStyle=t;b.lineWidth=l.lineThickness;var D="solid";if(b.setLineDash){var A=G(l.nullDataLineDashType,l.lineThickness),D=l.lineDashType,C=G(D,l.lineThickness);b.setLineDash(C)}for(var J=!0;f<p.length;f++)if(s=p[f].x.getTime?
p[f].x.getTime():p[f].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!l.connectNullData||!J)))if(null!==p[f].y&&p[f].y.length&&"number"===typeof p[f].y[0]&&"number"===typeof p[f].y[1]){m=a.axisX.convertValueToPixel(s);v=a.axisY.convertValueToPixel(p[f].y[0]);x=a.axisY.convertValueToPixel(p[f].y[1]);q||J?(l.connectNullData&&!q?(b.setLineDash&&(l.options.nullDataLineDashType||D===l.lineDashType&&l.lineDashType!==l.nullDataLineDashType)&&(n[n.length-1].newLineDashArray=C,D=l.nullDataLineDashType,
b.setLineDash(A)),b.lineTo(m,v),w&&e.lineTo(m,v),n.push({x:m,y1:v,y2:x})):(b.beginPath(),b.moveTo(m,v),z={x:m,y:v},n=[],n.push({x:m,y1:v,y2:x}),w&&(e.beginPath(),e.moveTo(m,v))),J=q=!1):(b.lineTo(m,v),n.push({x:m,y1:v,y2:x}),w&&e.lineTo(m,v),0==f%250&&g());s=l.dataPointIds[f];this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:f,x1:m,y1:v,y2:x};f<p.length-1&&(B!==(p[f].lineColor||t)||D!==(p[f].lineDashType||l.lineDashType))&&(g(),B=p[f].lineColor||t,n[n.length-
1].newStrokeStyle=B,b.strokeStyle=B,b.setLineDash&&(p[f].lineDashType?(D=p[f].lineDashType,n[n.length-1].newLineDashArray=G(D,l.lineThickness),b.setLineDash(n[n.length-1].newLineDashArray)):(D=l.lineDashType,n[n.length-1].newLineDashArray=C,b.setLineDash(C))));if(0!==p[f].markerSize&&(0<p[f].markerSize||0<l.markerSize)){var U=l.getMarkerProperties(f,m,x,b);h.push(U);var ba=X(s);w&&h.push({x:m,y:x,ctx:e,type:U.type,size:U.size,color:ba,borderColor:ba,borderThickness:U.borderThickness});U=l.getMarkerProperties(f,
...
f,m,v=[],x=[];if(0<l.length){var s=k._colorSet[p%k._colorSet.length],z=k.lineColor=k.options.lineColor||s,u=z;b.fillStyle=s;b.lineWidth=k.lineThickness;var C="solid",B;if(b.setLineDash){var D=G(k.nullDataLineDashType,k.lineThickness),C=k.lineDashType;B=G(C,k.lineThickness)}for(f=!1;p<l.length;p++)if(q=l[p].x.getTime?l[p].x.getTime():l[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!f)))if(null!==l[p].y&&l[p].y.length&&"number"===typeof l[p].y[0]&&"number"===
typeof l[p].y[1]){q=a.axisX.convertValueToPixel(q);f=a.axisY.convertValueToPixel(l[p].y[0]);m=a.axisY.convertValueToPixel(l[p].y[1]);var A=k.dataPointIds[p];this._eventManager.objectMap[A]={id:A,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:p,x1:q,y1:f,y2:m};v[v.length]={x:q,y:f};x[x.length]={x:q,y:m};p<l.length-1&&(u!==(l[p].lineColor||z)||C!==(l[p].lineDashType||k.lineDashType))&&(u=l[p].lineColor||z,v[v.length-1].newStrokeStyle=u,b.setLineDash&&(l[p].lineDashType?(C=l[p].lineDashType,
v[v.length-1].newLineDashArray=G(C,k.lineThickness)):(C=k.lineDashType,v[v.length-1].newLineDashArray=B)));if(0!==l[p].markerSize&&(0<l[p].markerSize||0<k.markerSize)){var H=k.getMarkerProperties(p,q,f,b);h.push(H);var J=X(A);w&&h.push({x:q,y:f,ctx:e,type:H.type,size:H.size,color:J,borderColor:J,borderThickness:H.borderThickness});H=k.getMarkerProperties(p,q,m,b);h.push(H);J=X(A);w&&h.push({x:q,y:m,ctx:e,type:H.type,size:H.size,color:J,borderColor:J,borderThickness:H.borderThickness})}if(l[p].indexLabel||
...
1].newLineDashArray=D,C=k.nullDataLineDashType):(g(B,z),v=[],x=[])),f=!0;g(B,z);W.drawMarkers(h)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(r.x1,r.y1,r.width,r.height),
...
a.dataSeriesIndexes[f],v=this.data[m],x=v.dataPoints,e=v._colorSet[0];v.risingColor=v.options.risingColor?v.options.risingColor:e;v.fallingColor=v.options.fallingColor?v.options.fallingColor:"#e40a0a";var s="number"===typeof v.options.lineThickness?Math.round(v.lineThickness):1,z=1===Math.round(s)%2?-0.5:0;if(0<x.length)for(var u=5<q&&v.bevelEnabled?!0:!1,t=!1,B=null,D=null,r=0;r<x.length;r++)if(x[r].getTime?l=x[r].x.getTime():l=x[r].x,"number"!==typeof x[r].y){if(0<r&&!t&&v.connectNullData)var C=
...
f)*q<<0;var A=a.axisX.reversed?d-q<<0:d+q<<0;n>k&&(e=n,n=k,k=e);a.axisY.reversed&&(e=n,n=k,k=e);e=v.dataPointIds[r];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:r,x1:d,y1:n,x2:A,y2:k};var J=x[r].color?x[r].color:0<x[r].y?v.risingColor:v.fallingColor;aa(c,a.axisX.reversed?A:d,a.axisY.reversed?k:n,a.axisX.reversed?d:A,a.axisY.reversed?n:k,J,0,J,u,u,!1,!1,v.fillOpacity);e=X(e);w&&aa(this._eventManager.ghostCtx,a.axisX.reversed?A:d,n,a.axisX.reversed?d:
A,k,e,0,null,!1,!1,!1,!1);var U,J=d;U="undefined"!==typeof x[r].isIntermediateSum&&!0===x[r].isIntermediateSum||"undefined"!==typeof x[r].isCumulativeSum&&!0===x[r].isCumulativeSum?0<x[r].y?n:k:0<x[r].y?k:n;0<r&&B&&(!t||v.connectNullData)&&(t&&c.setLineDash&&c.setLineDash(G(C,s)),c.beginPath(),c.moveTo(B,D-z),c.lineTo(J,U-z),0<s&&c.stroke(),w&&(b.beginPath(),b.moveTo(B,D-z),b.lineTo(J,U-z),0<s&&b.stroke()));t=!1;B=A;D=0<x[r].y?n:k;J=x[r].lineDashType?x[r].lineDashType:v.options.lineDashType?v.options.lineDashType:
"shortDash";c.strokeStyle=x[r].lineColor?x[r].lineColor:v.options.lineColor?v.options.lineColor:"#9e9e9e";c.lineWidth=s;c.setLineDash&&(J=G(J,s),c.setLineDash(J));(x[r].indexLabel||v.indexLabel||x[r].indexLabelFormatter||v.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",dataPoint:x[r],dataSeries:v,point:{x:d+(A-d)/2,y:0<=x[r].y?n:k},direction:0>x[r].y===a.axisY.reversed?1:-1,bounds:{x1:d,y1:Math.min(n,k),x2:A,y2:Math.max(n,k)},color:e})}}w&&(g.drawImage(this._preRenderCanvas,0,
...
p.indexLabelTextBlock.height/2+c>k&&(c=p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2+c-k);c=p.indexLabelTextBlock.y+c;r=0;r="right"===p.hemisphere?u.x+Math.sqrt(Math.pow(v,2)-Math.pow(c-u.y,2)):u.x-Math.sqrt(Math.pow(v,2)-Math.pow(c-u.y,2));n=u.x+A*Math.cos(p.midAngle);q=u.y+A*Math.sin(p.midAngle);q=Math.sqrt(Math.pow(r-n,2)+Math.pow(c-q,2));n=Math.acos(A/v);q=Math.acos((v*v+A*A-q*q)/(2*A*v));c=q<n?c-p.indexLabelTextBlock.y:0;r=null;for(k=1;k<l.length;k++)if(r=(a-k+f.length)%f.length,f[r].hemisphere!==
...
f=g+f;for(var g=[],h=0,r=0;r<z.length;r++){if("undefined"===typeof z[r].y)return-1;z[r].y="number"===typeof z[r].y?z[r].y:0;h+=Math.abs(z[r].y)}if(0===h)return-1;for(var d=g[0]=0,k=0,l,p,b=b-a,d=!1,r=0;r<z.length;r++)a=Math.abs(z[r].y)*f/h,d?l=0==Number(c.toFixed(3))?0:a/c:(p=ca*ca*b*b-4*Math.abs(ca)*a,0>p?(p=c,d=(b+p)*(e-k)/2,a-=d,l=e-k,k+=e-k,l+=0==p?0:a/p,k+=a/p,d=!0):(l=(Math.abs(ca)*b-Math.sqrt(p))/2,p=b-2*l/Math.abs(ca),k+=l,k>e&&(k-=l,p=c,d=(b+p)*(e-k)/2,a-=d,l=e-k,k+=e-k,l+=a/p,k+=a/p,d=!0),
b=p)),g.push(l);return g}function b(){if(s&&z){for(var a,b,c,e,g,h,r,d,k,l,p,q,m,y,u,v=[],t=[],I={percent:null,total:null},A=null,B=0;B<z.length;B++)u=R[B],u="undefined"!==typeof u.x5?(u.y2+u.y4)/2:(u.y2+u.y3)/2,u=f(u).x2+1,v[B]=Q-u-X;u=0.5*X;for(var B=0,C=z.length-1;B<z.length||0<=C;B++,C--){b=s.reversed?z[C]:z[B];a=b.color?b.color:s.reversed?s._colorSet[(z.length-1-B)%s._colorSet.length]:s._colorSet[B%s._colorSet.length];c=b.indexLabelPlacement||s.indexLabelPlacement||"outside";y=b.indexLabelTextAlign||
...
b.indexLabelLineThickness:"number"===typeof s.indexLabelLineThickness?s.indexLabelLineThickness:2;p=b.indexLabelLineDashType||s.indexLabelLineDashType||"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof s.indexLabelWrap?s.indexLabelWrap:!0;m=s.dataPointIds[B];x._eventManager.objectMap[m]={id:m,objectType:"dataPoint",dataPointIndex:B,dataSeriesIndex:0,funnelSection:R[s.reversed?z.length-1-B:B]};"inside"===s.indexLabelPlacement&&(v[B]=B!==da?s.reversed?R[B].x2-R[B].x1:
R[B].x3-R[B].x4:R[B].x3-R[B].x6,20>v[B]&&(v[B]=B!==da?s.reversed?R[B].x3-R[B].x4:R[B].x2-R[B].x1:R[B].x2-R[B].x1,v[B]/=2));m=b.indexLabelMaxWidth?b.indexLabelMaxWidth:s.options.indexLabelMaxWidth?s.indexLabelMaxWidth:v[B];if(m>v[B]||0>m)m=v[B];t[B]="inside"===s.indexLabelPlacement?q?Math.max(R[B].height,h):1.5*h:!1;I=x.getPercentAndTotal(s,b);if(s.indexLabelFormatter||b.indexLabelFormatter)A={chart:x.options,dataSeries:s,dataPoint:b,total:I.total,percent:I.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(A):
b.indexLabel?x.replaceKeywordsWithValue(b.indexLabel,b,s,B):s.indexLabelFormatter?s.indexLabelFormatter(A):s.indexLabel?x.replaceKeywordsWithValue(s.indexLabel,b,s,B):b.label?b.label:"";0>=l&&(l=0);1E3>m&&1E3-m<u&&(m+=1E3-m);n(s.options.indexLabelMaxWidth)&&(s.indexLabelMaxWidth=n(s.indexLabelMaxWidth)?m:Math.max(m,s.indexLabelMaxWidth));P.roundRect||za(P);c=new ja(P,{fontSize:h,fontFamily:d,fontColor:g,fontStyle:r,fontWeight:k,horizontalAlign:c,textAlign:y,backgroundColor:e,maxWidth:m,maxHeight:!1===
t[B]?q?4.28571429*h:1.5*h:t[B],text:b,padding:ea,textBaseline:"middle"});c.measureText();c.height=c.height===2*c.padding?0:c.height;c.width=c.width===2*c.padding?0:c.width;F.push({textBlock:c,id:s.reversed?C:B,isDirty:!1,lineColor:a,lineThickness:l,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,e,g,f=[];g=!1;c=0;for(var h,r=Q-V-X/2,r=s.options.indexLabelMaxWidth?s.indexLabelMaxWidth>r?r:s.indexLabelMaxWidth:r,
d=F.length-1;0<=d;d--){h=z[F[d].id];c=F[d];e=c.textBlock;b=(a=q(d)<R.length?F[q(d)]:null)?a.textBlock:null;c=c.height;a&&e.y+c+ea>b.y&&(g=!0);c=h.indexLabelMaxWidth||r;if(c>r||0>c)c=r;f.push(c)}if(g)for(d=F.length-1;0<=d;d--)a=R[d],F[d].textBlock.maxWidth=f[f.length-(d+1)],F[d].textBlock.measureText(),F[d].textBlock.height=F[d].textBlock.height===2*F[d].textBlock.padding?0:F[d].textBlock.height,F[d].textBlock.width=F[d].textBlock.width===2*F[d].textBlock.padding?0:F[d].textBlock.width,F[d].textBlock.x=
Q-r,c=F[d].textBlock.height<F[d].textBlock.maxHeight?F[d].textBlock.height:F[d].textBlock.maxHeight,g=F[d].textBlock.width<F[d].textBlock.maxWidth?F[d].textBlock.width:F[d].textBlock.maxWidth,F[d].height=c,F[d].width=g,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,F[d].textBlock.y=c-F[d].height/2,s.reversed?(F[d].textBlock.y+F[d].height>T+A&&(F[d].textBlock.y=T+A-F[d].height),F[d].textBlock.y<ta-A&&(F[d].textBlock.y=ta-A)):(F[d].textBlock.y<T-A&&(F[d].textBlock.y=T-A),F[d].textBlock.y+F[d].height>
ta+A&&(F[d].textBlock.y=ta+A-F[d].height))}function h(){var a,b,c,g;if("inside"!==s.indexLabelPlacement)for(var e=0;e<R.length;e++)0==F[e].textBlock.text.length?F[e].isDirty=!0:(a=R[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=s.reversed?"undefined"!==typeof a.x5?c>W?f(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<W?f(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,F[e].textBlock.x=b+X,F[e].textBlock.y=c-F[e].height/2,s.reversed?(F[e].textBlock.y+F[e].height>T+A&&(F[e].textBlock.y=
T+A-F[e].height),F[e].textBlock.y<ta-A&&(F[e].textBlock.y=ta-A)):(F[e].textBlock.y<T-A&&(F[e].textBlock.y=T-A),F[e].textBlock.y+F[e].height>ta+A&&(F[e].textBlock.y=ta+A-F[e].height)));else for(e=0;e<R.length;e++)0==F[e].textBlock.text.length?F[e].isDirty=!0:(a=R[e],b=a.height,c=F[e].height,g=F[e].width,b>=c?(b=e!=da?(a.x4+a.x3)/2-g/2:(a.x5+a.x4)/2-g/2,c=e!=da?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,F[e].textBlock.x=b,F[e].textBlock.y=c):F[e].isDirty=!0)}function r(){function a(b,c){var e;if(0>b||b>=F.length)return 0;
var g,f=F[b].textBlock;if(0>c){c*=-1;g=p(b);e=d(g,b);if(e>=c)return f.y-=c,c;if(0==b)return 0<e&&(f.y-=e),e;e+=a(g,-(c-e));0<e&&(f.y-=e);return e}g=q(b);e=d(b,g);if(e>=c)return f.y+=c,c;if(b==R.length-1)return 0<e&&(f.y+=e),e;e+=a(g,c-e);0<e&&(f.y+=e);return e}function b(){var a,e,g,f,h=0,r;f=(O-Z+2*A)/l;r=l;for(var d,k=1;k<r;k++){g=k*f;for(var n=F.length-1;0<=n;n--)!F[n].isDirty&&(F[n].textBlock.y<g&&F[n].textBlock.y+F[n].height>g)&&(d=q(n),!(d>=F.length-1)&&F[n].textBlock.y+F[n].height+ea>F[d].textBlock.y&&
...
(r&&g+e+ea>+k.y.toFixed(6))&&(e=h.y+e+ea-k.y,g=a(m,-e),g<e&&(0<g&&(e-=g),g=a(q(m),e),g!=e)));m--);b()}}function d(a,b){return(b<R.length?F[b].textBlock.y:s.reversed?T+A:ta+A)-(0>a?s.reversed?ta-A:T-A:F[a].textBlock.y+F[a].height+ea)}function m(a,b,c){var e,g,f,r=[],d=A,p=[];-1!==b&&(0<=$.indexOf(b)?(g=$.indexOf(b),$.splice(g,1)):($.push(b),$=$.sort(function(a,b){return a-b})));if(0===$.length)r=ia;else{g=A*(1!=$.length||0!=$[0]&&$[0]!=R.length-1?2:1)/k();for(var q=0;q<R.length;q++){if(1==$.length&&
...
0<z[U].indexLabel.toString().length)&&(J=!0),!J&&("undefined"!==typeof z[U].label&&null!==z[U].label&&0<z[U].label.toString().length)&&(J=!0),!J&&"function"===typeof s.indexLabelFormatter||"function"===typeof z[U].indexLabelFormatter)J=!0;J=J||"undefined"!==typeof s.indexLabel&&null!==s.indexLabel&&0<s.indexLabel.toString().length;"inside"!==s.indexLabelPlacement&&J||(B=(u.width-0.75*L)/2);var U=u.x1+B,Q=u.x2-B,Z=u.y1+A,O=u.y2-A,P=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=s.length&&(s.dataPoints&&
s.visible)&&0!==z.length){var N,E;a=75*L/100;var X=30*(Q-a)/100;"funnel"===s.type?(N=n(s.options.neckHeight)?0.35*H:s.neckHeight,E=n(s.options.neckWidth)?0.25*a:s.neckWidth,"string"===typeof N&&N.match(/%$/)?(N=parseInt(N),N=N*H/100):N=parseInt(N),"string"===typeof E&&E.match(/%$/)?(E=parseInt(E),E=E*a/100):E=parseInt(E),N>H?N=H:0>=N&&(N=0),E>a?E=a-0.5:0>=E&&(E=0)):"pyramid"===s.type&&(E=N=0,s.reversed=s.reversed?!1:!0);var B=U+a/2,S=U,V=U+a,T=s.reversed?O:Z,M=B-E/2,Y=B+E/2,W=s.reversed?Z+N:O-N,ta=
s.reversed?Z:O;E=s.valueRepresents=s.valueRepresents?s.valueRepresents:"height";U=[];a=[];var R=[],B=[],aa=Z,da,ca=(W-T)/(M-S),fa=-ca,L="area"===E?c():g();if(-1!==L){if(s.reversed)for(B.push(aa),E=L.length-1;0<E;E--)aa+=L[E],B.push(aa);else for(E=0;E<L.length;E++)aa+=L[E],B.push(aa);if(s.reversed)for(E=0;E<L.length;E++)B[E]<W?(U.push(M),a.push(Y),da=E):(U.push((B[E]-T+ca*S)/ca),a.push((B[E]-T+fa*V)/fa));else for(E=0;E<L.length;E++)B[E]<W?(U.push((B[E]-T+ca*S)/ca),a.push((B[E]-T+fa*V)/fa),da=E):(U.push(M),
a.push(Y));for(E=0;E<L.length-1;E++)aa=s.reversed?z[z.length-1-E].color?z[z.length-1-E].color:s._colorSet[(z.length-1-E)%s._colorSet.length]:z[E].color?z[E].color:s._colorSet[E%s._colorSet.length],E===da?R.push({x1:U[E],y1:B[E],x2:a[E],y2:B[E],x3:Y,y3:W,x4:a[E+1],y4:B[E+1],x5:U[E+1],y5:B[E+1],x6:M,y6:W,id:E,height:B[E+1]-B[E],color:aa}):R.push({x1:U[E],y1:B[E],x2:a[E],y2:B[E],x3:a[E+1],y3:B[E+1],x4:U[E+1],y4:B[E+1],id:E,height:B[E+1]-B[E],color:aa});var ea=2,F=[],ha=!1,$=[],ia=[],U=!1;a=a=0;Da($);
for(E=0;E<z.length;E++)z[E].exploded&&(U=!0,s.reversed?$.push(z.length-1-E):$.push(E));P.clearRect(u.x1,u.y1,u.width,u.height);P.fillStyle=x.backgroundColor;P.fillRect(u.x1,u.y1,u.width,u.height);if(J&&s.visible&&(b(),h(),"inside"!==s.indexLabelPlacement)){e();r();for(E=0;E<z.length;E++)F[E].isDirty||(a=F[E].textBlock.x+F[E].width,a=(Q-a)/2,0==E&&(C=a),C>a&&(C=a));for(E=0;E<R.length;E++)R[E].x1+=C,R[E].x2+=C,R[E].x3+=C,R[E].x4+=C,R[E].x5&&(R[E].x5+=C,R[E].x6+=C),F[E].textBlock.x+=C}for(E=0;E<R.length;E++)C=
R[E],qa(P,C,s.fillOpacity),ia.push(C.y1);v(P);J&&s.visible&&("inside"===s.indexLabelPlacement||x.animationEnabled||l(P),x.animationEnabled||t());if(!J)for(E=0;E<z.length;E++)C=s.dataPointIds[E],a={id:C,objectType:"dataPoint",dataPointIndex:E,dataSeriesIndex:0,funnelSection:R[s.reversed?z.length-1-E:E]},x._eventManager.objectMap[C]=a;!x.animationEnabled&&U?m(x,-1,0):x.animationEnabled&&!x.animatedRender&&m(x,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ha&&!x.isAnimating&&(n(a.dataSeries.explodeOnClick)||
...
m+Y+V-X,g[f].lineCoordinates.y2=m,"inside"===g[f].labelPlacement&&0<f&&(g[f].lineCoordinates.y1=g[0].lineCoordinates.y1-X-(g[f].labelEffectiveHeight||0)-5),"inside"===g[f].tickPlacement&&0<f&&(g[f].lineCoordinates.y1-=g[f].tickLength),g[f].bounds={x1:d,y1:m+(Y+V-("inside"===g[f].labelPlacement&&0===f?u[f]-5:u[f])-X),x2:t,y2:k,width:t-d},g[f].bounds.height=g[f].bounds.y2-g[f].bounds.y1,X+=("inside"===g[f].labelPlacement&&0===f?u[f]-5:u[f])+g[f].margin;if(c&&0<c.length)for(f=0;f<c.length;f++)M=l.isNavigator?
0:10,c[f]&&(d=Math.round(a[0]?a[0].lineCoordinates.x1:g[0].lineCoordinates.x1),M=c[f]._labels&&0<c[f]._labels.length?c[f]._labels[c[f]._labels.length-1].textBlock.height/2:p,m=Math.round(h.y1+Y+V<Math.max(M,p)?Math.max(M,p):h.y1+Y+V),t=Math.round(a[0]?a[0].lineCoordinates.x1:g[0].lineCoordinates.x1),M=0<a.length?0:c[f]._labels&&0<c[f]._labels.length?c[f]._labels[0].textBlock.height/2:p,k=Math.round(h.y2-W-e-M),c[f].lineCoordinates={x1:d-T,y1:m,x2:t-T,y2:k,height:Math.abs(k-m)},"inside"===c[f].labelPlacement&&
0<f&&(c[f].lineCoordinates.x1=c[0].lineCoordinates.x1-T-(c[f].labelEffectiveWidth||0)-5,c[f].lineCoordinates.x2=c[f].lineCoordinates.x1+c[f].lineThickness/2),"inside"===c[f].tickPlacement&&0<f&&(c[f].lineCoordinates.x1-=c[f].tickLength,c[f].lineCoordinates.x2=c[f].lineCoordinates.x1+c[f].lineThickness/2),c[f].bounds={x1:d-(("inside"===c[f].labelPlacement&&0===f?A[f]-5:A[f])+T),y1:m,x2:t-T,y2:k,height:k-m},c[f].bounds.width=c[f].bounds.x2-c[f].bounds.x1,c[f].title&&(c[f]._titleTextBlock.maxWidth=0<
c[f].titleMaxWidth&&c[f].titleMaxWidth<c[f].lineCoordinates.height?c[f].titleMaxWidth:c[f].lineCoordinates.height),T+=("inside"===c[f].labelPlacement&&0===f?A[f]-5:A[f])+c[f].margin);if(b&&0<b.length)for(f=0;f<b.length;f++)b[f]&&(d=Math.round(a[0]?a[0].lineCoordinates.x2:g[0].lineCoordinates.x2),t=Math.round(d),M=b[f]._labels&&0<b[f]._labels.length?b[f]._labels[b[f]._labels.length-1].textBlock.height/2:0,m=Math.round(h.y1+Y+V<Math.max(M,p)?Math.max(M,p):h.y1+Y+V),M=0<a.length?0:b[f]._labels&&0<b[f]._labels.length?
b[f]._labels[0].textBlock.height/2:0,k=Math.round(h.y2-(W+e+M)),b[f].lineCoordinates={x1:d+S,y1:m,x2:d+S,y2:k,height:Math.abs(k-m)},"inside"===b[f].labelPlacement&&0<f&&(b[f].lineCoordinates.x1=b[0].lineCoordinates.x2+S+(b[f].labelEffectiveWidth||0)+5,b[f].lineCoordinates.x2=b[f].lineCoordinates.x1+b[f].lineThickness/2),"inside"===b[f].tickPlacement&&0<f&&(b[f].lineCoordinates.x1+=b[f].tickLength,b[f].lineCoordinates.x2=b[f].lineCoordinates.x1+b[f].lineThickness/2),b[f].bounds={x1:d+S,y1:m,x2:t+(("inside"===
b[f].labelPlacement&&0===f?B[f]-5:B[f])+S),y2:k,height:k-m},b[f].bounds.width=b[f].bounds.x2-b[f].bounds.x1,b[f].title&&(b[f]._titleTextBlock.maxWidth=0<b[f].titleMaxWidth&&b[f].titleMaxWidth<b[f].lineCoordinates.height?b[f].titleMaxWidth:b[f].lineCoordinates.height),S+=("inside"===b[f].labelPlacement&&0===f?B[f]-5:B[f])+b[f].margin);if(a&&0<a.length)for(f=0;f<a.length;f++)a[f]&&(a[f].calculateValueToPixelConversionParameters(),a[f].calculateBreaksSizeInValues(),a[f]._labels&&1<a[f]._labels.length&&
(C=(a[f].logarithmic?Math.log(a[f]._labels[1].position/a[f].viewportMinimum)/a[f].conversionParameters.lnLogarithmBase:a[f]._labels[1].position-a[f].viewportMinimum)*Math.abs(a[f].conversionParameters.pixelPerUnit)+a[f].lineCoordinates.x1,d=a[f]._labels[a[f]._labels.length-("dateTime"===a[f].valueType?2:1)].position,d=a[f].getApparentDifference(a[f].viewportMinimum,d),G=a[f].logarithmic?(1<d?Math.log(d)/a[f].conversionParameters.lnLogarithmBase*Math.abs(a[f].conversionParameters.pixelPerUnit):0)+
a[f].lineCoordinates.x1:(0<d?d*Math.abs(a[f].conversionParameters.pixelPerUnit):0)+a[f].lineCoordinates.x1));if(g&&0<g.length)for(f=0;f<g.length;f++)g[f].calculateValueToPixelConversionParameters(),g[f].calculateBreaksSizeInValues(),g[f]._labels&&1<g[f]._labels.length&&(C=(g[f].logarithmic?Math.log(g[f]._labels[1].position/g[f].viewportMinimum)/g[f].conversionParameters.lnLogarithmBase:g[f]._labels[1].position-g[f].viewportMinimum)*Math.abs(g[f].conversionParameters.pixelPerUnit)+g[f].lineCoordinates.x1,
d=g[f]._labels[g[f]._labels.length-("dateTime"===g[f].valueType?2:1)].position,d=g[f].getApparentDifference(g[f].viewportMinimum,d),G=g[f].logarithmic?(1<d?Math.log(d)/g[f].conversionParameters.lnLogarithmBase*Math.abs(g[f].conversionParameters.pixelPerUnit):0)+g[f].lineCoordinates.x1:(0<d?d*Math.abs(g[f].conversionParameters.pixelPerUnit):0)+g[f].lineCoordinates.x1);for(f=0;f<q.length;f++)"axisY"===q[f].type&&(q[f].calculateValueToPixelConversionParameters(),q[f].calculateBreaksSizeInValues());if(0<
v){if(a&&0<a.length)for(f=0;f<a.length;f++)w=N[v-1][f]===N[v][f]?!0:!1;else w=!0;if(g&&0<g.length)for(f=0;f<g.length;f++)J=Q[v-1][f]===Q[v][f]?!0:!1;else J=!0;if(c&&0<c.length)for(f=0;f<c.length;f++)K=O[v-1][f]===O[v][f]?!0:!1;else K=!0;if(b&&0<b.length)for(f=0;f<b.length;f++)L=P[v-1][f]===P[v][f]?!0:!1;else L=!0}if(w&&J&&K&&L)break;v++}if(a&&0<a.length)for(f=0;f<a.length;f++)a[f].calculateStripLinesThicknessInValues(),a[f].calculateBreaksInPixels();if(g&&0<g.length)for(f=0;f<g.length;f++)g[f].calculateStripLinesThicknessInValues(),
g[f].calculateBreaksInPixels();if(c&&0<c.length)for(f=0;f<c.length;f++)c[f].calculateStripLinesThicknessInValues(),c[f].calculateBreaksInPixels();if(b&&0<b.length)for(f=0;f<b.length;f++)b[f].calculateStripLinesThicknessInValues(),b[f].calculateBreaksInPixels()}else{p=[];C=[];H=[];x=[];G=[];s=[];N=[];for(Q=[];4>v;){W=S=T=$=M=V=e=P=O=E=Y=0;if(a&&0<a.length)for(H=[],f=S=0;f<a.length;f++)H.push(Math.ceil(a[f]?a[f].createLabelsAndCalculateWidth():0)),S+=H[f],e+=a[f]&&!l.isNavigator?a[f].margin:0;else H.push(Math.ceil(a[0]?
a[0].createLabelsAndCalculateWidth():0));N.push(H);if(g&&0<g.length)for(x=[],f=W=0;f<g.length;f++)x.push(Math.ceil(g[f]?g[f].createLabelsAndCalculateWidth():0)),W+=x[f],V+=g[f]?g[f].margin:0;else x.push(Math.ceil(g[0]?g[0].createLabelsAndCalculateWidth():0));Q.push(x);if(c&&0<c.length)for(f=0;f<c.length;f++)c[f].lineCoordinates={},d=Math.round(h.x1+S+e),t=Math.round(h.x2-W-V>l.width-10?l.width-10:h.x2-W-V),c[f].labelAutoFit&&!n(z)&&(0<!a.length&&(d=0>c[f].labelAngle?Math.max(d,z):0===c[f].labelAngle?
Math.max(d,z/2):d),0<!g.length&&(t=0<c[f].labelAngle?t-u/2:0===c[f].labelAngle?t-u/2:t)),c[f].lineCoordinates.x1=d,c[f].lineCoordinates.x2=t,c[f].lineCoordinates.width=Math.abs(t-d),c[f].title&&(c[f]._titleTextBlock.maxWidth=0<c[f].titleMaxWidth&&c[f].titleMaxWidth<c[f].lineCoordinates.width?c[f].titleMaxWidth:c[f].lineCoordinates.width);if(b&&0<b.length)for(f=0;f<b.length;f++)b[f].lineCoordinates={},d=Math.round(h.x1+S+e),t=Math.round(h.x2-W-V>b[f].chart.width-10?b[f].chart.width-10:h.x2-W-V),b[f]&&
b[f].labelAutoFit&&!n(A)&&(0<!a.length&&(d=0<b[f].labelAngle?Math.max(d,A):0===b[f].labelAngle?Math.max(d,A/2):d),0<!g.length&&(t-=B/2)),b[f].lineCoordinates.x1=d,b[f].lineCoordinates.x2=t,b[f].lineCoordinates.width=Math.abs(t-d),b[f].title&&(b[f]._titleTextBlock.maxWidth=0<b[f].titleMaxWidth&&b[f].titleMaxWidth<b[f].lineCoordinates.width?b[f].titleMaxWidth:b[f].lineCoordinates.width);if(c&&0<c.length)for(p=[],f=T=0;f<c.length;f++)p.push(Math.ceil(c[f]?c[f].createLabelsAndCalculateHeight():0)),T+=
p[f]+c[f].margin,M+=c[f].margin;else p.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateHeight():0));G.push(p);if(b&&0<b.length)for(C=[],f=0;f<b.length;f++)C.push(Math.ceil(b[f]?b[f].createLabelsAndCalculateHeight():0)),$+=b[f].margin;else C.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateHeight():0));s.push(C);if(c&&0<c.length)for(f=0;f<c.length;f++)0<c[f]._labels.length&&(k=c[f]._labels[0],m=c[f]._labels[c[f]._labels.length-1],z=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+
(k.textBlock.height-m.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),u=m.textBlock.width*Math.cos(Math.PI/180*Math.abs(m.textBlock.angle))+(m.textBlock.height-m.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(m.textBlock.angle)));if(b&&0<b.length)for(f=0;f<b.length;f++)b[f]&&0<b[f]._labels.length&&(k=b[f]._labels[0],m=b[f]._labels[b[f]._labels.length-1],A=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-m.textBlock.fontSize/2)*Math.sin(Math.PI/
180*Math.abs(k.textBlock.angle)),B=m.textBlock.width*Math.cos(Math.PI/180*Math.abs(m.textBlock.angle))+(m.textBlock.height-m.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(m.textBlock.angle)));if(l.panEnabled)for(f=0;f<c.length;f++)p[f]=n(l.sessionVariables.axisY[f].height)?l.sessionVariables.axisY[f].height=p[f]:l.sessionVariables.axisY[f].height;else for(f=0;f<c.length;f++)l.sessionVariables.axisY[f].height=p[f];if(c&&0<c.length)for(f=c.length-1;0<=f;f--)m=Math.round(h.y2),k=Math.round(h.y2>
c[f].chart.height?c[f].chart.height:h.y2),c[f].lineCoordinates.y1=m-(p[f]+c[f].margin+Y),c[f].lineCoordinates.y2=m-(p[f]+c[f].margin+Y),"inside"===c[f].labelPlacement&&0<f&&(c[f].lineCoordinates.y1=c[f].lineCoordinates.y1+p[f]-(c[f]._titleTextBlock?c[f]._titleTextBlock.height:0)-c[f].tickLength-(c[f].stripLineLabelEffectiveHeight||0)-5,c[f].lineCoordinates.y2=c[f].lineCoordinates.y1+c[f].lineThickness/2),"inside"===c[f].tickPlacement&&0<f&&(c[f].lineCoordinates.y1+=c[f].tickLength,c[f].lineCoordinates.y2=
c[f].lineCoordinates.y1+c[f].lineThickness/2),c[f].bounds={x1:d,y1:m-(p[f]+Y+c[f].margin),x2:t,y2:k-(Y+c[f].margin),width:t-d,height:p[f]},c[f].title&&(c[f]._titleTextBlock.maxWidth=0<c[f].titleMaxWidth&&c[f].titleMaxWidth<c[f].lineCoordinates.width?c[f].titleMaxWidth:c[f].lineCoordinates.width),Y+=p[f]+c[f].margin;if(b&&0<b.length)for(f=b.length-1;0<=f;f--)b[f]&&(m=Math.round(h.y1),k=Math.round(h.y1+(C[f]+b[f].margin+E)),b[f].lineCoordinates.y1=k,b[f].lineCoordinates.y2=k,"inside"===b[f].labelPlacement&&
0<f&&(b[f].lineCoordinates.y1=k-C[f]+(b[f]._titleTextBlock?b[f]._titleTextBlock.height:0)+b[f].tickLength+(b[f].stripLineLabelEffectiveHeight||0),b[f].lineCoordinates.y2=b[f].lineCoordinates.y1-b[f].lineThickness/2),"inside"===b[f].tickPlacement&&0<f&&(b[f].lineCoordinates.y1-=b[f].tickLength,b[f].lineCoordinates.y2=b[f].lineCoordinates.y1-b[f].lineThickness/2),b[f].bounds={x1:d,y1:m+(b[f].margin+E),x2:t,y2:k,width:t-d},b[f].bounds.height=b[f].bounds.y2-b[f].bounds.y1,b[f].title&&(b[f]._titleTextBlock.maxWidth=
0<b[f].titleMaxWidth&&b[f].titleMaxWidth<b[f].lineCoordinates.width?b[f].titleMaxWidth:b[f].lineCoordinates.width),E+=C[f]+b[f].margin);if(a&&0<a.length)for(f=0;f<a.length;f++){M=a[f]._labels&&0<a[f]._labels.length?a[f]._labels[0].textBlock.fontSize/2:0;d=Math.round(h.x1+e);m=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:h.y1<Math.max(M,10)?Math.max(M,10):h.y1):h.y1<Math.max(M,10)?Math.max(M,10):h.y1;t=Math.round(h.x1+S+e);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:h.y2-T>l.height-
Math.max(M,10)?l.height-Math.max(M,10):h.y2-T):h.y2>l.height-Math.max(M,10)?l.height-Math.max(M,10):h.y2;if(c&&0<c.length)for(M=0;M<c.length;M++)c[M]&&c[M].labelAutoFit&&(t=c[M].lineCoordinates.x1,d=0>c[M].labelAngle||0===c[M].labelAngle?t-S:d);if(b&&0<b.length)for(M=0;M<b.length;M++)b[M]&&b[M].labelAutoFit&&(t=b[M].lineCoordinates.x1,d=t-S);a[f].lineCoordinates={x1:t-O,y1:m,x2:t-O,y2:k,height:Math.abs(k-m)};"inside"===a[f].labelPlacement&&0<f&&(a[f].lineCoordinates.x1=a[f].lineCoordinates.x1-(H[f]-
(a[f]._titleTextBlock?a[f]._titleTextBlock.height:0))+a[f].tickLength+(a[f].stripLineLabelEffectiveWidth||0),a[f].lineCoordinates.x2=a[f].lineCoordinates.x1+a[f].lineThickness/2);"inside"===a[f].tickPlacement&&0<f&&(a[f].lineCoordinates.x1-=a[f].tickLength,a[f].lineCoordinates.x2=a[f].lineCoordinates.x1+a[f].lineThickness/2);a[f].bounds={x1:t-(H[f]+O),y1:m,x2:t-O,y2:k,height:k-m};a[f].bounds.width=a[f].bounds.x2-a[f].bounds.x1;a[f].title&&(a[f]._titleTextBlock.maxWidth=0<a[f].titleMaxWidth&&a[f].titleMaxWidth<
a[f].lineCoordinates.height?a[f].titleMaxWidth:a[f].lineCoordinates.height);a[f].calculateValueToPixelConversionParameters();a[f].calculateBreaksSizeInValues();O+=H[f]+a[f].margin}if(g&&0<g.length)for(f=0;f<g.length;f++){M=g[f]._labels&&0<g[f]._labels.length?g[f]._labels[0].textBlock.fontSize/2:0;d=Math.round(h.x1-e);m=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:h.y1<Math.max(M,10)?Math.max(M,10):h.y1):h.y1<Math.max(M,10)?Math.max(M,10):h.y1;t=Math.round(h.x2-W-V);k=c&&0<c.length?Math.round(c[0]?
c[0].lineCoordinates.y1:h.y2-T>l.height-Math.max(M,10)?l.height-Math.max(M,10):h.y2-T):h.y2>l.height-Math.max(M,10)?l.height-Math.max(M,10):h.y2;if(c&&0<c.length)for(M=0;M<c.length;M++)c[M]&&c[M].labelAutoFit&&(t=0>c[M].labelAngle?Math.max(t,z):0===c[M].labelAngle?Math.max(t,z/2):t,d=0>c[M].labelAngle||0===c[M].labelAngle?t-W:d);if(b&&0<b.length)for(M=0;M<b.length;M++)b[M]&&b[M].labelAutoFit&&(t=b[M].lineCoordinates.x2,d=t-W);g[f].lineCoordinates={x1:t+P,y1:m,x2:t+P,y2:k,height:Math.abs(k-m)};"inside"===
g[f].labelPlacement&&0<f&&(g[f].lineCoordinates.x1=g[f].lineCoordinates.x1+(x[f]-(g[f]._titleTextBlock?g[f]._titleTextBlock.height:0)-2)-g[f].tickLength-(g[f].stripLineLabelEffectiveWidth||0),g[f].lineCoordinates.x2=g[f].lineCoordinates.x1+g[f].lineThickness/2);"inside"===g[f].tickPlacement&&0<f&&(g[f].lineCoordinates.x1+=g[f].tickLength,g[f].lineCoordinates.x2=g[f].lineCoordinates.x1+g[f].lineThickness/2);g[f].bounds={x1:g[f].lineCoordinates.x1,y1:m,x2:t+x[f]+P,y2:k,width:t-d,height:k-m};g[f].bounds.width=
g[f].bounds.x2-g[f].bounds.x1;g[f].title&&(g[f]._titleTextBlock.maxWidth=0<g[f].titleMaxWidth&&g[f].titleMaxWidth<g[f].lineCoordinates.height?g[f].titleMaxWidth:g[f].lineCoordinates.height);g[f].calculateValueToPixelConversionParameters();g[f].calculateBreaksSizeInValues();P+=x[f]+g[f].margin}for(f=0;f<q.length;f++)"axisY"===q[f].type&&(q[f].calculateValueToPixelConversionParameters(),q[f].calculateBreaksSizeInValues());if(0<v){if(a&&0<a.length)for(f=0;f<a.length;f++)w=N[v-1][f]===N[v][f]?!0:!1;else w=
!0;if(g&&0<g.length)for(f=0;f<g.length;f++)J=Q[v-1][f]===Q[v][f]?!0:!1;else J=!0;if(c&&0<c.length)for(f=0;f<c.length;f++)K=G[v-1][f]===G[v][f]?!0:!1;else K=!0;if(b&&0<b.length)for(f=0;f<b.length;f++)L=s[v-1][f]===s[v][f]?!0:!1;else L=!0}if(w&&J&&K&&L)break;v++}if(c&&0<c.length)for(f=0;f<c.length;f++)c[f].calculateStripLinesThicknessInValues(),c[f].calculateBreaksInPixels();if(b&&0<b.length)for(f=0;f<b.length;f++)b[f].calculateStripLinesThicknessInValues(),b[f].calculateBreaksInPixels();if(a&&0<a.length)for(f=
0;f<a.length;f++)a[f].calculateStripLinesThicknessInValues(),a[f].calculateBreaksInPixels();if(g&&0<g.length)for(f=0;f<g.length;f++)g[f].calculateStripLinesThicknessInValues(),g[f].calculateBreaksInPixels()}};C.render=function(a,g,c,b,e){var h=a[0]?a[0].chart:g[0].chart;e=h.ctx;h.alignVerticalAxes&&h.alignVerticalAxes();e.save();e.beginPath();a&&a.length&&e.rect(5,a[0].bounds.y1,a[0].chart.width-10,a[a.length-1].bounds.y2);g&&g.length&&e.rect(5,g[g.length-1].bounds.y1,g[0].chart.width-10,g[0].bounds.y2);
...
e.restore();if(a&&0<a.length)for(d=0;d<a.length;d++)a[d].renderGrid(),w&&(a[d].createMask(),a[d].renderBreaksBackground());if(g&&0<g.length)for(d=0;d<g.length;d++)g[d].renderGrid(),w&&(g[d].createMask(),g[d].renderBreaksBackground());if(c&&0<c.length)for(d=0;d<c.length;d++)c[d].renderGrid(),w&&(c[d].createMask(),c[d].renderBreaksBackground());if(b&&0<b.length)for(d=0;d<b.length;d++)b[d].renderGrid(),w&&(b[d].createMask(),b[d].renderBreaksBackground());if(a&&0<a.length)for(d=0;d<a.length;d++)a[d].renderAxisLine();
...
C.prototype.calculateStripLinesThicknessInValues=function(){for(var a=0;a<this.stripLines.length;a++)if(null!==this.stripLines[a].startValue&&null!==this.stripLines[a].endValue){var g=Math.min(this.stripLines[a].startValue,this.stripLines[a].endValue),c=Math.max(this.stripLines[a].startValue,this.stripLines[a].endValue),b=this.getApparentDifference(g,c);this.stripLines[a].value=this.convertPixelToValue(Math.abs(this.convertValueToPixel(g)+this.convertValueToPixel(c))/2);this.stripLines[a].thickness=
...
b=this.scaleBreaks&&!n(this.scaleBreaks.options.spacing),e,h=0;h<g.length;h++)e=b||!n(g[h].options.spacing),g[h].spacing=Ua(g[h].spacing,a,8,e?0.1*a:8,e?0:3)<<0,g[h].size=0>g[h].spacing?0:Math.abs(g[h].spacing/c),this.logarithmic&&(g[h].size=Math.pow(this.logarithmBase,g[h].size))};C.prototype.calculateBreaksInPixels=function(){if(!(this.scaleBreaks&&0>=this.scaleBreaks._appliedBreaks.length)){var a=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[];a.length&&(this.scaleBreaks.firstBreakIndex=this.scaleBreaks.lastBreakIndex=
null);for(var g=0;g<a.length&&!(a[g].startValue>this.conversionParameters.maximum);g++)a[g].endValue<this.conversionParameters.minimum||(n(this.scaleBreaks.firstBreakIndex)&&(this.scaleBreaks.firstBreakIndex=g),a[g].startValue>=this.conversionParameters.minimum&&(a[g].startPixel=this.convertValueToPixel(a[g].startValue),this.scaleBreaks.lastBreakIndex=g),a[g].endValue<=this.conversionParameters.maximum&&(a[g].endPixel=this.convertValueToPixel(a[g].endValue)))}};C.prototype.renderLabelsTicksAndTitle=
function(){var a=this,g=!1,c=0,b=0,e=1,h=0;0!==this.labelAngle&&360!==this.labelAngle&&(e=1.2);if("undefined"===typeof this.options.interval){if("bottom"===this._position||"top"===this._position)if(this.logarithmic&&!this.equidistantInterval&&this.labelAutoFit){for(var c=[],e=0!==this.labelAngle&&360!==this.labelAngle?1:1.2,d,n=this.viewportMaximum,m=this.lineCoordinates.width/Math.log(this.range),k=this._labels.length-1;0<=k;k--){p=this._labels[k];if(p.position<this.viewportMinimum)break;p.position>
...
e&&this.labelAutoFit&&(g=!0)}if("left"===this._position||"right"===this._position)if(this.logarithmic&&!this.equidistantInterval&&this.labelAutoFit){for(var c=[],l,n=this.viewportMaximum,m=this.lineCoordinates.height/Math.log(this.range),k=this._labels.length-1;0<=k;k--){p=this._labels[k];if(p.position<this.viewportMinimum)break;p.position>this.viewportMaximum||!(k===this._labels.length-1||l<Math.log(n/p.position)*m)||(c.push(p),n=p.position,l=p.textBlock.height*Math.abs(Math.cos(Math.PI/180*this.labelAngle))+
...
var k=0,p,q;if("bottom"===this._position){for(k=0;k<this._labels.length;k++)p=this._labels[k],p.position<this.viewportMinimum||p.position>this.viewportMaximum||(q=this.getPixelCoordinatesOnAxis(p.position),this.tickThickness&&"inside"!=this.tickPlacement&&(this.ctx.lineWidth=this.tickThickness,this.ctx.strokeStyle=this.tickColor,b=1===this.ctx.lineWidth%2?(q.x<<0)+0.5:q.x<<0,this.ctx.beginPath(),this.ctx.moveTo(b,q.y<<0),this.ctx.lineTo(b,q.y+this.tickLength<<0),this.ctx.stroke()),g&&0!==h++%2&&this.labelAutoFit||
...
g&&0!==h++%2&&this.labelAutoFit||(0===p.textBlock.angle?(q.x-=p.textBlock.width/2,q.y="inside"===this.labelPlacement?q.y+this.labelFontSize/2+("inside"===this.tickPlacement?this.tickLength:0)+5:q.y-(("inside"===this.tickPlacement?0:this.tickLength)+p.textBlock.height-p.textBlock.fontSize/2)):0>this.labelAngle?(q.x-="inside"===this.labelPlacement?p.textBlock.width*Math.cos(Math.PI/180*this.labelAngle):0,q.y="inside"===this.labelPlacement?q.y+("inside"===this.tickPlacement?this.tickLength:0)+5-p.textBlock.width*
...
180*this.labelAngle)));c.textBlock.x=b.x;c.textBlock.y=b.y;t.push(c)}else l._thicknessType===a&&(c.textBlock.angle=-90,"bottom"===this._position?(c.textBlock.maxWidth=this.options.stripLines[e].labelMaxWidth?this.options.stripLines[e].labelMaxWidth:this.chart.plotArea.height-3,c.textBlock.measureText(),b.x-c.textBlock.height-l.thickness/2>this.chart.plotArea.x1?n(l.startValue)?b.x-=c.textBlock.height-c.textBlock.fontSize/2+l.thickness/2:b.x-=c.textBlock.height/2-c.textBlock.fontSize/2:(c.textBlock.angle=
90,n(l.startValue)?b.x+=c.textBlock.height-c.textBlock.fontSize/2+l.thickness/2:b.x+=c.textBlock.height/2-c.textBlock.fontSize/2),b.y=-90===c.textBlock.angle?"near"===c.stripLine.labelAlign?this.chart.plotArea.y2-3:"center"===c.stripLine.labelAlign?(this.chart.plotArea.y2+this.chart.plotArea.y1+c.textBlock.width)/2:this.chart.plotArea.y1+c.textBlock.width+3:"near"===c.stripLine.labelAlign?this.chart.plotArea.y2-c.textBlock.width-3:"center"===c.stripLine.labelAlign?(this.chart.plotArea.y2+this.chart.plotArea.y1-
c.textBlock.width)/2:this.chart.plotArea.y1+3):"top"===this._position?(c.textBlock.maxWidth=this.options.stripLines[e].labelMaxWidth?this.options.stripLines[e].labelMaxWidth:this.chart.plotArea.height-3,c.textBlock.measureText(),b.x-c.textBlock.height-l.thickness/2>this.chart.plotArea.x1?n(l.startValue)?b.x-=c.textBlock.height-c.textBlock.fontSize/2+l.thickness/2:b.x-=c.textBlock.height/2-c.textBlock.fontSize/2:(c.textBlock.angle=90,n(l.startValue)?b.x+=c.textBlock.height-c.textBlock.fontSize/2+l.thickness/
...
(c.textBlock.maxWidth=this.options.stripLines[e].labelMaxWidth?this.options.stripLines[e].labelMaxWidth:this.chart.plotArea.width-3,c.textBlock.angle=0,c.textBlock.measureText(),b.y-c.textBlock.height-l.thickness/2>this.chart.plotArea.y1?n(l.startValue)?b.y-=c.textBlock.height-c.textBlock.fontSize/2+l.thickness/2:b.y-=c.textBlock.height/2-c.textBlock.fontSize/2:n(l.startValue)?b.y+=c.textBlock.height-c.textBlock.fontSize/2+l.thickness/2:b.y+=c.textBlock.height/2-c.textBlock.fontSize+3,b.x="near"===
c.stripLine.labelAlign?this.chart.plotArea.x1+3:"center"===c.stripLine.labelAlign?(this.chart.plotArea.x2+this.chart.plotArea.x1)/2-c.textBlock.width/2:this.chart.plotArea.x2-c.textBlock.width-3):"right"===this._position&&(c.textBlock.maxWidth=this.options.stripLines[e].labelMaxWidth?this.options.stripLines[e].labelMaxWidth:this.chart.plotArea.width-3,c.textBlock.angle=0,c.textBlock.measureText(),b.y-c.textBlock.height-l.thickness/2>this.chart.plotArea.y1?n(l.startValue)?b.y-=c.textBlock.height-c.textBlock.fontSize/
2+l.thickness/2:b.y-=c.textBlock.height/2-c.textBlock.fontSize/2:n(l.startValue)?b.y+=c.textBlock.height-c.textBlock.fontSize/2+l.thickness/2:b.y-=c.textBlock.height/2-c.textBlock.fontSize/2+3,b.x="near"===c.stripLine.labelAlign?this.chart.plotArea.x2-c.textBlock.width-3:"center"===c.stripLine.labelAlign?(this.chart.plotArea.x2+this.chart.plotArea.x1)/2-c.textBlock.width/2:this.chart.plotArea.x1+3),c.textBlock.x=b.x,c.textBlock.y=b.y,t.push(c));if(!k){b=!1;this.ctx.save();this.ctx.beginPath();this.ctx.rect(this.chart.plotArea.x1,
...
g=1===a.lineWidth%2?(g.y<<0)+0.5:g.y<<0,a.moveTo(c.x1<<0,g),a.lineTo(c.x2<<0,g),a.stroke());a.restore()}};C.prototype.renderAxisLine=function(){var a=this.chart.ctx,g=w?this.chart._preRenderCtx:a,c=Math.ceil(this.tickThickness/(this.reversed?-2:2)),b=Math.ceil(this.tickThickness/(this.reversed?2:-2)),e,h;g.save();if("bottom"===this._position||"top"===this._position){if(this.lineThickness){this.reversed?(e=this.lineCoordinates.x2,h=this.lineCoordinates.x1):(e=this.lineCoordinates.x1,h=this.lineCoordinates.x2);
...
if(this.logarithmic){c=n(c)?g/a:c;for(var h=0;h<e.length&&!(g<e[h].startValue);h++)a>e[h].endValue||(a<=e[h].startValue&&g>=e[h].endValue?c=c/e[h].endValue*e[h].startValue*e[h].size:a>=e[h].startValue&&g>=e[h].endValue?c=c/e[h].endValue*a*Math.pow(e[h].size,Math.log(e[h].endValue/a)/Math.log(e[h].endValue/e[h].startValue)):a<=e[h].startValue&&g<=e[h].endValue?c=c/g*e[h].startValue*Math.pow(e[h].size,Math.log(g/e[h].startValue)/Math.log(e[h].endValue/e[h].startValue)):!b&&(a>e[h].startValue&&g<e[h].endValue)&&
(c=a*Math.pow(e[h].size,Math.log(g/a)/Math.log(e[h].endValue/e[h].startValue))))}else for(c=n(c)?Math.abs(g-a):c,h=0;h<e.length&&!(g<e[h].startValue);h++)a>e[h].endValue||(a<=e[h].startValue&&g>=e[h].endValue?c=c-e[h].endValue+e[h].startValue+e[h].size:a>e[h].startValue&&g>=e[h].endValue?c=c-e[h].endValue+a+e[h].size*(e[h].endValue-a)/(e[h].endValue-e[h].startValue):a<=e[h].startValue&&g<e[h].endValue?c=c-g+e[h].startValue+e[h].size*(g-e[h].startValue)/(e[h].endValue-e[h].startValue):!b&&(a>e[h].startValue&&
g<e[h].endValue)&&(c=a+e[h].size*(g-a)/(e[h].endValue-e[h].startValue)));return c};C.prototype.setViewPortRange=function(a,g){this.sessionVariables.newViewportMinimum=this.viewportMinimum=Math.min(a,g);this.sessionVariables.newViewportMaximum=this.viewportMaximum=Math.max(a,g)};C.prototype.getXValueAt=function(a){if(!a)return null;var g=null;"left"===this._position?g=this.convertPixelToValue(a.y):"bottom"===this._position&&(g=this.convertPixelToValue(a.x));return g};C.prototype.calculateValueToPixelConversionParameters=
...
2,this.intervalType="month"):b/(3*L.monthDuration)<=a?(this.interval=3,this.intervalType="month"):b/(6*L.monthDuration)<=a?(this.interval=6,this.intervalType="month"):(this.interval=b/(1*L.yearDuration)<=a?1:b/(2*L.yearDuration)<=a?2:b/(4*L.yearDuration)<=a?4:Math.floor(C.getNiceNumber(b/(a-1),!0)/L.yearDuration),this.intervalType="year"));if(null===this.viewportMinimum||isNaN(this.viewportMinimum))this.viewportMinimum=e-d/2;if(null===this.viewportMaximum||isNaN(this.viewportMaximum))this.viewportMaximum=
...
null===this.viewportMinimum?b:this.viewportMinimum);this.intervalType="number";d=Math.pow(this.logarithmBase,C.getNiceNumber(Math.abs(Math.log(d)/g),!1));this.options&&0<this.options.interval?this.interval=this.options.interval:(this.interval=C.getNiceExponent(Math.log(d)/g/(a-1),!0),c=C.getNiceNumber(m/(a-1),!0));if(null===this.viewportMinimum||isNaN(this.viewportMinimum))this.viewportMinimum="axisX"===this.type?b/Math.sqrt(h):Math.pow(this.logarithmBase,this.interval*Math.floor(Math.log(b)/g/this.interval));
...
(this.interval=C.getNiceExponent(Math.ceil(Math.log(d)/g)/(a-1)),c=C.getNiceNumber((this.viewportMaximum-this.viewportMinimum)/(a-1),!0)));if(null===this.minimum||null===this.maximum)"axisX"===this.type?(b=null!==this.minimum?this.minimum:this.dataInfo.min,e=null!==this.maximum?this.maximum:this.dataInfo.max,1===e/b&&(d=Math.pow(this.logarithmBase,"undefined"===typeof this.options.interval?0.4:this.options.interval),e*=d,b/=d),h=Infinity!==this.dataInfo.minDiff?this.dataInfo.minDiff:e/b>this.logarithmBase?
...
this.lineColor;this.ctx.fillStyle=this.color;this.ctx.beginPath();this.ctx.globalAlpha=1;X(this.id);var d,r,m,n,k,l;a=Math.max(this.spacing,3);var p=Math.max(0,this.lineThickness);this.ctx.lineWidth=p;this.ctx.setLineDash&&this.ctx.setLineDash(G(this.lineDashType,p));if("bottom"===this.scaleBreaks.parent._position||"top"===this.scaleBreaks.parent._position)if(b=1===p%2?(b.x<<0)+0.5:b.x<<0,r=1===p%2?(e.x<<0)+0.5:e.x<<0,"top"===this.scaleBreaks.parent._position?(e=this.chart.plotArea.y1,m=this.chart.plotArea.y2+
p/2+0.5<<0):(e=this.chart.plotArea.y2,m=this.chart.plotArea.y1-p/2+0.5<<0,a*=-1),this.bounds={x1:b-p/2,y1:e,x2:r+p/2,y2:m},this.ctx.moveTo(b,e),"straight"===this.type||"top"===this.scaleBreaks.parent._position&&0>=a||"bottom"===this.scaleBreaks.parent._position&&0<=a)this.ctx.lineTo(b,m),this.ctx.lineTo(r,m),this.ctx.lineTo(r,e);else if("wavy"===this.type){n=b;k=e;d=0.5;l=(m-k)/a/3;for(var q=0;q<l;q++)this.ctx.bezierCurveTo(n+d*a,k+a,n+d*a,k+2*a,n,k+3*a),k+=3*a,d*=-1;this.ctx.bezierCurveTo(n+d*a,
k+a,n+d*a,k+2*a,n,k+3*a);n=r;d*=-1;this.ctx.lineTo(n,k);for(q=0;q<l;q++)this.ctx.bezierCurveTo(n+d*a,k-a,n+d*a,k-2*a,n,k-3*a),k-=3*a,d*=-1}else{if("zigzag"===this.type){d=-1;k=e+a;n=b+a;l=(m-k)/a/2;for(q=0;q<l;q++)this.ctx.lineTo(n,k),n+=2*d*a,k+=2*a,d*=-1;this.ctx.lineTo(n,k);n+=r-b;for(q=0;q<l+1;q++)this.ctx.lineTo(n,k),n+=2*d*a,k-=2*a,d*=-1;this.ctx.lineTo(n+d*a,k+a)}}else if("left"===this.scaleBreaks.parent._position||"right"===this.scaleBreaks.parent._position)if(e=1===p%2?(e.y<<0)+0.5:e.y<<
0,m=1===p%2?(b.y<<0)+0.5:b.y<<0,"left"===this.scaleBreaks.parent._position?(b=this.chart.plotArea.x1,r=this.chart.plotArea.x2+p/2+0.5<<0):(b=this.chart.plotArea.x2,r=this.chart.plotArea.x1-p/2+0.5<<0,a*=-1),this.bounds={x1:b,y1:e-p/2,x2:r,y2:m+p/2},this.ctx.moveTo(b,e),"straight"===this.type||"left"===this.scaleBreaks.parent._position&&0>=a||"right"===this.scaleBreaks.parent._position&&0<=a)this.ctx.lineTo(r,e),this.ctx.lineTo(r,m),this.ctx.lineTo(b,m);else if("wavy"===this.type){n=b;k=e;d=0.5;l=
(r-n)/a/3;for(q=0;q<l;q++)this.ctx.bezierCurveTo(n+a,k+d*a,n+2*a,k+d*a,n+3*a,k),n+=3*a,d*=-1;this.ctx.bezierCurveTo(n+a,k+d*a,n+2*a,k+d*a,n+3*a,k);k=m;d*=-1;this.ctx.lineTo(n,k);for(q=0;q<l;q++)this.ctx.bezierCurveTo(n-a,k+d*a,n-2*a,k+d*a,n-3*a,k),n-=3*a,d*=-1}else if("zigzag"===this.type){d=1;k=e-a;n=b+a;l=(r-n)/a/2;for(q=0;q<l;q++)this.ctx.lineTo(n,k),k+=2*d*a,n+=2*a,d*=-1;this.ctx.lineTo(n,k);k+=m-e;for(q=0;q<l+1;q++)this.ctx.lineTo(n,k),k+=2*d*a,n-=2*a,d*=-1;this.ctx.lineTo(n+a,k+d*a)}0<p&&this.ctx.stroke();
...
l.push(x));x=null;if(0===l.length)return;l.sort(function(a,b){return a.distance-b.distance});var z=x=0;yPercent=cumulativeY=0;for(var v=Infinity,u,s=0;s<l.length;s++){if("rangeBar"===l[s].dataSeries.type||"error"===l[s].dataSeries.type){if(l[s].dataPoint.y)for(var A=0;A<l[s].dataPoint.y.length;A++)z=Math.abs(a-this.parent.convertValueToPixel(l[s].dataPoint.y[A])),z<=v&&(v=z,x=s)}else"stackedBar"===l[s].dataSeries.type?(cumulativeY=l[s].dataSeries.dataPointEOs[l[s].index].cumulativeY,z=Math.abs(a-
...
x.dataSeries.visible&&l.push(x));if(0===l.length)return;l.sort(function(a,b){return a.distance-b.distance});z=x=0;v=Infinity;for(s=0;s<l.length;s++){if("rangeColumn"===l[s].dataSeries.type||"rangeArea"===l[s].dataSeries.type||"error"===l[s].dataSeries.type||"rangeSplineArea"===l[s].dataSeries.type||"candlestick"===l[s].dataSeries.type||"ohlc"===l[s].dataSeries.type||"boxAndWhisker"===l[s].dataSeries.type){if(l[s].dataPoint.y)for(A=0;A<l[s].dataPoint.y.length;A++)z=Math.abs(g-this.parent.convertValueToPixel(l[s].dataPoint.y[A])),
...
2,d+e/2),c.stroke(),c.moveTo(a+e/2,d-e/2),c.lineTo(a-e/2,d+e/2),c.stroke())}},drawMarkers:function(a){for(var d=0;d<a.length;d++){var c=a[d];W.drawMarker(c.x,c.y,c.ctx,c.type,c.size,c.color,c.borderColor,c.borderThickness)}}};return m}();t.version="v3.8.12 GA";window.CanvasJS&&(t&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=t)})();
