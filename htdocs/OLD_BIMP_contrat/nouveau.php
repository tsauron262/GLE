...
/*
  ...
  */
    ...
    if ($result)
    {
        ...
        print '<button style="padding: 5px 10px;" class="ui-widget-header ui-corner-all ui-state-default ui-button" ><span style="padding: 1px 10px;float: left;">'.$langs->trans("Etape suivante").'</span><span style="float: left;" class="ui-icon ui-icon-arrowreturnthick-1-e"></button>';
        print "</table>";
        print "</form>";
        ...
        print "<input type='hidden' name='action' value='create'>";
        print '<button style="padding: 5px 10px;" class="ui-widget-header ui-corner-all ui-state-default ui-button" ><span style="padding: 1px 10px;float: left;">'.$langs->trans("Filtrer").'</span><span style="float: left;" class="ui-icon ui-icon-circle-zoomout"></button>';
        print "</td>";
        print "</table";
        print "</form>";
    }
