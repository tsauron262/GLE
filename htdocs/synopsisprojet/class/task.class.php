...
/**
 *      \file       htdocs/synopsisprojet/class/task.class.php
 *      \ingroup    project
...
class Task extends CommonObject
{
    ...
    function delete($user, $notrigger=0)
    {
        ...
        else
        {
	        ...
	        {
	        	$projectstatic=new SynopsisProject($this->db);
    ...
    function getNomUrl($withpicto=0,$option='')
    {
        ...
        $lien = '<a href="'.DOL_URL_ROOT.'/synopsisprojet/tasks/task.php?id='.$this->id.($option=='withproject'?'&withproject=1':'').'">';
        $lienfin='</a>';
