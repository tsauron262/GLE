...
(function($) { // Create closure.
     ...
     */
       ...
       */
            ...
            widget.addControl = function(id, control) {
                var markup = '<a class="widget-icon ' + id + '-icon"><img src="'+DOL_URL_ROOT+'/synopsistools/dashboard/images/' + id + '.gif" alt="' + control.description + '" /></a>';
    ...
    $.fn.dashboard.defaults = {
        ...
        fullscreenHeaderInner: '<img alt="Close this widget" src="'+DOL_URL_ROOT+'/synopsistools/dashboard/images/close.gif" /> Return to Dashboard',
        throbberMarkup: '<div class="throbber"><img alt="Loading, please wait" src="'+DOL_URL_ROOT+'/synopsistools/dashboard/images/throbber.gif" /><p>Loading...</p></div>',
        animationSpeed: 200,
        callbacks: {},
        widgetCallbacks: {}
    };
