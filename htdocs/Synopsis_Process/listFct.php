...
jQuery(document).ready(function() {
    var grid = jQuery("#gridlistFct").jqGrid({
            datatype: "json",
            url: "ajax/listFct_json.php?",
...
$jqgridJs .= <<<EOF
            ...
            rowList:[30,50,100],
            imgpath: gridimgpath,
            pager: jQuery('#gridlistFctPager'),
            sortname: 'label',
            beforeRequest: function(){
                jQuery('#gview_gridlistFct').find('.ui-jqgrid-titlebar').addClass('ui-state-default');
            },
...
$jqgridJs .= <<<EOF
            ...
            sortorder: "asc",
            //multiselect: true,
            caption: "<span style='padding:4px; font-size: 16px;'>Fonctions</span>",
            viewsortcols: true,
            ondblClickRow: function(e,u){
                location.href='fctBuilder.php?id='+e;
            },
EOF;

    $jqgridJs.= '    }).navGrid("#gridlistFctPager",'."\n";
...
llxHeader($js,utf8_decode('Liste des fonctions'));
  ...
  print '<div id="gridlistFctPager" class="scroll" style="text-align:center;"></div>';
