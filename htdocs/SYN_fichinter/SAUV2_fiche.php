...
if (!$user->admin && !(isset($_REQUEST['action']) && $_REQUEST['action'] == 'create'))
...
//lié a un contrat de maintenance ou mixte
        $requete = "SELECT * FROM llx_contrat WHERE type in (3,7) AND fk_soc =" . $societe->id;
        $sql = $db->query($requete);
