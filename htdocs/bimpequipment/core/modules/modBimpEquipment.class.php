...
class modBimpEquipment extends DolibarrModules {
    ...
    public function __construct($db) {
        ...
        $this->tabs = array(
            'supplier_order:+bimpordersupplier:Livraison:@bimpequipment:$user->rights->fournisseur->facture->lire:/bimpequipment/manageequipment/viewOrderSupplier.php?id=__ID__'
        );
