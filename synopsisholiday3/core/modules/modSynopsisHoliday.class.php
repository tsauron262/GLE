...
//    $r++;
        ...
        $this->menu[$r]=array('fk_menu'=> 'fk_mainmenu=hrm,fk_leftmenu=holiday',
                            ...
                            'langs' => 'holiday@synopsisholiday',
                            'position'=>1,
                            'perms'=>'$user->rights->holiday->view_log',
                            'target'=>'',
                            'user'=>0);
        ...
        $this->menu[$r]=array('fk_menu'=> 'fk_mainmenu=hrm,fk_leftmenu=holiday',
                            ...
                            'mainmenu'=>'hrm',
                            'leftmenu'=>'1',        // To say if we can overwrite leftmenu
                            'url'=>'/synopsisholiday/index.php?&aff=myValid',
                            'langs' => 'holiday@synopsisholiday',
                            'position'=>5   ,
                            'perms'=>'$user->rights->holiday->month_report',
                            'target'=>'',
        ...
        $this->tabs = array('user:-paidholidays',
            ...
            'user:+paidholidaysRtt:Valid Congés RTT:@monmodule:/synopsisholiday/index.php?search_valideur=__ID__');
