 ...
 * Copyright (C) 2003      Eric Seigne          <erics@rycks.com> Copyright (C)
 * 2004-2008 Laurent Destailleur  <eldy@users.sourceforge.net> Copyright (C)
 * 2005-2006 Regis Houssin        <regis.houssin@capnetworks.com>
 *
...
/**
        ...
        \version    $Id: box_external_rss.php,v 1.24 2008/05/02 20:24:38 eldy Exp $
*/
