                    ...
                    $requeteLocZim = "SELECT folder_type_refid as ftid,
                                       ...
                                       WHERE folder_name='Propales'
                                         AND folder_parent = ( SELECT max(folder_uid)
                                                                FROM " . MAIN_DB_PREFIX . "Synopsis_Zimbra_trigger_folder
                                                               WHERE folder_name ='" . $tmpUser->prenom . ' ' . $tmpUser->nom . "'
            ...
            while ($objPai = $db->fetch_object($resqlPre)) {
                ...
                if ($resql) {
                    while ($res = $db->fetch_object($resql)) {
                        ...
                        $newAccountDet['zimbraCalResContactName'] = iconv("ISO-8859-1", "UTF-8", $tmpUser->prenom . ' ' . $tmpUser->nom);
...
//fcuntion
    ...
    public function Synopsis_Zimbra_GetDemandeInterventionUser($userid, $parentFolderId) {
...
//fcuntion
    ...
    public function Synopsis_Zimbra_GetDemandeInterventionUserById($userId, $diid) {
...
//fcuntion
    ...
    public function Synopsis_Zimbra_GetDemandeIntervention() {
