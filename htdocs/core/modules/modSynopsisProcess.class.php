...
(12, \'SELECT p.rowid, p.ref, p.fk_soc, s.nom  FROM babel_projet as p, '.MAIN_DB_PREFIX.'societe as s where s.rowid = p.fk_soc order by s.nom, p.dateo \', \'SELECT p.rowid, p.ref, p.fk_soc, s.nom  FROM  babel_projet as p, '.MAIN_DB_PREFIX.'societe as s WHERE s.rowid = fk_soc AND [[indexField]] order by s.nom, p.dateo  , p.ref                   \', \'a:1:{i:0;s:0:"";}\', 100, \'requete projet/soc\', \'Toutes les projets par société\', \'a:1:{i:0;s:5:"rowid";}\', \'ref\', \'p\', NULL, NULL, NULL, \'rowid\', \'rowid\', \'a:1:{s:3:"ref";s:0:"";}\'),
