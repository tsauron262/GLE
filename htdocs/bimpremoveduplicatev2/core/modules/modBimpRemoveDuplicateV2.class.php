 ...
 */
class modBimpRemoveDuplicateV2 extends DolibarrModules {
    ...
    public function __construct($db) {
        ...
        $this->rights_class = 'BimpRemoveDuplicateV2';
        ...
        $this->description = "Enlever les doublons dans la BDD, méthode de recherche avancée";
        // Used only if file README.md and README-LL.md not found.
        $this->descriptionlong = "Enlever les doublons dans la BDD, méthode de recherche avancée";
...
//        $this->warnings_activation_ext = array();                 // Warning to show when we activate an external module. array('always'='text') or array('FR'='textfr','ES'='textes'...)
        ...
        if (!isset($conf->modBimpRemoveDuplicateV2) || !isset($conf->modBimpRemoveDuplicateV2->enabled)) {
            $conf->modBimpRemoveDuplicateV2 = new stdClass();
            $conf->modBimpRemoveDuplicateV2->enabled = 0;
        }
