...
class Transfer extends BimpDolObject
{
	...
	{
		if($field == 'id_warehouse_source' && $this->getData('status') != Transfer::STATUS_SENDING){
			return 0;
		}
		return parent::isFieldEditable($field, $force_edit); // TODO: Change the autogenerated stub
	}
