 ...
 */
class modsynopsissignature extends DolibarrModules {

    /**
     *   \brief      Constructor. Define names, constants, directories, boxes, permissions
     *   \param      DB      Database handler
     */
    function modsynopsissignature($DB) {
        global $langs, $conf;
        ...
        $this->rights_class = 'modsynopsissignature';

        // Family can be 'crm','financial','hr','projects','products','ecm','technic','other'
        // It is used to group modules in module setup page
        $this->family = "Synopsis";
        // Module label (no space allowed), used if translation string 'ModuleXXXName' not found (where XXX is value of numeric property 'numero' of module)
        $this->name = "synopsissignature";
        $this->nameI = "synopsissignature";
        // Module description, used if translation string 'ModuleXXXDesc' not found (where XXX is value of numeric property 'numero' of module)
        $this->description = "Ajoute la signature éléctronique";
       ...
       /* $this->module_parts = array(
        ...
        $this->tabs = array('chrono:+signature:Signature:synopsisGene@synopsistools:1:/synopsissignature/signature.php?obj=chrono&id=__ID__',
            'intervention:+signature:Signature:synopsisGene@synopsistools:1:/synopsissignature/signature.php?obj=fi&id=__ID__',
            'delivery:+signature:Signature:synopsisGene@synopsistools:1:/synopsissignature/signature.php?obj=shipping&id=__ID__'
            );
    }
