...
//            $constPrix = 45;
	...
	public function create(&$warnings = array(), $force_create = false)
	{
		...
		if (!count($errors)) {
			...
			$sav = $this->getParentInstance();
			if (BimpObject::objectLoaded($sav)) {
				$warnings = BimpTools::merge_array($warnings, $sav->addPartsAuto($this->getData('id_issue'), $this->getData('part_number')));
			}
