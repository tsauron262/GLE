 ...
 * Copyright (C) 2014-2020  Regis Houssin       <regis.houssin@inodbox.com>
 *
...
/**
 *       \file       /multicompany/core/login/functions_ldapmc.php
 *       \ingroup    core
 *       \brief      Authentication functions for LDAP with Multicompany
 */
 ...
 */
function check_user_password_ldapmc($usertotest, $passwordtotest, $entitytotest)
{
