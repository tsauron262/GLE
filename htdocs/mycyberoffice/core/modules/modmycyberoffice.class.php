...
/**
 * 		\class      modmycyberoffice 
 *      \brief      Description and activation class for module 
 */
class modmycyberoffice extends DolibarrModules
{
	/**
	...
	function modmycyberoffice($db)
	{
		...
		$this->rights_class = 'mycyberoffice';
		...
		$this->description = $langs->trans("Synchronization from Dolibarr ERP/CRM to Prestashop");
		...
		//							'models' => 0,                                   // Set this to 1 if module has its own models directory
									'css' => '/mycyberoffice/css/mycyberoffice.css',       // Set this to relative path of css if module has its own css file
		...
		//$this->style_sheet = '/mycyberoffice/css/mycyberoffice.css';

		// Config pages. Put here list of php page names stored in admmin directory used to setup module.
		$this->config_page_url = array("mycyberoffice_setupapage.php@mycyberoffice");
		...
		$this->langfiles = array("mycyberoffice@mycyberoffice");//mettre aussi le nom et la description dans /langs/fr_FR/admin.lang
...
*/				
	...
	{
		return $this->_load_tables('/mycyberoffice/sql/');
	}
}
