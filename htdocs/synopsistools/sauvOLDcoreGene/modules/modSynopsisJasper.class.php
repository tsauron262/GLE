 ...
 */
class modSynopsisJasper extends DolibarrModules {
    ...
    function __construct($db) {
        ...
        $this->numero = 13694301;
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'SynopsisJasper'; //Max 12 lettres
        ...
        $this->config_page_url = "Synopsis_Jasper.php";
...
//            $conf->mymodule->enabled = 0;
        ...
        $this->rights[$r][1] = 'Affichage de SynopsisJasper';
        $this->rights[$r][2] = 'r'; //useless
        $this->rights[$r][3] = 1; // Default
        $this->rights[$r][4] = 'SynopsisJasper'; // Famille
        $this->rights[$r][5] = 'Affiche'; // Droit
        $r ++;

        $this->rights[$r][0] = $this->numero."2";// this->numero ."". 2
        $this->rights[$r][1] = 'G&eacute;n&eacute;ration dans SynopsisJasper';
...
//        $this->menu[$r]=array('fk_menu'=>0,'type'=>'top','titre'=>'BI','mainmenu'=>'synopsisjasper','leftmenu'=>'0','url'=>'/Synopsis_Jasper/index.php','langs'=>'other','position'=>100,'perms'=>'$user->rights->SynopsisJasper->SynopsisJasper->Affiche','target'=>'','user'=>0);
        $r++;
        $this->menu[$r]=array('fk_menu'=>'fk_mainmenu=SynopsisTools',
                                'type'=>'left',
                                'titre'=>'Reporting',
                                'url'=>'/Synopsis_Jasper/index.php',
                                'langs'=>'other',
                                'position'=>100,
                                'perms'=>'$user->rights->SynopsisJasper->SynopsisJasper->Affiche',
                                'target'=>'',
                                'user'=>0);
        $r++;
     ...
     */
    function init($options = '') {      global $langs;
