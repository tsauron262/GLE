...
$object2 = new SynopsisProject($db);
$object2->fetch($object->id);
$head=synopsis_project_prepare_head($object2);
dol_fiche_head($head, 'element', $langs->trans("Project"),0,($object->public?'projectpub':'project'));


print '<table class="border" width="100%">';

$linkback = '<a href="'.DOL_URL_ROOT.'/synopsisprojet/liste.php">'.$langs->trans("BackToList").'</a>';
