...
class CommandeGroup extends CommonObject{
    ...
    public function getNomUrl($withpicto=0,$option=0)
    {
        ...
        $lien = '<a href="'.DOL_URL_ROOT.$urlOption.'/synopsistools/commandeGroup/card.php?id='.$this->id.'">';
        $lienfin='</a>';

        if ($option == 6) $lien = '<a href="'.DOL_URL_ROOT.'/synopsistools/commandeGroup/card.php?id='.$this->id.'">';
        $picto='orderGroup@synopsistools';
