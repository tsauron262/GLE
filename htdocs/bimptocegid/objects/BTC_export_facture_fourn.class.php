...
class BTC_export_facture_fourn extends BTC_export {
    ...
    public static $rfa_fournisseur = ['GEN-CRT', 'GEN-RFA', 'GEN-IPH', 'REMISE', 'GEN-RETROCESSION', 'GEN-AVOIR', 'GEN-AVOIR-6097000', "GEN-PUB", "GEN-INCENTIVE"];
            ...
            if ($ligne->total_ttc != doubleval(0)) {
                ...
                if ($ligne->fk_product) {
                    ...
                    if ($frais_de_port = $this->db->getRow('categorie_product', 'fk_categorie = 9705 AND fk_product = ' . $produit->id) || $produit->id == 129950) { // ID du produit à enlever quand il sera categoriser (FRAIS DE PORT LDLC
                        ...
                        $use_compte_general = $this->convertion_to_interco_code($produit->getCodeComptableAchat($facture->getData('zone_vente')), $compte_general_401);
