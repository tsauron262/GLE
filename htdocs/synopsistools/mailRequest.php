...
if (isset($_REQUEST['action']) && $_REQUEST['action'] == "annulObj" && isset($_SERVER["HTTP_REFERER"]) && $_SERVER["HTTP_REFERER"] != '') {
    mailSyn("jc.cannet@bimp.fr", "Demande annulation", "Annuler Obj : " . $_SERVER["HTTP_REFERER"] . "<br/><br/><a href='" . DOL_MAIN_URL_ROOT . "/synopsistools/mailRequest.php?action=deblockComm&id=" . $_REQUEST['id'] . "'>Deverouiller</a>");
