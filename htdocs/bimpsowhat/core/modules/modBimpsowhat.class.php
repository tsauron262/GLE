 ...
 */
class modBimpsowhat extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 599392;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'bimpsowhat';
		...
		$this->description = "Module pour SoWhat";
