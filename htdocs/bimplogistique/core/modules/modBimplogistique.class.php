 ...
 */
class modBimpLogistique extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 514966;		// TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'bimplogistique';
		...
		$this->description = "BimpLogistique";
