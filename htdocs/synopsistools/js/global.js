...
//    $("#id-container").hide();
    ...
    iFrame.find("iframe").on('load', function () {
        ...
        $(this).contents().find("a.butActionDelete, input[name='cancel'], input[name='edit'], input[name='save'], input[value='Ajouter'], input[value='Ajouter'], div.ui-dialog-buttonset span.ui-button-text").click(function () {
//            fermerIframe($(this).parent(), callBack);
            nbLoad = 1;
        });
