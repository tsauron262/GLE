        ...
        if (!empty($files)) {
            ...
            foreach ($files as $file) {
                ...
                if ($url) {
                    ...
                    $html .= '<div onclick="' . $onclick . '" style="max-height: 200px; max-width: 160px; width: auto; height: auto; cursor: zoom-in; margin: 5px; padding: 5px; border: 1px solid #ccc; overflow: scroll">';
