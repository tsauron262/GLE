...
//            print '<td><input type="text" maxlength="30" name="ref" size="20"></td></tr>';
            ...
            print '. ';
            if ($absolute_discount) print $langs->trans("CompanyHasAbsoluteDiscount",price($absolute_discount),$langs->trans("Currency".$conf->global->MAIN_MONNAIE));
