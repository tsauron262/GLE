                            ...
                            if (is_array($array[$this->value])) {
                                if ($this->no_html) {
                                    ...
                                    if (($this->params['icon_only'] || $this->name === 'icon') && isset($array[$this->value]['icon'])) {
                                        ...
                                        $array[$this->value]['classes'] = BimpTools::merge_array($array[$this->value]['classes'], array(BimpRender::renderIconClass($array[$this->value]['icon']), 'iconLeft', 'bs-popover'));
                    ...
                    case 'datetime':
                        if ($this->value !== '0000-00-00 00:00:00') {
                            ...
                            if ($this->no_html) {
                                ...
                                $html .= BimpTools::printDate($date, 'span', 'datetime', $this->params['format'], ($this->field_params['show_hour'])? $this->params['format'] : null);
                            }
                        }
                        break;
