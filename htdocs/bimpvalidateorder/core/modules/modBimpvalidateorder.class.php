 ...
 */
class modBimpvalidateorder extends DolibarrModules {
    ...
    public function __construct($db) {
        ...
        $this->numero = 182502;  // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'bimpvalidateorder';
        ...
        $this->description = "Autorisation commande";
        // Used only if file README.md and README-LL.md not found.
        $this->descriptionlong = "Envoie des emails aux responsables des commandes en fonction du montant.";
...
//            1 => array('MYMODULE_MYCONSTANT', 'chaine', 'avalue', 'This is a constant to add', 1, 'allentities', 1)
        ...
        if (!isset($conf->modBimpvalidateorder) || !isset($conf->modBimpvalidateorder->enabled)) {
            $conf->modBimpvalidateorder = new stdClass();
            $conf->modBimpvalidateorder->enabled = 0;
        }
