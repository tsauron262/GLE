...
class PDO extends AbstractBackend {
    ...
    public $uriTest = "11C9E1F-708C-4CA7-9A38-CA7006231C71.ics";//35aef3ab-dd26-41b8-b361-f30dd6ff1bc4
        ...
        if(count($tabPartExtInt) > 1){
            foreach ($tabPartExtInt as $part)
                if ($part != "" /*&& $part != $row['organisateur']*/){
                    ...
                    $extra = ($tmpMail == $row['organisateur'])? ";ROLE=CHAIR" : ";ROLE=REQ-PARTICIPANT";
