...
//               <td class="ui-widget-content"><input size="8" type="text" name="ref" value="'.$_POST["ref"].'"></td></tr>';
    ...
    if ($_GET["action"] == 'edit') {
        ...
        print '<tr><th style="border-top:0px" class="ui-widget-header ui-state-default" width=25%>' . $langs->trans('TempsPrevu') . '</th><td style="border-top:0px; border-right:0px;" class="ui-widget-content">' . sec2time($projet->totDuration) .($projet->totDuration > (3600*24) ? " (".$projet->totDuration/3600 . "h)" : ''). '</td></tr>';
        print '<tr><th style="border-top:0px;border-bottom:0px" class="ui-widget-header ui-state-default" width=25%>' . $langs->trans('TempsEffectue') . '</th><td style="border-right:0px; border-top:0px" class="ui-widget-content">' . sec2time($projet->workedDuration) .($projet->workedDuration > (3600*24) ? " (".$projet->workedDuration/3600 . "h)" : ''). '</td></tr>';
